<div class="form-group text-right">
    ...
    <a href="<?php echo base_url()?>setting/restauranttable/floorlist" class="btn btn-success btn-md"><i
            class="fa fa-plus-circle" aria-hidden="true"></i>
        <?php echo display('add_floor')?></a>
    <button type="button" class="btn btn-success btn-md" data-target="#add0" data-toggle="modal" data-backdrop="static"
        data-keyboard="false"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="capacity"
                                        class="col-sm-4 col-form-label"><?php echo display('capacity'); ?> *</label>
                                    <div class="col-sm-8">
                                        <input name="capacity" class="form-control" type="text"
                                            placeholder="Add <?php echo  display('capacity'); ?>" id="capacity" value=""
                                            required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="firstname"
                                        class="col-sm-4 col-form-label"><?php echo display('table_shape');?> *</label>
                                    <div class="col-sm-8">
                                        ...
                                        <select class="form-control" name="shape" id="shape" required="">
                                            <option value="">--Select--</option>
                                            <option value="1">Round Circle</option>
                                            <option value="2">Round Square</option>
                                            <option value="3">Rectangular</option>
                                            <option value="4">Cube shape</option>
                                        </select>
                                    </div>
                                    <!-- <div class="col-sm-2">
                                ...
                                <div class="panel-title">
                                    <div class="btn-group pull-right">
                                        ...
                                        <input name="url" type="hidden" id="uploadurl"
                                            value="<?php echo base_url("setting/restauranttable/uploadfile") ?>" />
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td>
                                <div class="restora-table <?php echo $icon;?>">
                                    <div class="table-inner">
                                        <div class="table-user">
                                            <i class="fa fa-user-circle-o" aria-hidden="true"></i>
                                            <span class="table-user__count">
                                                <?php echo $table->person_capicity; ?></span>
                                        </div>
                                    </div>
                                </div>

                                <!--<img src="<?php //echo base_url(!empty($table->table_icon)?$table->table_icon:'assets/img/icons/table/default.jpg'); ?>" class="img-thumbnail tablelist-img"/>-->
                            </td>
                            <td class="center">
                                <?php if($this->permission->method('setting','update')->access()): ?>
                                <input name="url" type="hidden" id="url_<?php echo $table->tableid; ?>"
                                    value="<?php echo base_url("setting/restauranttable/updateintfrm") ?>" />
                                ...
                                <a href="<?php echo base_url("setting/restauranttable/delete/$table->tableid") ?>"
...
<script src="<?php echo base_url('application/modules/setting/assets/js/tablelist_script.js'); ?>"
