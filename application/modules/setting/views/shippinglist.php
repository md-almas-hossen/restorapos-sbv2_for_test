                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="shipping"
                                        class="col-sm-5 col-form-label"><?php echo display('shipping_name') ?> *</label>
                                    <div class="col-sm-7">
                                        <input name="shipping" class="form-control" type="text"
                                            placeholder="Add <?php echo display('shipping_name') ?>" id="shipping"
                                            value="" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="shippingrate"
                                        class="col-sm-5 col-form-label"><?php echo display('shippingrate') ?> *</label>
                                    <div class="col-sm-7">
                                        <input name="shippingrate" class="form-control" type="text"
                                            placeholder="Add <?php echo display('shippingrate') ?>" id="shippingrate"
                                            value="" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="paymentmethod"
                                        class="col-sm-5 col-form-label"><?php echo display('payment_add') ?> *</label>
                                    <div class="col-sm-7">
                            			...
                            			?>
                                            <option value="<?php echo $payment->payment_method_id; ?>">
                                                <?php echo $payment->payment_method; ?></option>
                                            <?php } } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="status"
                                        class="col-sm-5 col-form-label"><?php echo display('shipping_type');?> *</label>
                                    <div class="col-sm-7 customesl">
                                        <select name="shippintype" class="form-control" required="">
                                ...
                                <div class="form-group row">
                                    <label for="status" class="col-sm-5 col-form-label"><?php echo display('status');?>
                                        *</label>
                                    <div class="col-sm-7 customesl">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $shipping->ship_id; ?>"
                                    value="<?php echo base_url("setting/shippingmethod/updateintfrm") ?>" />
                                <a onclick="editinfoshiping('<?php echo $shipping->ship_id; ?>')"
                                ...
                                <a href="<?php echo base_url("setting/shippingmethod/delete/$shipping->ship_id") ?>"
