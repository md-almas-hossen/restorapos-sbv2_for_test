                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="kitchenname"
                                        class="col-sm-4 col-form-label"><?php echo display('kitchen_name') ?> *</label>
                                    <div class="col-sm-8">
                                        <input name="kitchenname" class="form-control" type="text"
                                            placeholder="<?php echo display('kitchen_name') ?>" id="kitchenname">
                                    </div>
                                </div>
                                <div class="form-group text-right">
                                    <button type="reset"
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $kitchen->kitchenid; ?>"
                                    value="<?php echo base_url("setting/kitchensetting/updateintfrm") ?>" />
                                <a onclick="editinfo('<?php echo $kitchen->kitchenid; ?>')" class="btn btn-info btn-sm"
                                ...
                                <a href="<?php echo base_url("setting/kitchensetting/delete/$kitchen->kitchenid") ?>"
