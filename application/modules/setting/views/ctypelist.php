                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="typename"
                                        class="col-sm-4 col-form-label"><?php echo display('type_name') ?> *</label>
                                    <div class="col-sm-8">
                                        <input name="typename" class="form-control" type="text"
                                            placeholder="Add <?php echo display('type_name') ?>" id="tablename"
                                            value="">
                                    </div>
                                </div>
...
<div id="edit" class="modal fade" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <strong>Edit <?php echo display('customer_type');?></strong>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $type->customer_type_id; ?>"
                                    value="<?php echo base_url("setting/customertype/updateintfrm") ?>" />
                                <a onclick="editinfo('<?php echo $type->customer_type_id; ?>')"
