        ...
        <div class="modal-content customer-list">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <?php endif; ?>
                    <h3>You can export test.csv file Example-<a class="btn btn-primary btn-md"
                            href="<?php echo base_url() ?>setting/language/downloadformatsingle/<?php echo $language;?>"><i
                                class="fa fa-download" aria-hidden="true"></i>Download CSV Format</a></h3>
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("setting/language/phrase") ?>"> <i
                            class="fa fa-plus"></i> Add Phrase</a>
                    <a class="btn btn-primary" href="<?php echo base_url("setting/language") ?>"> <i
                            class="fa fa-list"></i> Language List </a>
                </div>
                <div class="btn-group pull-right">
                    <?php if($this->permission->method('setting','update')->access()): ?>
                    <a data-target="#add0" data-toggle="modal" class="btn btn-primary btn-md"><i
