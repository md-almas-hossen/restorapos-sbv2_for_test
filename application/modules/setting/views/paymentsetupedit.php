                ...
                <div class="panel-body">
                   ...
                   <?php echo form_hidden('setupid', (!empty($intinfo->setupid)?$intinfo->setupid:null)) ?>
                     <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="payment" class="col-sm-4 col-form-label"><?php if($intinfo->paymentid=='8'){ echo "Application ID";}elseif($intinfo->paymentid=='13') {echo display('api_key');}else{echo display('marchantid');} ?></label>
                            <div class="col-sm-8">
                                <!-- iyzico -->
                        ...
                        <div class="form-group row">
                               <!-- iyzico -->
                            <label for="payment" class="col-sm-4 col-form-label"><?php if($intinfo->paymentid=='8'){ echo "Access Token";}elseif($intinfo->paymentid=='13') {echo display('security_key');}else{echo display('password');} ?></label>
                            <div class="col-sm-8">
