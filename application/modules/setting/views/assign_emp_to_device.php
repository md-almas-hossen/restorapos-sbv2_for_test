        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php if (count($emp_list) > 0) : ?>
                    ...
                    <?php echo form_open('setting/Setting/assign_emp_to_device/') ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="mb-3 col-sm-9" style="margin-top:5px">

                            <table class="table table-bordered">

                                <thead style="background: #eeeeee; color: #374767;">
                                    ...
                                    <th style="width:10%" class="text-center">
                                        ...
                                        <div class="kitchen-tab" id="option" style="background:#eee; width:10%; float:right; margin-right: 5%; margin-left: -16%; ">
                    ...
                    <div class="form-group text-right">
                        <button style="margin-right: 8%;" type="submit" class="btn btn-success w-md m-b-5"><?php echo display('assign');?></button>
                    </div>
                ...
                <?php else : ?>
                    ...
                    <p class="text-center" style="background: #019868; color: #fff; padding: 10px 10px 10px 10px;"><b><?php echo display('no_employee_remains');?></b></p>
