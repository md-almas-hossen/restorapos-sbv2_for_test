                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="payment" class="form-control" type="text"
                                            placeholder="Add <?php echo display('payment_name') ?>" id="unitname"
                                            value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8 customesl">
                                        <input name="dorder" class="form-control" type="text"
                                            placeholder="Display Ordering">
                                    </div>
                                </div>
                                <div class="form-group row">
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            <td><?php echo $sl; ?></td>
                            <td><?php echo $payment->paymentmethod_code; ?></td>
                            <td><?php echo $payment->payment_method; ?></td>
                            <td><?php echo $payment->commission; ?></td>
                            <td><?php if($payment->is_active==1){echo "Active";}else{echo "Inactive";} ?></td>
                            <td class="center">
                                <?php if($this->permission->method('setting','update')->access()): ?>
                                <input name="url" type="hidden" id="url_<?php echo $payment->payment_method_id; ?>"
                                    value="<?php echo base_url("setting/paymentmethod/updateintfrm") ?>" />
                                <a onclick="editinfo('<?php echo $payment->payment_method_id; ?>')"
