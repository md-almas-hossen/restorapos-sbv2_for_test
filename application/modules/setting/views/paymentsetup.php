                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="payment"
                                        class="col-sm-4 col-form-label"><?php echo display('payment_name') ?> *</label>
						...
						echo form_dropdown('payment',$paymentlist,(!empty($intinfo->paymentid)?$intinfo->paymentid:null),'class="form-control" id="payment" required') ?>
                                ...
                                <div class="form-group row">
                                    <label for="payment"
                                        class="col-sm-4 col-form-label"><?php echo display('marchantid') ?></label>
                                    <div class="col-sm-8">
                                        <input name="marchantid" class="form-control" type="text"
                                            placeholder="<?php echo display('marchantid') ?>" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="payment"
                                        class="col-sm-4 col-form-label"><?php echo display('password').'sdfgfd' ?></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="email" class="form-control" type="text"
                                            placeholder="<?php echo display('email') ?>" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="payment"
                                        class="col-sm-4 col-form-label"><?php echo display('currency') ?> *</label>
                                    <div class="col-sm-8 customesl">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $payment->setupid; ?>"
                                    value="<?php echo base_url("setting/paymentmethod/psetupupdateintfrm") ?>" />
                                <a onclick="editinfo('<?php echo $payment->setupid; ?>')" class="btn btn-info btn-sm"
