                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="unit_name"
                                        class="col-sm-3 col-form-label"><?php echo display('unit_name') ?> *</label>
                                    <div class="col-sm-9">
                ...
                <table width="100%" class="datatable2 table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo display('um_code') ?></th>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td><?php echo $unit->um_code; ?></td>
                            <td><?php echo $unit->uom_short_code; ?></td>
                            <td class="center">
                                <?php if($this->permission->method('setting','update')->access()): ?>
                                <input name="url" type="hidden" id="url_<?php echo $unit->id; ?>"
                                    value="<?php echo base_url("setting/unitmeasurement/updateunitfrm") ?>" />
                                <a onclick="editinfo('<?php echo $unit->id; ?>')" class="btn btn-info btn-sm"
                                ...
                                <a href="<?php echo base_url("setting/unitmeasurement/delete/$unit->id") ?>"
