                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="currencyname"
                                        class="col-sm-4 col-form-label"><?php echo display('currency_name') ?> *</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label for="icon"
                                        class="col-sm-4 col-form-label"><?php echo display('currency_icon') ?> *</label>
                                    <div class="col-sm-8">
                                        <input name="icon" class="form-control" type="text"
                                            placeholder="Add <?php echo display('currency_icon') ?>" id="icon" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="rate"
                                        class="col-sm-4 col-form-label"><?php echo display('currency_rate') ?> *</label>
                                    <div class="col-sm-8">
                                        <input name="rate" class="form-control" type="text"
                                            placeholder="Add <?php echo display('currency_rate') ?>" id="rate" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="position"
                                        class="col-sm-4 col-form-label"><?php echo display('position') ?> *</label>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $currency->currencyid; ?>"
                                    value="<?php echo base_url("setting/currency/updateintfrm") ?>" />
                                <a onclick="editinfo('<?php echo $currency->currencyid; ?>')"
                                ...
                                <a href="<?php echo base_url("setting/currency/delete/$currency->currencyid") ?>"
