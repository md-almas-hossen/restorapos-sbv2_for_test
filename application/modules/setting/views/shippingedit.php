                ...
                <div class="panel-body">
                    ...
                    <?php echo form_hidden('ship_id', (!empty($intinfo->ship_id)?$intinfo->ship_id:null)) ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                 <input name="shipping" class="form-control" type="text" placeholder="<?php echo display('shipping_name') ?>" id="shipping" value="<?php echo (!empty($intinfo->shipping_method)?$intinfo->shipping_method:null) ?>" required="">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="shippingrate" class="col-sm-5 col-form-label"><?php echo display('shippingrate') ?> *</label>
                            <div class="col-sm-7">
                                <input name="shippingrate" class="form-control" type="text" placeholder="Add <?php echo display('shippingrate') ?>" id="shippingrate" value="<?php echo (!empty($intinfo->shippingrate)?$intinfo->shippingrate:null) ?>" required="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="paymentmethod" class="col-sm-5 col-form-label"><?php echo display('payment_add') ?> *</label>
                            <div class="col-sm-7">
                                <select name="paymentmethod[]" class="form-control" multiple="multiple" required>
