                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="state"
                                        class="col-sm-4 col-form-label"><?php echo display('state') ?></label>
                                    <div class="col-sm-8 customesl">
                                        <select name="state" id="state" class="form-control" onchange="getcountry()">
                                            <option value="" selected="selected">Select Option</option>
                                            <?php foreach($allstate as $single){?>
                                            <option value="<?php echo $single->stateid;?>"
                                                data-title="<?php echo $single->countryid;?>">
                                                <?php echo $single->statename;?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="state" class="col-sm-4 col-form-label"><?php echo display('city') ?>
                                        *</label>
                                    <div class="col-sm-8">
                                        <input name="city" class="form-control" type="text"
                                            placeholder="Add <?php echo display('city') ?>" id="city" value="">
                                    </div>
                                </div>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $city->cityid; ?>"
                                    value="<?php echo base_url("setting/country_city_list/updatecityfrm") ?>" />
                                <a onclick="editinfo('<?php echo $city->cityid; ?>')" class="btn btn-info btn-sm"
                                ...
                                <a href="<?php echo base_url("setting/country_city_list/deletecity/$city->cityid") ?>"
...
<script src="<?php echo base_url('application/modules/setting/assets/js/citylist.js'); ?>" type="text/javascript">
</script>