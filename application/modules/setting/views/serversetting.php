...
<div class="col-md-12">
            ...
            <div class="panel-heading">
                ...
                <div class="panel-body">
                    <?php $qrurl=$setting2->localhost_url."/V3/";
                    $qrurl2=$setting2->localhost_url."/V1/";
                    ?>
                 <div class="col-md-3 serversetting-local-url">
                 <img src="<?php echo generateQrCode($qrurl,'v3'); ?>" alt="qr1" />
                 <p align="center"><strong><?php echo display('kitchen_app')?> QR Scan</strong></p>
                 </div>
                  <div class="col-md-3 serversetting-waiter-app">
                 <img src="<?php echo generateQrCode($qrurl2,'v1'); ?>" alt="qr1" />
