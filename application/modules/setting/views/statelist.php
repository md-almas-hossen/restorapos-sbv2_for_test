                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="country"
                                        class="col-sm-4 col-form-label"><?php echo display('country') ?></label>
                                    <div class="col-sm-8 customesl">
                                        <select name="country" class="form-control">
                                            <option value="" selected="selected">Select Option</option>
                                            <?php foreach($country as $single){?>
                                            <option value="<?php echo $single->countryid;?>">
                                                <?php echo $single->countryname;?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="state" class="col-sm-4 col-form-label"><?php echo display('state') ?>
                                        *</label>
                                    <div class="col-sm-8">
                                        <input name="state" class="form-control" type="text"
                                            placeholder="Add <?php echo display('state') ?>" id="tablename" value="">
                                    </div>
                                </div>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $state->stateid; ?>"
                                    value="<?php echo base_url("setting/country_city_list/updatestatefrm") ?>" />
                                <a onclick="editinfo('<?php echo $state->stateid; ?>')" class="btn btn-info btn-sm"
                                ...
                                <a href="<?php echo base_url("setting/country_city_list/deletestate/$state->stateid") ?>"
