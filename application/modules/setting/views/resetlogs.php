            ...
            <div class="panel-body">
            		<div class="row">
                        <div class="form-group col-lg-6 col-sm-offset-3 reset-system-alert">
                            <p class="alert"><?php echo display('logs_reset_note')?></p>
                        </div>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <strong>
      	Verify Account To Clear Logs Data
        </strong> </div>
      	...
      	<div class="row">
                  ...
                  <div class="form-group text-right">
                    <div class="col-sm-11 reset-system-b">
                      <button type="button" id="resetnow" class="btn btn-success w-md m-b-5" onclick="confirm_logs_reset()">Reset Data</button>
                    </div>
                  </div>
                </div>
...
<script src="<?php echo base_url('application/modules/setting/assets/js/resetsystem_script.js?v=1'); ?>" type="text/javascript"></script>
