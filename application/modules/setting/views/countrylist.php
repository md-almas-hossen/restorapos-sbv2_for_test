                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="country"
                                        class="col-sm-4 col-form-label"><?php echo display('countryname') ?> *</label>
                                    <div class="col-sm-8">
                                        <input name="country" class="form-control" type="text"
                                            placeholder="Add <?php echo display('countryname') ?>" id="tablename"
                                            value="">
                                    </div>
                                </div>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $type->countryid; ?>"
                                    value="<?php echo base_url("setting/country_city_list/updateintfrm") ?>" />
                                <a onclick="editinfo('<?php echo $type->countryid; ?>')" class="btn btn-info btn-sm"
                                ...
                                <a href="<?php echo base_url("setting/country_city_list/deletecountry/$type->countryid") ?>"
