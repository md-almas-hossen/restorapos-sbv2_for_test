                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="3rdcompany_name"
                                        class="col-sm-4 col-form-label"><?php echo display('3rdcompany_name') ?>
                                        *</label>
                                    <div class="col-sm-8">
                                        <input name="3rdcompany_name" class="form-control" type="text"
                                            placeholder="Add <?php echo display('3rdcompany_name') ?>"
                                            id="3rdcompany_name" value="" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="commision"
                                        class="col-sm-4 col-form-label"><?php echo display('commision') ?>(%) *</label>
                                    <div class="col-sm-8">
                                        <input name="commision" class="form-control" type="number"
                                            placeholder="<?php echo display('commision') ?>" id="commision" value=""
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            <td><?php echo $sl; ?></td>
                            <td><?php echo $type->companycode; ?></td>
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $type->companyId; ?>"
                                    value="<?php echo base_url("setting/thirdpratycustomer/updateintfrm") ?>" />
                                <a onclick="editinfo('<?php echo $type->companyId; ?>')" class="btn btn-info btn-sm"
                                ...
                                <?php endif; 
										 ...
										 if(!empty($exitid)){
										 ?>
                                <a onclick="return confirm('You Can not Remove this Company!!! Because the delivary Company Have some Order!!')"
                                ...
                                <?php }
										 ...
										 ?>
                                <a href="<?php echo base_url("setting/thirdpratycustomer/delete/$type->companyId") ?>"
