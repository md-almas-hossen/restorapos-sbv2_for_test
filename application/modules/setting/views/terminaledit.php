            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_hidden('card_terminalid', (!empty($intinfo->card_terminalid)?$intinfo->card_terminalid:null)) ?>
                        ...
                        <div class="form-group row">
                            <label for="commission" class="col-sm-4 col-form-label"><?php echo display('commission') ?></label>
                            <div class="col-sm-8">
                                <input name="commission" id="commission" class="form-control" type="text" placeholder="<?php echo display('commission') ?>" value="<?php echo (!empty($intinfo->comissionrate)?$intinfo->comissionrate:null) ?>" />
                            </div>
                        </div>
