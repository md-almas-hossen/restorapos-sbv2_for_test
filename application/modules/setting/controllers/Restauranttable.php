...
class Restauranttable extends MX_Controller {
    ...
    public function create($id = null)
    {
	  ...
	  #-------------------------------#
		...
		$this->form_validation->set_rules('shape','Table Shape'  ,'required');
	   ...
	   $data['supplier']   = (Object) $postData = array(
		   ...
		   'table_icon' 	     => $this->input->post('shape',true),
   ...
   public function updateintfrm($id){
	...
	public function tablesetting(){
			...
			$data['tablefloor']   = $this->restable_model->tablefloor();
			$data['module'] = "setting";  
			$data['page']   = "tablesetting";
			echo Modules::run('template/layout', $data);   
		}
	public function floorselect(){
			$ids =$this->input->post('floorno',true);
			$data['tablesetting']   = $this->restable_model->tablemap($ids);
			$data['module'] = "setting";  
			$data['page']   = "selectedtablemap";
			$this->load->view('setting/selectedtablemap', $data);  
		}
