...
function getreport(){
	...
	var myurl =baseurl+'report/reports/productwisereadyreport';
	var csrf = $('#csrfhashresarvation').val();
	var dataString = "from_date="+from_date+'&to_date='+to_date+'&catid='+category+'&productid='+productid+'&stockcheck='+stockcheck+'&csrf_test_name='+csrf;
		 $.ajax({
		 type: "POST",
		 url: myurl,
		 data: dataString,
