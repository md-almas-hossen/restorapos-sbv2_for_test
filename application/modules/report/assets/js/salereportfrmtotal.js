...
function printDiv(divName) {
	...
	$("#respritblday_filter").hide();
	$(".dt-buttons").hide();
	$(".dataTables_info").hide();
	$("#respritbl_paginate").hide();
	$("#respritblday_paginate").hide();
	$("#respritbl_length").hide();
	$("#respritblday_length").hide();
    window.print();
...
function getreport(){
	...
	var myurl =baseurl+'report/reports/salereportbydatewise';
	var csrf = basicinfo.csrftokeng;
	    var dataString = "from_date="+from_date+'&to_date='+to_date+'&paytype='+paytype+'&status='+status+'&csrf_test_name='+csrf;
		 $.ajax({
		 type: "POST",
		 url: myurl,
		 data: dataString,
