...
function getDueSaleReport(){
	var from_date=$('#from_date').val();
	var to_date=$('#to_date').val();
	var customer_id = $('#customer_id').val();
	// alert('Not Finished');return false;
	...
	var myurl =baseurl+'report/reports/getDueSaleReport';
	var csrf = basicinfo.csrftokeng;
	    var dataString = "from_date="+from_date+'&to_date='+to_date+'&customer_id='+customer_id+'&csrf_test_name='+csrf;
		 $.ajax({
		 type: "POST",
		 url: myurl,
		 data: dataString,
