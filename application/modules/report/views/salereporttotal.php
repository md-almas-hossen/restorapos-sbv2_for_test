<script src="<?php echo base_url('application/modules/report/assets/js/salereportfrmtotal.js?v=1.3'); ?>"
...
<script src="<?php echo base_url('application/modules/report/assets/js/salereportfrmdate_script.js'); ?>"
    type="text/javascript"></script>