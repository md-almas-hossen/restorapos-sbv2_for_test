<script src="<?php echo base_url('application/modules/report/assets/js/kicReport.js'); ?>" type="text/javascript">
</script>
<link href="<?php echo base_url('application/modules/report/assets/css/kicReport.css'); ?>" rel="stylesheet"
    type="text/css" />
