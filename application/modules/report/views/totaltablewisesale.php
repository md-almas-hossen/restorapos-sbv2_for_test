...
<table class="table table-bordered table-striped table-hover" id="respritbl">
			                        <thead>
										 <tr>
				                           ...
				                           <th class="text-center"><?php echo display('view')?></th>
				                        </tr>
									</thead>
									<tbody>
										<?php $totalprice=0;
										...
										<tr>
											...
											<td class="text-center">  
												<a  href="<?php echo base_url('report/reports/payroll_commission/').$commission->tableid?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="right" title="<?php echo display('view').' '.display('commission') ?>">
