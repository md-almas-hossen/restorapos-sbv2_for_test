									...
									?>
											<tr>
                                               ...
                                               <td><?php echo $newDate = date("h:i A", strtotime($pitem->order_time));?></td>
                                                ...
                                                <!-- <td class="total_ammount"><?php echo numbershow($pitem->discountnote, $setting->showdecimal);?></td> -->
                                                ...
                                                <td class="total_ammount"><?php echo numbershow($pitem->commission, $setting->showdecimal);?></td>
											</tr>
									<?php 
									 } 
									}
