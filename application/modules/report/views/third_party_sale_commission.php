<script src="<?php echo base_url('application/modules/report/assets/js/third_party_sale_commission.js'); ?>"
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <?php echo form_dropdown('thirdparty', $thirdparty, '', 'class="postform resizeselect form-control " id="thirdparty"') ?>
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <a class="btn btn-success"
                            onclick="thirdpartycommgetreport()"><?php echo display('search') ?></a>

                        <a class="btn btn-warning" href="#"
                            onclick="printDiv('purchase_div1')"><?php echo display('print'); ?></a>
                    </div>
