<script src="<?php echo base_url('application/modules/report/assets/js/prechasereport.js?v=1.6'); ?>"
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <select name="supplier" class="form-control" id="supplier">
                        ...
                        <option value="<?php echo $supplier->supid;?>"><?php echo $supplier->supName;?>
                        </option>
                        <?php } ?>
                    </select>
                </div>
                ...
                <div id="purchase_div">
                    ...
                    <div class="table-responsive" id="getresult2">
                        ...
                        <table class="table table-bordered table-striped table-hover" id="respritbl">
                            <thead>
                                <tr style="background: rgba(231,233,235, 0.6) !important" class="voucherList bg-light">
                                    <th>
                                        <?php echo display('purdate'); ?></th>
                                    <th>
                                        <?php echo display('invoice_no'); ?></th>
                                    <th>
                                        <?php echo display('supplier_name') ?></th>
                                    <th class="text-right">
