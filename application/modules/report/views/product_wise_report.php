        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="col-sm-12 col-md-6 col-lg-2 mb-2 mb-lg-0">
                    ...
                    <select name="category" class="form-control" id="category" onchange="getproducstList();">
                ...
                <div class="col-sm-12 col-md-6 col-lg-2 mb-2 mb-lg-0">
                    ...
                    <input type="text" id="from_date" name="from_date" value="<?php //echo date('d-m-Y')?>"
                ...
                <div class="col-sm-12 col-md-6 col-lg-2">
                    <label for="to_date"><?php echo display('to'); ?>:
                        <i class="text-danger">*</i></label>
                    <input type="text" id="to_date" name="to_date" value="<?php echo date('d-m-Y')?>"
                        class="form-control datepicker" required />
                </div>

                <div style="margin-top:24px" class="col-sm-12 col-md-6 col-lg-2 d-flex align-items-center">
            ...
            <div class="panel-body">
                <div id="printableArea">
                    <div class="text-center">
                        ...
                        <h4 id="hsdate" style="display:none;"><?php echo display('date'); ?>: <span id="sdate"></span>
                        </h4>
                        <h4><?php echo display('stock_report_product_wise') ?></h4>
                    </div>
