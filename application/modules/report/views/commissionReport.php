<script src="<?php echo base_url('application/modules/report/assets/js/commissionReport.js'); ?>"
    type="text/javascript"></script>
<link href="<?php echo base_url('application/modules/report/assets/css/commissionReport.css'); ?>" rel="stylesheet"
    type="text/css" />
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
		               ...
		               $statdate = date('d-m-Y', strtotime('first day of this month'));?>
                        ...
                        <div class="form-group">
                            <label class=""
                                for="orderid"><?php echo display('table').':'; echo $table_details->tablename;?></label>

                        </div>
                        <input type="hidden" name="table_id" class="form-control" id="table_id" placeholder=""
