<script src="<?php echo base_url('application/modules/report/assets/js/salebytable.js'); ?>" type="text/javascript">
</script>
<link href="<?php echo base_url('application/modules/report/assets/css/salebytable.css'); ?>" rel="stylesheet"
    type="text/css" />
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('sale_by_table'); ?></h4>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div id="purchase_div">
