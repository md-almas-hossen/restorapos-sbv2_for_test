<script src="<?php echo base_url('application/modules/report/assets/js/schargeReport.js'); ?>" type="text/javascript">
</script>
...
<script src="<?php echo base_url('application/modules/report/assets/js/schargeReport_script.js'); ?>"
