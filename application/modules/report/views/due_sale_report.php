            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?php if(!empty($getActiveCustomers)){?>
                        <div class="form-group">
                            <?php //echo form_dropdown('categorylist',$getActiveCustomers,(!empty($catelist)?$catelist:null),'class="postform resizeselect form-control " id="catid"') ?>
                            <select class="postform resizeselect form-control customer_id" id="customer_id"
                                name="customer_id">
                                <option value="">select customer</option>
                                <?php foreach($getActiveCustomers as $customer){ ?>
                        ...
                        <?php } ?>
                        <a class="btn btn-success" onclick="getDueSaleReport()"><?php echo display('search') ?></a>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('due_sale_report') ?></h4>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div id="purchase_div">
