<script src="<?php echo base_url('application/modules/report/assets/js/PaymentGatewayCommission.js'); ?>"
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a class="btn btn-success"
                            onclick="PaymentGatewayCommission()"><?php echo display('search') ?></a>
