<script src="<?php echo base_url('application/modules/report/assets/js/salereportfrmaddons.js'); ?>"
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a class="btn btn-success" onclick="getreportaddons()"><?php echo display('search') ?></a>
...
<script src="<?php echo base_url('application/modules/report/assets/js/salereportfrmaddons_script.js'); ?>"
    type="text/javascript"></script>