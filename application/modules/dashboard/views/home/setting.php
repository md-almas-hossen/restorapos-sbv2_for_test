        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    <label for="title" class="col-xs-3 col-form-label"><?php echo display('application_title') ?> <i
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <input name="stname" type="text" class="form-control" id="stname"
                            placeholder="<?php echo display('store_name') ?>" value="<?php echo $setting->storename ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <input name="address" type="text" class="form-control" id="address"
                            placeholder="<?php echo display('address') ?>" value="<?php echo $setting->address ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <input name="email" type="text" class="form-control" id="email"
                            placeholder="<?php echo display('email')?>" value="<?php echo $setting->email ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <input name="phone" type="text" class="form-control" id="phone"
                            placeholder="<?php echo display('phone') ?>" value="<?php echo $setting->phone ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <input name="opentime" type="text" class="form-control" id="opentime"
                            placeholder="<?php echo display('opent') ?>" value="<?php echo $setting->opentime ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="storevat" class="col-xs-3 col-form-label"><?php echo display('closeTime') ?></label>
                    <div class="col-xs-9">
                        <input name="closetime" type="text" class="form-control" id="closetime"
                            placeholder="<?php echo display('closeTime') ?>" value="<?php echo $setting->closetime ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <select class="form-control" name="dtype">
                            ...
                            <option value="0" <?php if($setting->discount_type=="0"){ echo "selected";}?>>
                                <?php echo display('amount') ?></option>
                            <option value="1" <?php if($setting->discount_type=="1"){ echo "selected";}?>>
                                <?php echo display('percent') ?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <select class="form-control" name="sdtype">
                            ...
                            <option value="0" <?php if($setting->service_chargeType=="0"){ echo "selected";}?>>
                                <?php echo display('amount') ?></option>
                            <option value="1" <?php if($setting->service_chargeType=="1"){ echo "selected";}?>>
                                <?php echo display('percent') ?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <input name="storevat" type="text" class="form-control" id="storevat"
                            placeholder="<?php echo display('vat_tax') ?>" value="<?php echo $setting->vat ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="delivary_time"
                        class="col-xs-3 col-form-label"><?php echo display('mindeltime') ?></label>
                    <div class="col-xs-9">
                        <input name="delivary_time" type="text" class="form-control" id="delivary_time"
                            placeholder="<?php echo display('mindeltime') ?>"
                            value="<?php echo $setting->min_prepare_time ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <select class="form-control" name="timeformat">
                            ...
                            <option value="d/m/Y" <?php if($setting->dateformat=="d/m/Y"){ echo "selected";}?>>
                                dd/mm/yyyy</option>
                            <option value="Y/m/d" <?php if($setting->dateformat=="Y/m/d"){ echo "selected";}?>>
                                yyyy/mm/dd</option>
                            <option value="d-m-Y" <?php if($setting->dateformat=="d-m-Y"){ echo "selected";}?>>
                                dd-mm-yyyy</option>
                            <option value="Y-m-d" <?php if($setting->dateformat=="Y-m-d"){ echo "selected";}?>>
                                yyyy-mm-dd</option>
                            <option value="m/d/Y" <?php if($setting->dateformat=="m/d/Y"){ echo "selected";}?>>
                                mm/dd/yyyy</option>
                            <option value="d M,Y" <?php if($setting->dateformat=="d M,Y"){ echo "selected";}?>>dd M,yyyy
                            </option>
                            <option value="d F,Y" <?php if($setting->dateformat=="d F,Y"){ echo "selected";}?>>dd
                                MM,yyyy</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <textarea name="power_text" class="form-control" placeholder="Powered By Text" maxlength="140"
                            rows="7"><?php echo $setting->powerbytxt ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="footer_text"
                        class="col-xs-3 col-form-label"><?php echo display('footer_text') ?></label>
                    <div class="col-xs-9">
                        <textarea name="footer_text" class="form-control" placeholder="Footer Text" maxlength="140"
                            rows="7"><?php echo $setting->footer_text ?></textarea>
                    </div>
                </div>
