        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="email" class="form-control" type="text"
                            placeholder="<?php echo display('email') ?>" id="email" value="<?php echo $user->email ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <img src="<?php echo base_url(!empty($user->image)?$user->image: "./assets/img/icons/default.jpg") ?>"
                ...
                <div class="form-group row">
                    <label for="istatus"
                        class="col-sm-3 col-form-label"><?php echo display('is_monitor_display') ?></label>
                    <div class="col-sm-9">
                        <div class="checkbox checkbox-success">
                            <input type="checkbox" name="ismonitor" <?php if($user->counter==1){ echo "checked";}?>
