                    ...
                    <table class="table table-bordered table-hover" id="RoleTbl">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-<?php echo ($value->parent_menu?'right':'')?>"><?php echo display($value->menu_title); //echo $value->page_url;  ?></td>
                                <td>
                                ...
                                <td>
                                    <div class="checkbox checkbox-success text-center">
                                        <input type="checkbox" class="del_<?php echo $m?>" name="delete[<?php echo $m?>][<?php echo $sl ?>][]" value="1" <?php echo ((@$ck_data->can_delete==1)?"checked":null) ?> id="delete[<?php echo $m?>]<?php echo $sl?>">
