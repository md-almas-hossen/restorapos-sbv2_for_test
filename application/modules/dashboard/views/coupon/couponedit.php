        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <input name="tokencode" class="form-control" type="text" placeholder="<?php echo display('coupon_Code') ?>" id="tokencode" value="<?php echo (!empty($intinfo->tokencode)?$intinfo->tokencode:null) ?>" required>
                        ...
                        <div class="col-sm-8">
                            <input name="offerstartdate" class="form-control datepicker" type="text"  placeholder="<?php echo  display('token_startdate'); ?>" id="offerstartdate1"  value="<?php echo (!empty(date("d-m-Y", strtotime($intinfo->tokenstartdate)))?date("d-m-Y", strtotime($intinfo->tokenstartdate)):null) ?>" required>
                        </div>
                    </div>
                        <div class="form-group row">
                        <label for="offerendate" class="col-sm-4 col-form-label"><?php echo  display('coupon_enddate'); ?> </label>
                        <div class="col-sm-8">
                            <input name="offerendate" class="form-control datepicker" type="text"  placeholder="<?php echo  display('coupon_enddate'); ?>" id="offerendate1"  value="<?php echo (!empty(date("d-m-Y", strtotime($intinfo->tokenendate)))?date("d-m-Y", strtotime($intinfo->tokenendate)):null) ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
