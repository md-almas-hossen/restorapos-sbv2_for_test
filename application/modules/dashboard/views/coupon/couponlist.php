                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="tokencode"
                                        class="col-sm-4 col-form-label"><?php echo display('coupon_Code')?> *</label>
                                    <div class="col-sm-8">
                                        <input name="tokencode" class="form-control" type="text"
                                            placeholder="<?php echo display('coupon_Code') ?>" id="tokencode" value=""
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tokenrate"
                                        class="col-sm-4 col-form-label"><?php echo  display('coupon_rate'); ?></label>
                                    <div class="col-sm-8">
                                        <input name="tokenrate" class="form-control" type="text"
                                            placeholder="<?php echo  display('coupon_rate'); ?>" id="capacity" value=""
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="offerstartdate"
                                        class="col-sm-4 col-form-label"><?php echo  display('coupon_startdate'); ?></label>
                                    <div class="col-sm-8">
                                        <input name="offerstartdate" class="form-control datepicker" type="text"
                                            placeholder="<?php echo  display('coupon_startdate'); ?>"
                                            id="offerstartdate" value="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="offerendate"
                                        class="col-sm-4 col-form-label"><?php echo  display('coupon_enddate'); ?>
                                    </label>
                                    <div class="col-sm-8">
                                        <input name="offerendate" class="form-control datepicker" type="text"
                                            placeholder="<?php echo  display('coupon_enddate'); ?>" id="offerendate"
                                            value="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $token->tokenid; ?>"
                                    value="<?php echo base_url("dashboard/couponlist/updateintfrm") ?>" />
                                <a onclick="editinfo('<?php echo $token->tokenid; ?>')" class="btn btn-info btn-sm"
                                ...
                                <a href="<?php echo base_url("dashboard/couponlist/delete/$token->tokenid") ?>"
