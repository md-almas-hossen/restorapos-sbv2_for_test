                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="title" class="col-sm-4 col-form-label"><?php echo display('title')?>
                                        *</label>
                                    <div class="col-sm-8">
                                        <input name="title" class="form-control" type="text"
                                            placeholder="<?php echo display('title') ?>" id="title" value="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tokenrate"
                                    ...
                                    <div class="col-sm-8">
                                        <input name="name" class="form-control" type="text"
                                            placeholder="<?php echo  display('name'); ?>" id="name" value="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="review"
                                        class="col-sm-4 col-form-label"><?php echo  display('reviewtxt'); ?></label>
                                    <div class="col-sm-8">
                                        <input name="review" class="form-control" type="text"
                                            placeholder="<?php echo  display('reviewtxt'); ?>" id="offerstartdate"
                                            value="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="rating"
                                        class="col-sm-4 col-form-label"><?php echo  display('rating'); ?> </label>
                                    <div class="col-sm-8">
                                        <input name="rating" class="form-control datepicker" type="text"
                                            placeholder="<?php echo  display('rating'); ?>" id="offerendate" value=""
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $rating->ratingid; ?>"
                                    value="<?php echo base_url("dashboard/rating/updateintfrm") ?>" />
                                <a onclick="editinfo('<?php echo $rating->ratingid; ?>')" class="btn btn-info btn-sm"
                                ...
                                <a href="<?php echo base_url("dashboard/rating/delete/$rating->ratingid") ?>"
