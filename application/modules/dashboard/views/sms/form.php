        ...
        <div class="panel">
            <div class="panel-body">
                <p class="dashboard_sms_form">
                    <?php echo display('smsrankgateway');?> <b><a href="http://door.smsrank.com/signup"
                            target="_blank">here</a></b> <?php echo display('ranktext');?>
                </p>
            </div>
        </div>
    </div>
...
<script src="<?php echo base_url('application/modules/dashboard/assest/js/form.js'); ?>" type="text/javascript">
</script>