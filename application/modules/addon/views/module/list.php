                ...
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                $def_mods = ['dashboard','ordermanage','reservation','purchase','report','itemmanage','production','setting','accounts','hrm','template','addon','qrapp','taxsetting'];
                                if (is_array($map))
                                            ...
                                            <div class="thumbnail">
                                              ...
                                              <div class="caption">
                                                ...
                                                <p>
													...
													?>
													<a onclick="return confirm('<?php echo display("are_you_sure") ?>')"  class="btn btn-success" href="<?php echo base_url($mod.'/androidpos/app_download?module='.$mod.'&downloadurl=https://play.google.com/store/apps/details?id=com.bdtask.bhojonpos') ?>" target="_new"><?php echo display("download") ?></a>
													<?php } } else { ?>
