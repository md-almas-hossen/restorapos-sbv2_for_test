                                ...
                                <div class="col-md-4 themebox  theme_<?php echo $single_theme->themename ?>">
                                    ...
                                    <div class="border-box pnav" id="pnav">
                                        <div class="img_part">
                                            ...
                                            <?php } else{ 
											    $themename=html_escape($single_theme->themename);
												$changename2=base64_encode($themename);
												$changename=rawurlencode('T'.date('m').$changename2.date('d').'M1');
											?>
                                                <a href="<?php echo base_url('addon/theme/active_theme/'.$changename)?>" target='__blank' class="btn btn-dtls"><?php echo display('active')?></a>
                                            <?php  } ?>
                                        ...
                                        ?></h4>
                                            ...
                                            <div class="caption_btn <?php echo ((@$active_theme == $single_theme->themename)?'activated':''); ?>">
												...
												$changename=rawurlencode('T'.date('m').$changename2.date('d').'M1');
												?>
                                                <a href="<?php echo base_url('addon/theme/active_theme/'.$changename)?>" class="btn btn-success"><?php echo display('active')?></a>
