    ...
    <div class="page-wrapper">
        <div class="invoice-card">
            ...
            <div class="invoice-head linehight">
                ...
                <h4 style="font-size:22px;" align="center" class="linehight fontsizepx">
                ...
                <div class="row-data linehight ">
                    ...
                    <div class="item-info linehight fontsizepx">
                        ...
                        <h5 class="item-title linehight fontsizepx"
                            style="font-size:<?php echo $posinvoiceTemplate->fontsize; ?>px; font-weight:bold;">
			...
			if($billinfo->bill_status==1){?>
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        ...
                        <h5 class="item-title linehight fontsizepx"><?php echo display('customer_due_amount'); ?></h5>
                        <?php }else{ ?>
                        <h5 class="item-title linehight fontsizepx">
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx"><?php echo $pmethod->payment_method;?> </h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php echo numbershow($pmethod->paidamount,$settinginfo->showdecimal); ?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
            ...
            <div class="invoice_address linehight">
                ...
                <div class="middle-data linehight ">
                    ...
                    <div class="item-info gap_right linehight">
                        <?php if($orderinfo->cutomertype==3){
							...
							?>
                        <h5 class="item-title linehight fontsizepx">Third
                            Party(<?php echo $thirdpartyinfo->company_name;?>)</h5>
                        <?php }else{?>
                        <h5 class="item-title linehight fontsizepx">
                    ...
                    <div class="item-info linehight ">
                        <h5 class="item-title linehight fontsizepx">
                            ...
                            <?php if($gloinvsetting->order_number_format){?>
                                <?php echo $orderinfo->random_order_number;?></h5>
                            <?php }else{?>
                ...
                <div class="text-center linehight">
                    ...
                    <h3 class="my-0 linehight fontsizepx">
