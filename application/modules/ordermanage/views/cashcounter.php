                    ...
                    <table class="table table-bordered table-hover" id="RoleTbl">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="editmenu('<?php echo $counter->counterno; ?>',<?php echo $counter->ccid; ?>)"  data-toggle="tooltip" data-placement="left" title="<?php echo display('update');?>" class="btn btn-success btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></a>
