                ...
                <div class="panel-title">
                    <div class="btn-group pull-right form-inline">
                        <div style="width: 200px;" class="form-group">
                            ...
                            <select name="thirdparty" class="form-control js-basic-single" id="thirdparty"
                                tabindex="-1">
...
<script src="<?php echo base_url('application/modules/ordermanage/assets/js/thirdpartydueorderlist.js?v=3'); ?>"
