    ...
    <div class="page-wrapper">
        <div class="invoice-card">
					...
					$opentotal=0;
					 ...
					 $itemtotal=$totalamount+$subtotal+$opentotal;
							  ...
							  foreach($billinfo as $bill){
								  ...
								  if(!empty($taxinfos)){
								  $ordertaxinfo=$this->App_android_model->read('*', 'tax_collection', array('relation_id' => $bill->order_id));
			...
			?>
                ...
                <?php } ?>
                <?php $paymentsmethod=$this->App_android_model->allmergepayments($margeid);
				$alltype="";
				$totalpaid=0;
