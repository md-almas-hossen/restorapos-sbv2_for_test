        ...
        <div class="panel-body">
            <div class="table-responsive m-b-20">
                        ...
                        <td>
                            ...
                            <table border="0" class="wpr_100" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="font-size:20px;">Token: <span
                                            style="font-size:25px;"><?php echo $orderinfo->tokenno;?></span></td>
                                </tr>

                                <tr>
                                    <td align="left"><?php echo $customerinfo->customer_name;?></td>
                                    <?php if(!empty($waiterinfo)){?>
                                    <td align="left"><?php echo $waiterinfo->first_name.' '.$waiterinfo->last_name;?>
                                    </td>
                                    <?php } ?>
                                </tr>
                            </table>
			 ...
			 foreach ($iteminfo as $item){
						...
						$adonsprice=0;
						$alltoppingprice=0;
						$newitem=$this->App_android_model->read('*','order_menu', array('row_id' =>$item->row_id,'isupdate'=>1));
						$isexitsitem=$this->App_android_model->readupdate('tbl_updateitemssunmi.*,SUM(tbl_updateitemssunmi.qty) as totalqty', 'tbl_updateitemssunmi', array('ordid' =>$item->order_id,'menuid'=>$item->menu_id,'varientid'=>$item->varientid,'addonsuid'=>$item->addonsuid));
			...
			foreach ($exitsitem as $exititem){				
				$isexitsitem=$this->App_android_model->read('*', 'order_menu', array('order_id' =>$orderinfo->order_id,'menu_id'=>$exititem->menuid,'varientid'=>$exititem->varientid,'addonsuid'=>$exititem->addonsuid));
				...
				?>
                                <tr>
                                    <td align="left">
                                        <?php echo $sign;?><?php echo quantityshow($exititem->qty,$item->is_customqty);?>
                                        <?php //echo $exititem->qty;?></td>
