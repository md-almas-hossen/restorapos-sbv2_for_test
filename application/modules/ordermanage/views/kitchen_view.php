						...
						if( strpos($allchecked2, '0') !== false ) {
								  $isaccept= 0;
                                    ...
                                    <div class="food_item_top">
                                        ...
                                        <div class="item_inner">
                                            <h4 class="kf_info"><?php echo display('customer_name') ?>: <?php echo $orderinfo->customer_name;?></h4>						<h4 class="kf_info"><?php echo display('type') ?>: <?php 
                                    ...
                                    <div class="food_select" id="acceptitem<?php echo $orderinfo->order_id.$kitchenid;?>">
                                        ...
                                        <div class="single_item">
                                            <div class="align-center justify-between position-relative mb-13">
                                                ...
                                                <h4 class="quantity"><?php echo quantityshow($item->menuqty,$item->is_customqty);?>x</h4>
                                            </div>
                                            <?php if((!empty($item->add_on_id))||(!empty($item->tpid))){
											...
											$tp=0;	if(!empty($topping[0])){
													foreach($topping as $toppingid){
                                                          $tpinfo=$this->order_model->read('*', 'add_ons', array('add_on_id' => $toppingid));											  if($toppingposition[$tp]==1){
															  echo $tpinfo->add_on_name.'_Left Half Side,';
														  }
														 else if($toppingposition[$tp]==2){
															   echo $tpinfo->add_on_name.'_Right Half Side,';
														  }
														  else if($toppingposition[$tp]==3){
															  echo $tpinfo->add_on_name.'_Whole Side,';
														  }else{
