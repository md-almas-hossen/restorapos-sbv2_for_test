                ...
                <div class="row-data linehight">
                    ...
                    <div class="item-info linehight">
                        ...
                        <h5 class="item-title linehight fontsizepx" style="font-size:18px; font-weight:bold;">
                            ...
                            <?php echo date($posinvoiceTemplate->date_time_formate, strtotime($mainorderinfo->order_date)); ?>
                        </h5>
...
if ($isvatinclusive->isvatinclusive == 1) {
    $gtotal = $total + $servicecharge - $alldiscount;
} else {
...
foreach ($iteminfo as $item) {
    ...
    if (isset($presentsub[$item->row_id])) {
        $splitQty = $presentsub[$item->row_id];
    }
                        ...
                        <div class="row-data linehight">
                            ...
                            <div class="text-right linehight">
                                <p class="item-number linehight fontsizepx">
                                    ...
                                    <?php echo quantityshow($splitQty, $item->is_customqty); ?></p>
...
?>
            ...
            <div class="invoice-footer mb-15 linehight">
                ...
                <?php }
$paymentsmethod = $this->order_model->allsubpayments($mainorderinfo->order_id, $orderinfo->sub_id);
$alltype        = "";
$totalpaid      = 0;
...
if ($orderinfo->is_duepayment == 1) {
            ...
            echo "Paid Amount" . $pmethod->payment_method . "(" . $allcard . ")";
        }
        ?></h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx">
...
if ($orderinfo->is_duepayment == 1) {
            ...
            echo "Paid Amount" . $pmethod->payment_method . "(" . $allmobile . ")";
        }
        ?></h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx">
...
if ($orderinfo->is_duepayment == 1) {
            ...
            echo "Paid Amount" . $pmethod->payment_method;
        }
        ?></h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx">
...
?>
            ...
            <div class="invoice_address linehight">
                ...
                <div class="middle-data linehight">
                    ...
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx">
                            <?php echo(!empty($posinvoiceTemplate->order_no) ? $posinvoiceTemplate->order_no : display('orderno')); ?>:<?php echo $mainorderinfo->saleinvoice; ?>(<?php echo $orderinfo->sub_id; ?>)
                        </h5>
                    </div>
                    <?php }?>
...
if ($gloinvsetting->qroninvoice == 1) {
    ?>
            ...
            <div class="invoice_address linehight">
                ...
                <div class="middle-data linehight">
                    <p class="my-0 linehight fontsizepx">
                        <?php echo(!empty($mainorderinfo->delivaryaddress) ? $mainorderinfo->delivaryaddress : $customerinfo->customer_address) ?>
                    </p>
                </div>
