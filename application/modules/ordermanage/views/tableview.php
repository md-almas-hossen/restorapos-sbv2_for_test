...
if($settinginfo->tablemaping==1){?>
<div class="row kitchen-tab no-bg">
                            <?php 
                                $row = count($tableinfo);
                                $numOfCols = 3;
                                $rowCount = 0;
 ...
 <?php if (!empty($tableinfo)) { 
  ...
  foreach ($tableinfo as $table) {
								...
								if($table['sum'] >= 1){ $onclick =""; $Cl="";}
								else{
									$onclick ="onclick='selecttable(".$table['tableid'].")'";
									$Cl="Tfree";
									}
								...
								?>
                                <input id="chkboxmap-<?php echo
                                            $table['tableid']?>" type="hidden"  name="add_table[]" value="<?php 
                                            echo $table['tableid']?>">
                        <input type="hidden" min="1" value="<?php echo $table['person_capicity'];?>" class="form-control add_input" placeholder="Person" name="person-<?php echo $table['tableid'];?>" id="person-<?php echo $table['tableid'];?>">
                                <div class="restora-table <?php echo $icon;?> <?php if($table['sum'] >= 1){ echo 'active';}?> <?php echo $Cl;?>" <?php echo $onclick;?> id="<?php echo $table['tableid'];?>" <?php echo $style;?> data-itemid='<?php echo $table['tableid'];?>'>
                        ...
                        <?php } }?>
                        <input id="table_member" type="hidden" value="" />
                        </div>
 <?php } ?>