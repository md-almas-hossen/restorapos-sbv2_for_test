    ...
    <div class="invoice-card">
        ...
        <div class="invoice-head linehight">
            ...
            <img src="<?php echo base_url();?><?php echo (!empty($posinvoiceTemplate->logo)?$posinvoiceTemplate->logo:$storeinfo->logo)?>"
                alt="" style="max-height: 100px !important;max-width:250px;margin-bottom: 5px;padding-top: 10px;">
            ...
            <p class="my-0 text-center linehight fontsizepx"><strong>Mobile: <?php echo $storeinfo->phone;?></strong>
            </p>
			...
			if(!empty($item->add_on_id)){
				$y=0;
                    ...
                    <div class="row-data linehight">
                        ...
                        <h5 class="linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
			 ...
			 if(!empty($openiteminfo)){
                    ...
                    <div class="row-data">
                        ...
                        <div class="text-right">
                            ...
                            <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
        ...
        <div class="invoice-footer mb-15">
            ...
            <div class="row-data">
                ...
                <h5 class="my-5 fontsizepx">
                    <?php if($currency->position==1){echo $currency->curr_icon;}?><?php $sdcharge=0; if(empty($billinfo)){ echo numbershow($sdcharge,$settinginfo->showdecimal);} else{echo $sdcharge=numbershow($billinfo->service_charge,$settinginfo->showdecimal);} ?><?php if($currency->position==2){echo $currency->curr_icon;}?>
                </h5>
            </div>
            ...
            <div class="row-data">
                <div class="item-info">
                    <h5 class="item-title fontsizepx">
                        <?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?><?php $discountpercent=($duedis*100)/($billinfo->total_amount+$billinfo->service_charge+$billinfo->VAT)?>(<?php //echo number_format($discountpercent,3)?>%)
                    </h5>
                </div>
                <h5 class="my-5 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                    <?php if(empty($billinfo)){ echo numbershow($duedis,$settinginfo->showdecimal);} else{echo $duedis= numbershow($duedis,$settinginfo->showdecimal);} ?>
                    <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
            </div>
            <?php }else{   
            ...
            <div class="row-data">
                <div class="item-info">
                    <h5 class="item-title fontsizepx">
                        <?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?><?php $discountpercent=($discount*100)/($billinfo->total_amount+$billinfo->service_charge+$billinfo->VAT)?>(<?php //echo number_format($discountpercent,3)?>%)
                    </h5>
                </div>
                <h5 class="my-5 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                    <?php $discount=0; if(empty($billinfo)){ echo numbershow($discount,$settinginfo->showdecimal);} else{echo $discount= numbershow($billinfo->discount-$billinfo->allitemdiscount,$settinginfo->showdecimal);} ?>
                    <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
            </div>
            <?php } }
            ...
            <div class="row-data linehight">
                <div class="item-info linehight fontsizepx">
                    <h5 class="item-title linehight fontsizepx">Adjustment
            ...
            <div class="row-data">
                <div class="item-info">
                    <h5 class="item-title fontsizepx"><?php echo $mvat['tax_name'];?></h5>
                </div>
                <h5 class="my-5 fontsizepx">
                    <?php if($currency->position==1){echo $currency->curr_icon;}?>
            ...
            <div class="row-data border-top">
                <div class="item-info">
                    <h5 class="item-title text-bold fontsizepx">
            ...
            <div class="row-data">
                ...
                <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                    <?php if($customepaid>$billinfo->bill_amount) {echo numbershow($customepaid-$billinfo->bill_amount,$settinginfo->showdecimal);}else{echo "0.00";} ?>
                    <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
            </div>
            <?php 
                }
        ...
        <div class="invoice_address">
            ...
            <div class="middle-data">
                ...
                <div class="item-info gap_right fontsizepx">
                    <?php if($posinvoiceTemplate->order_no_show==3){
							...
							?>
                    <h5 class="item-title fontsizepx">Third Party(<?php echo $thirdpartyinfo->company_name;?>)</h5>
                    <?php }else{?>
                    <h5 class="item-title fontsizepx">
                ...
                <div class="item-info fontsizepx">
                    <h5 class="item-title fontsizepx">
            ...
            <div class="middle-data">
                <div class="text-center">
                    <h5 class="item-title fontsizepx" style="font-size:18px; font-weight:bold;">
        ...
        <div class="invoice_address linehight">
            ...
            <div class="linehight">
                <p class="my-0 linehight fontsizepx"><span
                        style="font-weight: 600;"><?php echo display('name');?>:</span>
                    <?php echo $main_customerinfo->customer_name?></p>
            </div>
            <?php } if($posinvoiceTemplate->customer_mobile==1){?>
            <div class="linehight">
                <p class="my-0 linehight fontsizepx"><span
                        style="font-weight: 600;"><?php echo display('phone');?>:</span>
                    <?php echo $main_customerinfo->customer_phone; ?></p>
            </div>
            <?php } ?>
            ...
            <div class="linehight">
                <p class="my-0 linehight fontsizepx"><span
                        style="font-weight: 600;"><?php echo display('address');?>:</span>
                    <?php echo (!empty($orderinfo->delivaryaddress) ? $orderinfo->delivaryaddress : $main_customerinfo->customer_address) ?>
                </p>
            </div>
            <?php } ?>
        </div>
