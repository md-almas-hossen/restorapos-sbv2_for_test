...
//                        dd($thirdpartyinfo);
                    ...
                    <?php
                    if ($customerType == 'Third Party') {
                        echo '<h4 style="font-size:18px;" class="item-title linehight fontsizepx"><strong>( ' . $thirdpartyinfo->company_name . ' )</strong></h4>';
                    }
                    ?>
                <?php }
        ...
        <div class="invoice-details linehight">
            <div class="invoice-list linehight">
                <div class="invoice-title linehight fontsizepx">
                    ...
                    foreach ($iteminfo as $item){
                        ...
                        <div class="row-data linehight">
                            ...
                            <div class="text-right linehight">
                                ...
                                <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow($itemprice,$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                            </div>
                        </div>
                        <?php
                        if(!empty($item->add_on_id)){
                            ...
                            foreach($addons as $addonsid){
                                ...
                                <div class="row-data linehight">
                                    ...
                                    <h5 class="linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow($adonsinfo->price*$addonsqty[$y],$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                                </div>
                                <?php $y++;
                            }
                        }
                            ...
                            foreach($topping as $toppingid){
                                ...
                                <div class="row-data">
                                    <div class="item-info">
                                        ...
                                        <p class="item-number fontsizepx"><?php //echo $toppingprice[$tp];?></p>
                                    </div>
                                    <h5 class="fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow($toppingprice[$t],$settinginfo->showdecimal);?><?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                                </div>
                                <?php $t++;
                            }
                        }
                        ...
                        foreach($openiteminfo as $openfood){
                            ...
                            <div class="row-data">
                                ...
                                <div class="text-right">
                                    ...
                                    <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $openitemtotal;?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                                </div>
                            </div>
        ...
        <div class="invoice-footer mb-15">
            <?php if($posinvoiceTemplate->subtotal_level_show==1){?>
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title fontsizepx" style="font-size:22px;"><strong><?php echo (!empty($posinvoiceTemplate->subtotal_level)?$posinvoiceTemplate->subtotal_level:display('subtotal'));?></strong></h5>
                    </div>
                    <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow($billinfo->total_amount,$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
            <?php } ?>
            <div class="row-data">
                <div class="item-info">
                    <h5 class="item-title fontsizepx"><?php echo "Items Discount";?></h5>
                </div>
                <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow($billinfo->allitemdiscount,$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
            </div>

            <?php if($posinvoiceTemplate->servicechargeshow==1){?>
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->service_charge)?$posinvoiceTemplate->service_charge:display('service_chrg'));?></h5>
                    </div>
                    <h5 class="my-5 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?><?php $sdcharge=0; if(empty($billinfo)){ echo numbershow($sdcharge,$settinginfo->showdecimal);} else{echo $sdcharge=numbershow($billinfo->service_charge,$settinginfo->showdecimal);} ?><?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
            <?php } if($posinvoiceTemplate->discountshow==1){
                ...
                if($duedisst==1){
                    ...
                    <div class="row-data">
                        <div class="item-info">
                            <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?><?php $discountpercent=($duedis*100)/($billinfo->total_amount+$billinfo->service_charge+$billinfo->VAT)?>(<?php //echo number_format($discountpercent,3)?>%)</h5>
                        </div>
                        <h5 class="my-5 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php if(empty($billinfo)){ echo numbershow($duedis,$settinginfo->showdecimal);} else{echo $duedis= numbershow($duedis,$settinginfo->showdecimal);} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                    </div>
                <?php }else{
                    ...
                    <div class="row-data">
                        <div class="item-info">
                            <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?><?php $discountpercent=($discount*100)/($billinfo->total_amount+$billinfo->service_charge+$billinfo->VAT)?>(<?php //echo number_format($discountpercent,3)?>%)</h5>
                        </div>
                        <h5 class="my-5 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php $discount=0; if(empty($billinfo)){ echo numbershow($discount,$settinginfo->showdecimal);} else{echo $discount= numbershow($billinfo->discount-$billinfo->allitemdiscount,$settinginfo->showdecimal);} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                    </div>
                <?php } }
            ...
            <?php if($posinvoiceTemplate->vatshow==1){
                if(empty($taxinfos)){?>
                    <div class="row-data">
                        <div class="item-info">
                            <h5 class="item-title fontsizepx" style="font-size:15px;"><strong><?php echo (!empty($posinvoiceTemplate->vat_level)?$posinvoiceTemplate->vat_level:display('vat_tax'));?>(<?php echo $storeinfo->vat;?>%)</strong></h5>
                        </div>
                        <h5 class="my-5 fontsizepx">
                            <?php if($currency->position==1){echo $currency->curr_icon;}?>
                ...
                <?php }else{
                    ...
                    foreach($taxinfos as $mvat){
                        if($mvat['is_show']==1){
                            ...
                            <div class="row-data">
                                <div class="item-info">
                                    <h5 class="item-title fontsizepx" style="font-size:15px;"><strong><?php echo $mvat['tax_name'];?></strong></h5>
                                </div>
                                <h5 class="my-5 fontsizepx">
                                    <?php if($currency->position==1){echo $currency->curr_icon;}?>
            ...
            <?php if($posinvoiceTemplate->grandtotalshow==1){
                $grandtotal= $billinfo->bill_amount;
                if($duedisst==1){
                    $grandtotal= $billinfo->bill_amount-$duedis;
                }
                ?>
                <div class="row-data border-top">
                    <div class="item-info">
                        <h5 class="item-title text-bold fontsizepx" ><?php echo (!empty($posinvoiceTemplate->grand_total)?$posinvoiceTemplate->grand_total:display('grand_total'));?></h5>
                    </div>
                    <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow($grandtotal,$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
            <?php }
            ...
            if($billinfo->bill_status==1){?>
                <?php if($posinvoiceTemplate->customer_paid_show == 1){?>
                    <div class="row-data">
                        <div class="item-info">
                            <h5 class="item-title fontsizepx">
                                <?php
                        ...
                        <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow($customepaid,$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                    </div>
                <?php } ?>
            <?php } else{
                if($posinvoiceTemplate->total_due_show==1){
                    ...
                    if($duedisst==1){
                        $customepaid= $customepaid-$duedis;
                    }
                    ?>
                    <div class="row-data">
                        <div class="item-info">
                            <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->total_due)?$posinvoiceTemplate->total_due:display('total_due'));?></h5>
                        </div>
                        <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow($customepaid,$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                    </div>
                    <?php
            ...
            ?>
            <?php
            if($orderinfo->splitpay_status==1){
                $paymentsmethod=$this->order_model->splitallpayments($orderinfo->order_id);
            }else{
            ...
            foreach($paymentsmethod as $pmethod){
                ...
                if($pmethod->payment_type_id==1){
                    ...
                    <div class="row-data">
                        <div class="item-info">
                            <h5 class="item-title fontsizepx"><?php
                                if($orderinfo->is_duepayment==1){
                                    echo "Due";
                                }else{
                        ...
                        <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow($pmethod->paidamount,$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                    </div>
                <?php }
                ...
                <?php }else{
                    ...
                    if($orderinfo->is_duepayment != 1){
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title fontsizepx"><?php echo $pmethod->payment_method;?> </h5>
                            </div>
                            <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow($pmethod->paidamount,$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                        </div>
                        <?php
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title fontsizepx"><?php echo "Due";?> </h5>
                            </div>
                            <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow($pmethod->paidamount,$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                        </div>
                    <?php }
            ...
            ?>
            <?php
            if($posinvoiceTemplate->change_due_show==1){
                if($orderinfo->is_duepayment != 1){
                    ?>
                    <div class="row-data">
                        <div class="item-info">
                            <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->change_due_level)?$posinvoiceTemplate->change_due_level:display('change_due'));?></h5>
                        </div>
                        <h5 class="my-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php if($customepaid>$billinfo->bill_amount) {echo numbershow($customepaid-$billinfo->bill_amount,$settinginfo->showdecimal);}else{echo "0.00";} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                    </div>
                    <?php
                }
            }
            if($billinfo->bill_status==1){
                if($orderinfo->is_duepayment != 1){
                    ...
                    <div class="row-data">
                        <div class="item-info">
                            <h5 class="item-title fontsizepx"><?php echo display('totalpayment')?></h5>
                        </div>
                        <h5 class="my-0 fontsizepx"> <?php if($billinfo->bill_status==1){if($currency->position==1){echo $currency->curr_icon;} echo numbershow($totalpaid,$settinginfo->showdecimal); if($currency->position==2){echo $currency->curr_icon;} } else{ if($currency->position==1){echo $currency->curr_icon;} echo numbershow($customepaid,$settinginfo->showdecimal);if($currency->position==2){echo $currency->curr_icon;} }?></h5>
                    </div>
                    <?php
                }
            } ?>
        ...
        <div class="invoice_address">
            <?php if($posinvoiceTemplate->billing_to_show==1 || $posinvoiceTemplate->bill_by_show==1){?>
                <div class="row-data" style="margin-bottom:8px;">
                    <?php if($posinvoiceTemplate->billing_to_show==1){?>
                        <div class="item-info">
                            <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->billing_to)?$posinvoiceTemplate->billing_to:display('billing_to'));?>: <?php echo $customerinfo->customer_name;?></h5>
                        </div>
                    <?php } if($posinvoiceTemplate->bill_by_show==1){ ?>
                        <h5 class="my-0 fontsizepx"><?php echo (!empty($posinvoiceTemplate->bill_by)?$posinvoiceTemplate->bill_by:display('bill_by'));?>: <?php echo $cashierinfo->firstname.' '.$cashierinfo->lastname;?></h5><?php } ?>
                </div>
            <?php } if($posinvoiceTemplate->table_level_show==1 || $posinvoiceTemplate->order_no_show==1){?>
                <div class="middle-data">
                    <?php if($posinvoiceTemplate->table_level_show==1){?>
                        <div class="item-info gap_right fontsizepx" style="margin-bottom:8px;">
                            <?php if($posinvoiceTemplate->order_no_show==3){
                                $thirdpartyinfo=$this->db->select('*')->where('companyId',$orderinfo->isthirdparty)->get('tbl_thirdparty_customer')->row();
                                ?>
                                <h5 class="item-title fontsizepx" style="font-size:22px;"><strong>Third Party(<?php echo $thirdpartyinfo->company_name;?>)</strong></h5>
                            <?php }else{?>
                                <h5 class="item-title fontsizepx" style="font-size:22px;"><strong><?php echo (!empty($posinvoiceTemplate->table_level)?$posinvoiceTemplate->table_level:display('table'));?>: <?php echo $tableinfo->tablename;?></strong></h5>
                            <?php } ?>
                        </div>
                    <?php } if($gloinvsetting->invorder==1){?>
                        <div class="item-info fontsizepx" style="font-size:22px;">
                            <h5 class="item-title fontsizepx" style="font-size:22px;"><strong><?php echo (!empty($posinvoiceTemplate->order_no)?$posinvoiceTemplate->order_no:display('orderno'));?>: <?php echo getPrefixSetting()->sales. '-'.$orderinfo->order_id;?></strong></h5>
                        </div>
                    <?php } ?>
                </div>
            <?php }
            if($posinvoiceTemplate->payment_status_show==1){
                ...
                <div class="middle-data">
                    <div class="text-center">
                        <h5 class="item-title fontsizepx" style="font-size:18px; font-weight:bold;"><?php echo (!empty($posinvoiceTemplate->payment_status)?$posinvoiceTemplate->payment_status:display('payment_status'));?>: <?php
                            if($orderinfo->is_duepayment==1){
                                echo "Due";
                            }else{
            ...
            <?php } if($posinvoiceTemplate->footertextshow=='1'){ ?>
                <div class="text-center">
                    ...
                    <h3 class="mt-0 fontsizepx"><?php echo (!empty($posinvoiceTemplate->footer_text)?$posinvoiceTemplate->footer_text:display('thanks_you'));?></h3>
                    <?php //}
            ...
            if($gloinvsetting->qroninvoice==1){
                ?>
                <div class="text-center fontsizepx">
                    <?php $qr=Zatca($orderinfo->order_id);?>
                    <img src="<?php echo $qr;?>" alt="QR Code" />
                </div>
            <?php } ?>
        </div>
        <?php if($main_customerinfo->customer_id >1){?>
            <div class="invoice_address linehight">
