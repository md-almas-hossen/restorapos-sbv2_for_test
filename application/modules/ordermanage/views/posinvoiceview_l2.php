                ...
                <?php $this->load->model('ordermanage/order_model',	'ordermodel');
				  ...
				  $totalamount=0;
                    ...
                    <tr>
                        ...
                        <td valign="top" class="p-0 text-right fontsizepx"><p class="mb-0"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow(floor($itemprice-$ptdiscount),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p></td>
                    </tr>
             ...
             <?php $y++;
					...
					if(!empty($openiteminfo)){
									foreach($openiteminfo as $openfood){
                                     ...
                                     <tr>
                        				<td class="p-0 fontsizepx"><p class="mb-0 fontsizepx"><?php echo $openfood->foodname;?>-<?php echo "Regular";?></p><small class="mb-0 text-italic fontsizepx"><?php echo number_format(floor($openprice));?> x <?php echo $openqty;?></small></td>
                        				<td valign="top" class="p-0 text-right fontsizepx"><p class="mb-0"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo number_format(floor($openitemtotal));?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p></td>
                    				 </tr>
										<?php }
									}			 
