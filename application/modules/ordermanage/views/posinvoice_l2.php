...
<div id="printableArea" class="bill__container bill-pos-mini__container" style="width: 278px; font-size:11px;">
    ...
    <?php if($posinvoiceTemplate->company_name_show==1){?>
        ...
        <div>
            ...
            <p class="mb-0 linehight fontsizepx"><b class="text-bold fontsizepx"><?php echo (!empty($posinvoiceTemplate->order_no)?$posinvoiceTemplate->order_no:display('orderno'));?>: </b> #<?php echo $orderinfo->saleinvoice;?></p>
        ...
        <div class="pb-3 border-bottom--dashed linehight">
            <table class="w-100 linehight">
                <thead class="linehight">
                    <th style="width: 50%; text-align: left;" class="fontsizepx linehight" ><strong><?php echo display('item')?></strong></th>
                    <th style="width: 50%; text-align: right;" class="fontsizepx linehight"><strong><?php echo display('total')?></strong></th>
                </thead>
                <tbody>
                <?php $this->load->model('ordermanage/order_model',	'ordermodel');
				  ...
				  $totalamount=0;
					...
					?>
                    <tr>
                        <td class="p-0 fontsizepx linehight" ><p class="mb-0 fontsizepx"><?php echo $item->ProductName;?>-<?php echo $item->variantName;?></p><small class="mb-0 text-italic fontsizepx"><?php echo numbershow(floor($singleprice),$settinginfo->showdecimal);?> x <?php echo quantityshow($item->menuqty,$item->is_customqty);?></small></td>
                        <td valign="top" class="p-0 text-right fontsizepx linehight"><p class="mb-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow(floor($itemprice-$ptdiscount),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p></td>
                    </tr>
             ...
             <?php $y++;
					...
					if(!empty($openiteminfo)){
									foreach($openiteminfo as $openfood){
                                     ...
                                     <tr>
                        				<td class="p-0 fontsizepx"><p class="mb-0 fontsizepx"><?php echo $openfood->foodname;?>-<?php echo "Regular";?></p><small class="mb-0 text-italic"><?php echo number_format(floor($openprice));?> x <?php echo $openqty;?></small></td>
                        				<td valign="top" class="p-0 text-right fontsizepx"><p class="mb-0 fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo number_format(floor($openitemtotal));?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p></td>
                    				 </tr>
										<?php }
									}			 
        ...
        <?php if($posinvoiceTemplate->subtotal_level_show==1){?>
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow(floor($billinfo->total_amount),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
             <?php } ?>
            <div class="d-flex justify-content-between align-items-center mb-2">
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php echo "Items Discount";?><?php //echo $discountpr;?></p>
                <p class="mb-0 text-note text-primary linehight fontsizepx">-<?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow(floor($billinfo->allitemdiscount),$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            <?php if($posinvoiceTemplate->discountshow==1){?>
            <div class="d-flex justify-content-between align-items-center mb-2 linehight">
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?><?php $discountpercent=($discount*100)/($billinfo->total_amount+$billinfo->service_charge+$billinfo->VAT)?>(<?php //echo number_format($discountpercent,3)?>%)<?php //echo $discountpr;?></p>
            ...
            <div class="d-flex justify-content-between align-items-center mb-2 linehight">
                ...
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow(floor($calvat),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            <?php }else{
              $i=0;
              ...
              ?>
              <div class="d-flex justify-content-between align-items-center mb-2 linehight">
                  <p class="mb-0 text-note text-primary linehight fontsizepx"><?php echo $mvat['tax_name'];?>:</p>
                  <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow(floor($taxinfo->$fieldname),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
              </div>
           <?php $i++;} }} }?>
        </div>
        <div class="border-bottom--dashed linehight">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2 linehight">
                ...
                <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow(floor($billinfo->bill_amount),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            <?php }
            ...
            <div class="d-flex justify-content-between align-items-center mb-2 linehight">
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->cutomer_paid_amount)?$posinvoiceTemplate->cutomer_paid_amount:display('customer_paid_amount'));?>:</p>
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow(floor($customepaid),$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            <?php } else{ 
			if($posinvoiceTemplate->total_due_show==1){
			?>
            <div class="d-flex justify-content-between align-items-center linehight">
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->total_due)?$posinvoiceTemplate->total_due:display('total_due'));?>:</p>
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow(floor($customepaid),$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            <?php } } ?>
            <?php $paymentsmethod=$this->order_model->allpayments($orderinfo->order_id);
				...
				foreach($paymentsmethod as $pmethod){
						...
						if($pmethod->payment_type_id==1){
                            ...
                            <div class="border-bottom--dashed linehight fontsizepx">
                                <div class="d-flex justify-content-between align-items-center mb-2 linehight">
            ...
            <div class="d-flex justify-content-between align-items-center linehight">
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->change_due_level)?$posinvoiceTemplate->change_due_level:display('change_due'));?>:</p>
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php if($totalpaid>$billinfo->bill_amount) {echo numbershow(floor($totalpaid-$billinfo->bill_amount),$settinginfo->showdecimal);}else{echo "0.00";} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            <?php } ?>
        </div>
        ...
        <div class="">
            <div class="d-flex justify-content-between linehight">
                <p class="text-note text-center mb-0 linehight fontsizepx">+ <?php echo display('totalpayment')?></p>
                <?php if($billinfo->bill_status==1){?><p class="mb-0 text-note fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow(floor($customepaid),$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
				<?php } else{?><p class="mb-0 text-note linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow(floor($customepaid),$settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p><?php } ?>
            </div>
        </div>
        <?php } ?>
    </div>
    <div class="">
        <div class="mx-auto mb-1 linehight fontsizepx" style="width: 25%; border: 1px solid rgb(0, 0, 0);"></div>
		...
		if($posinvoiceTemplate->payment_status_show==1){
		 ?>
        <div class="middle-data linehight fontsizepx">
...
<?php 
				 ...
				 ?>
                <div class="border-top py-1 linehight fontsizepx">
