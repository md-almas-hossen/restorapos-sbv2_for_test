...
<div class="pos-wrap">
    <div class="pos-sidebar">
        ...
        <div class="align-center d-flex cat-name">
            <div class=" cat-name_text"><?php echo display('All_Items'); ?></div>
                    ...
                    if ($isAdmin == 1) { ?>
                        <li>
                            <a href="javascript:void(0)" class="has-arrow" style="background:<?php echo $category->catcolor; ?>">
                                <div class="cat-icon">
                                    <img src="<?php echo base_url(!empty($category->caticon) ? $category->caticon : 'application/modules/itemmanage/assets/images/dummy_26x26_.jpg'); ?>" alt="">
                                </div>
...
<script src="<?php echo base_url('application/modules/ordermanage/assets/js/posupdateother.js?v=1.0'); ?>" type="text/javascript"></script>
