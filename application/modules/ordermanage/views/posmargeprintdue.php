...
<body>
    <div class="page-wrapper">
        <div class="invoice-card"><?php //print_r($posinvoiceTemplate);?>
            ...
            <div class="invoice-footer mb-15 linehight">
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx">
                            <?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?><?php $discountpercent=($discount*100)/($allsubtotal+$servicecharge+$calvat)?>(<?php //echo number_format($discountpercent,3)?>%)
                        </h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                ...
                <div class="middle-data linehight">
                    ...
                    <div class="item-info gap_right linehight fontsizepx">
                        <h5 class="item-title linehight fontsizepx">
                            ...
                            <?php echo $allorder_tablel;//$tableinfo->tablename;?></h5>
                    </div>
