    ...
    <div id="printableArea" class="print_area">
        <div class="panel-body">
            <div class="table-responsive m-b-20">
                ...
                <table border="0" class="font-18 wpr_100" style="width:100%; font-size:20px;width:100%;border-bottom: 2px #090909 dotted;">
                
                    <h2 style="text-align: left;">
                        Table No:<?php //echo $orderinfo->table_no;?> <?php if(!empty($tableinfo)){ echo $tableinfo->tablename;}?>
                        Token No:<?php echo $orderinfo->tokenno;?>
                    </h2>

                    <tr>
                        <td>

                            <table border="0" class="wpr_100" style="width:100%;border-bottom: 2px #090909 dotted;">

                                <tr>
                                    <td align="left" style="font-size:20px;"><span
                                            style="font-size:18px;"><?php echo display('type')?></span>:<?php echo $custype;?>
                                    </td>
                                    <td align="left" style="font-size:20px;">
                                        <!-- Token: <span style="font-size:25px;"><?php //echo $orderinfo->tokenno;?></span> -->
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left">W. Name: <?php echo $waiterinfo->first_name.' '.$waiterinfo->last_name;?>
                                    </td>
                                    <?php } ?>
                                </tr>
                            </table>
			...
			foreach ($exitsitem as $exititem){				
				...
				?>
                                <tr>
                                    <td align="left" style="font-size: 16px;font-weight: 600;"><?php echo $exititem->ProductName;?><br><?php echo $notes;?></td>
                                    <td align="left" style="font-size: 16px;font-weight: 600;"><?php echo $exititem->variantName;?></td>
                                    <td align="left" style="font-size: 16px;font-weight: 600;"><?php echo $sign;?><?php echo quantityshow($exititem->qty,$item->is_customqty);?></td>
                                </tr>
                                <?php 
			}
			?>
                ...
                <?php if($orderinfo->customer_note){ ?>
                    ...
                    <table>
                        ...
                        <tr>
                            <td align="left" style="font-size:20px;"><span
                                    style="font-size:18px;"><?php echo display('ordnote')?></span>: <?php echo $orderinfo->customer_note;?>
                            </td>
                            <td align="left" style="font-size:20px;">
                                <!-- Token: <span style="font-size:25px;"><?php //echo $orderinfo->tokenno;?></span> -->
                            </td>
                ...
                <?php 
		       $gloinvsetting= $this->db->select('*')->from('tbl_invoicesetting')->where('token_history',1)->get()->row();
		       if($gloinvsetting->token_history ==1){
		       if($getTokenHistory){ ?>
