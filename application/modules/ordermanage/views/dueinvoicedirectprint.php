    ...
    <div class="invoice-card">
        <?php if ($posinvoiceTemplate->invoice_logo_show == 1 || $posinvoiceTemplate->company_name_show == 1 || $posinvoiceTemplate->company_address == 1) { ?>
            <div class="invoice-head linehight">
                ...
                if ($posinvoiceTemplate->mushak == 1) { ?>
                    <p class="my-0 text-center linehight fontsizepx" style="font-size:22px;"><strong>Mushak-6.3</strong></p>
                <?php } ?>
            </div>
        <?php } ?>
                ...
                <div class="invoice-data linehight">
                    ...
                    foreach ($iteminfo as $item) {
                        ...
                        <div class="row-data linehight">
                            ...
                            <div class="text-right linehight fontsizepx">
                                <?php
                                if ($settinginfo->showdecimal == 0) {
                                    if ($item->is_customqty == 1) {
                                        $showqty = $item->menuqty;
                                    } else {
                                        $showqty = round($item->menuqty);
                                    }
                                    $showprice = round($singleprice);
                                } else {
                                    if ($item->is_customqty == 1) {
                                        $showqty = $item->menuqty;
                                    } else {
                                    ...
                                    $showprice = number_format($singleprice, $settinginfo->showdecimal);
                                }
                                ?>
                                <p class="item-number linehight fontsizepx"><?php echo $showprice; ?> x <?php echo $showqty; ?></p>
                                <h5 class="my-0 linehight fontsizepx">
                                    <?php if ($currency->position == 1) {
                                        echo $currency->curr_icon;
                                    } ?>
                                    <?php if ($settinginfo->showdecimal == 0) {
                                        echo round($itemprice);
                                    } else {
                                        echo number_format($itemprice, $settinginfo->showdecimal);
                                    } ?>
                            ...
                            foreach ($addons as $addonsid) {
                                ...
                                <div class="row-data linehight">
                                    <div class="item-info linehight">
                                        ...
                                        <p class="item-number linehight fontsizepx"><?php if ($settinginfo->showdecimal == 0) {
                                                echo round($adonsinfo->price);
                                            } else {
                                                echo number_format($adonsinfo->price, $settinginfo->showdecimal);
                                            } ?> x <?php echo $addonsqty[$y]; ?></p>
                                    </div>
                                    <h5 class="fontsizepx">
                                        <?php if ($currency->position == 1) {
                                            echo $currency->curr_icon;
                                        ...
                                        <?php if ($settinginfo->showdecimal == 0) {
                                            $round = $adonsinfo->price * $addonsqty[$y];
                                            echo round($round);
                                        } else {
                                            echo number_format($adonsinfo->price * $addonsqty[$y], $settinginfo->showdecimal);
                                        } ?>
                                        <?php if ($currency->position == 2) {
                                            echo $currency->curr_icon;
                                        } ?>
                            ...
                            foreach ($topping as $toppingid) {
                                ...
                                <div class="row-data linehight">
                                    <div class="item-info linehight">
                                        ...
                                        <p class="item-number linehight fontsizepx"><?php //echo $toppingprice[$tp];
                                            ?></p>
                                    </div>
                                    <h5 class="fontsizepx"><?php if ($currency->position == 1) {
                                            echo $currency->curr_icon;
                                        } ?> <?php if ($settinginfo->showdecimal == 0) {
                                            echo round($toppingprice[$t]);
                                        } else {
                                            echo number_format($toppingprice[$t], $settinginfo->showdecimal);
                                        } ?><?php if ($currency->position == 2) {
                                            echo $currency->curr_icon;
                                        } ?></h5>
                                </div>
                        ...
                        foreach ($openiteminfo as $openfood) {
                            ...
                            <div class="row-data linehight">
                                ...
                                <div class="text-right linehight">
                                    <p class="item-number linehight fontsizepx"><?php echo $openprice; ?> x <?php echo $openqty; ?></p>
        ...
        <div class="invoice-footer mb-15 linehight">
            <?php if ($posinvoiceTemplate->subtotal_level_show == 1) { ?>
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx" style="font-size:18px;"><strong><?php echo (!empty($posinvoiceTemplate->subtotal_level) ? $posinvoiceTemplate->subtotal_level : display('subtotal')); ?></strong></h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx">
                        <?php if ($currency->position == 1) {
                            echo $currency->curr_icon;
            ...
            if ($billinfo->bill_status == 1) { ?>
                <?php if ($posinvoiceTemplate->customer_paid_show == 1) { ?>
                    <div class="row-data linehight">
                        <div class="item-info linehight">
                            <h5 class="item-title linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->cutomer_paid_amount) ? $posinvoiceTemplate->cutomer_paid_amount : display('customer_paid_amount')); ?></h5>
                        </div>
                        <h5 class="my-0 linehight fontsizepx">
                            <?php if ($currency->position == 1) {
                                echo $currency->curr_icon;
            ...
            <?php } else {
                if ($posinvoiceTemplate->total_due_show == 1) {
                    ...
                    <div class="row-data linehight">
                        <div class="item-info linehight">
                            <h5 class="item-title linehight fontsizepx text-bold"><?php echo (!empty($posinvoiceTemplate->total_due) ? $posinvoiceTemplate->total_due : display('total_due')); ?></h5>
                        </div>
                        <h5 class="my-0 linehight fontsizepx">
                            <?php if ($currency->position == 1) {
                                echo $currency->curr_icon;
            ...
            <?php if ($posinvoiceTemplate->change_due_show == 1) { ?>
                <div class="row-data linehight">
                    ...
                    <h5 class="my-0 linehight fontsizepx">
                        ...
                        <?php echo numbershow($changes, $settinginfo->showdecimal); ?>
                        <?php if ($currency->position == 2) {
                            echo $currency->curr_icon;
                        } ?>
                    </h5>
                ...
                <div class="middle-data linehight" style="margin-bottom:8px;">
                    <?php if ($posinvoiceTemplate->table_level_show == 1) { ?>
                        <div class="item-info gap_right linehight">
                            ...
                            <?php } else { ?>
                                <h5 class="item-title linehight fontsizepx" style="font-size:18px;"><strong><?php echo (!empty($posinvoiceTemplate->table_level) ? $posinvoiceTemplate->table_level : display('table')); ?>: <?php echo $tableinfo->tablename; ?></strong></h5>
                            <?php } ?>
                        </div>
                    <?php }
                    if ($posinvoiceTemplate->order_no_show == 1) { ?>
                        <div class="item-info linehight">
                            <h5 class="item-title linehight fontsizepx" style="font-size:18px;"><strong><?php echo (!empty($posinvoiceTemplate->order_no) ? $posinvoiceTemplate->order_no : display('orderno')); ?> <?php echo getPrefixSetting()->sales . '-' . $orderinfo->order_id; ?></strong></h5>
                        </div>
                    <?php } ?>
                </div>
            <?php }
