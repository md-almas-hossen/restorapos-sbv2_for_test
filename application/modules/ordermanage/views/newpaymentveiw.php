                      ...
                      <div class="row no-gutters">
                        ...
                        <div class="form-group col-md-6">
                            <label for="4digit" class="col-form-label"><?php echo display('lstdigit');?></label>
                       		 ...
                       		 <div class="mobilearea w-100 no-gutters display-none">
                        <div class="form-group col-md-6">
                            <label for="mobilemethodName" class="col-form-label"><?php echo display('mobilemethodName');?></label>
                          
                                 <?php echo form_dropdown('mobile_method[]',$mpaylist,'','class="postform resizeselect form-control" ') ?>
                           
                        </div>
                        <div class="form-group col-md-6">
                            <label for="mobile" class="col-form-label"><?php echo display('mobile');?></label>
                          	<input type="text" class="form-control"  name="mobileno[]" />
                        </div>
                        <div class="form-group col-md-6">
                            <label for="trans_no" class="col-form-label"><?php echo display('trans_no');?></label>
                           
                                  <input type="text" class="form-control"  name="trans_no[]" value="" />
