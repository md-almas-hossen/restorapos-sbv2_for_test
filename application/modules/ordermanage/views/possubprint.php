        ...
        <div class="invoice-card">
            ...
            $presentsub = unserialize($orderinfo->order_menu_id);
					...
					foreach ($iteminfo as $item){
						...
						$itemdetails=$this->App_android_model->getiteminfo($item->menu_id);
						...
						$adonsprice=0;
						$alltoppingprice=0;
						if((!empty($item->add_on_id) && !empty($isaddones)) || (!empty($item->tpid))){
                        ...
                        <div class="row-data linehight">
                            ...
                            <div class="text-right linehight">
                                <p class="item-number linehight fontsizepx">
                                    <?php echo numbershow($item->price,$settinginfo->showdecimal);?> x
                                ...
                                <h5 class="my-0 linehight fontsizepx">
                                    ...
                                    <?php echo numbershow($itemprice-$ptdiscount,$settinginfo->showdecimal);?>
            ...
            <div class="invoice-footer mb-15 linehight">
                <div class="row-data linehight">
                    ...
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php echo numbershow($total,$settinginfo->showdecimal);?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                ...
                <div class="row-data linehight">
                    ...
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php echo numbershow($vat,$settinginfo->showdecimal); ?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx">
                            <?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?><?php $discountpercent=$alldiscount*100/$gtotal?>(<?php //echo number_format($discountpercent,3)?>%)
                        </h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php echo numbershow($alldiscount,$settinginfo->showdecimal);?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <?php } ?>
                ...
                <div class="row-data border-top linehight">
                    ...
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php echo numbershow($gtotal,$settinginfo->showdecimal);?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <?php }
				$paymentsmethod=$this->App_android_model->allsubpayments($mainorderinfo->order_id,$orderinfo->sub_id);
				$alltype="";
				$totalpaid=0;
                ...
                <div class="row-data linehight">
                    ...
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php if($totalpaid>$gtotal) {echo numbershow($totalpaid-$gtotal,$settinginfo->showdecimal);}else{echo "0.00";} ?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <?php } ?>
            ...
            <div class="invoice_address linehight">
                ...
                <div class="row-data linehight">
                    <?php if($gloinvsetting->billing_to_show==1){?>
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx">
                    ...
                    <?php } if($gloinvsetting->bill_by_show==1){ ?>
                    <h5 class="my-0 linehight fontsizepx">
                ...
                <div class="middle-data linehight">
                    ...
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx">
                            <?php echo (!empty($posinvoiceTemplate->order_no)?$posinvoiceTemplate->order_no:display('orderno'));?>:<?php echo getPrefixSetting()->sales. '-'.$mainorderinfo->saleinvoice;?>(<?php echo $orderinfo->sub_id;?>)
                        </h5>
                    </div>
                    <?php } ?>
                </div>
