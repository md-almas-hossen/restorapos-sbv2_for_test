    ...
    <div class="page-wrapper">
        <div class="invoice-card">
            ...
            <div class="invoice-head linehight">
                ...
                <p class="my-0 text-center linehight fontsizepx"><strong>Mushak-6.3</strong></p>
                <?php } ?>
            </div>
            <?php } ?>
            ...
            <div class="invoice-details linehight">
                <div class="invoice-list linehight">
                    ...
                    <div class="invoice-data linehight">
                        <?php $this->load->model('ordermanage/App_android_model',	'ordermodel');
				  $i=0; 
				  $totalamount=0;
					  $subtotal=0;
					...
					foreach ($iteminfo as $item){
						...
						if((!empty($item->add_on_id))||(!empty($item->tpid))){
							...
							foreach($topping as $toppingid){
                                  $tpinfo=$this->App_android_model->read('*', 'add_ons', array('add_on_id' => $toppingid));
			...
			if(!empty($item->tpid)){
             ...
             $discount=0; 
             $dueinformation=$this->App_android_model->read('*', 'tbl_orderduediscount', array('dueorderid' => $billinfo->order_id));
			...
			if($mvat['is_show']==1){
			$taxinfo=$this->App_android_model->read('*', 'tax_collection', array('relation_id' => $orderinfo->order_id));	
			$fieldname='tax'.$i;
			?>
                <div class="row-data linehight">
                    <div class="item-info linehight">
			...
			if($billinfo->bill_status==1){?>
                ...
                <?php $paymentsmethod=$this->App_android_model->allpayments($orderinfo->order_id);
				$alltype="";
				$totalpaid=0;
				...
				foreach($paymentsmethod as $pmethod){
						...
						if($pmethod->payment_type_id==1){
							$allcardp=$this->App_android_model->allcardpayments($pmethod->bill_id,$pmethod->payment_type_id);
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx">
                            <?php echo $pmethod->payment_method."(".$allcard.")";?></h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                ...
                <?php }
							...
							$allmobilep=$this->App_android_model->allmpayments($pmethod->bill_id,$pmethod->payment_type_id);
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx">
                            <?php echo $pmethod->payment_method."(".$allmobile.")";?></h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php echo numbershow($pmethod->paidamount,$settinginfo->showdecimal); ?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                ...
                <div class="row-data linehight">
                    ...
                    <h5 class="my-0 linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php if($totalpaid>$billinfo->bill_amount) {echo numbershow($totalpaid-$billinfo->bill_amount,$settinginfo->showdecimal);}else{echo "0.00";} ?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
