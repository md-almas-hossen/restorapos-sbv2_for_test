...
<?php if($orderinfo->cutomertype==1){
	$custype=display('Walk_In_Customer');
	}
	if($orderinfo->cutomertype==2){
	$custype=display('Online_Customer');
	}
...
<div class="print_area2">
		...
		<h3 style="text-align: left;">Table No:<?php echo $orderinfo->table_no;?> Token No: <?php echo $orderinfo->tokenno;?></h3>							
      <tr>
        <td>

          <table border="0" width="100%">
          	  <tr>
            	<td align="center" style="font-size:26px;"><?php echo "Type: ".$custype;?></td>
          	 </tr>
             <tr>
