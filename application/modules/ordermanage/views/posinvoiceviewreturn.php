    ...
    <div class="invoice-card">
        <?php if ($posinvoiceTemplate->invoice_logo_show == 1 || $posinvoiceTemplate->company_name_show == 1 || $posinvoiceTemplate->company_address == 1) { ?>
            <div class="invoice-head linehight">
                <?php if ($posinvoiceTemplate->invoice_logo_show == 1) { ?>
                    <img src="<?php echo base_url(); ?><?php echo (!empty($posinvoiceTemplate->logo) ? $posinvoiceTemplate->logo : $storeinfo->logo) ?>" alt="">
                <?php }
                            ...
                            if (!empty($item->tpid)) {
                                ...
                                ?>
                                    <div class="row-data">
                                        ...
                                        <h5 class="fontsizepx"><?php if ($currency->position == 1) {
                                                                    echo $currency->curr_icon;
        ...
        <div class="invoice-footer mb-15">
            <?php if ($posinvoiceTemplate->subtotal_level_show == 1) { ?>
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->subtotal_level) ? $posinvoiceTemplate->subtotal_level : display('subtotal')); ?></h5>
                    </div>
                    <h5 class="my-0 fontsizepx"><?php if ($currency->position == 1) {
                                                    echo $currency->curr_icon;
            ...
            <?php if ($posinvoiceTemplate->servicechargeshow == 1) { ?>
                <div class="row-data">
                    ...
                    <h5 class="my-5 fontsizepx"><?php if ($currency->position == 1) {
                                                    echo $currency->curr_icon;
                                                } ?><?php $sdcharge = 0;
                                                                                                                if (empty($billinfo)) {
            ...
            if ($posinvoiceTemplate->discountshow == 1) { ?>
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->discount_level) ? $posinvoiceTemplate->discount_level : display('discount')); ?><?php $discountpercent = ($discount * 100) / ($billinfo->total_amount + $billinfo->service_charge + $billinfo->VAT) ?>(<?php //echo number_format($discountpercent,3)
                                                                                                                                                                                                                                                                                            ?>%)</h5>
                    </div>
                    <h5 class="my-5 fontsizepx"><?php if ($currency->position == 1) {
                                                    echo $currency->curr_icon;
                                                                                                                ...
                                                                                                                if (empty($billinfo)) {
                                                                                                                    ...
                                                                                                                    echo $discount = numbershow($billinfo->discount - $billinfo->allitemdiscount, $settinginfo->showdecimal);
                                                                                                                } ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                                                                                                                    echo $currency->curr_icon;
                                                                                                                                                                                                                                                                                                                                } ?></h5>
                </div>
            ...
            <?php if ($posinvoiceTemplate->vatshow == 1) {
                if (empty($taxinfos)) { ?>
                    <div class="row-data">
                        <div class="item-info">
                            <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->vat_level) ? $posinvoiceTemplate->vat_level : display('vat_tax')); ?>(<?php echo $storeinfo->vat; ?>%)</h5>
                        </div>
            ...
            <?php if ($posinvoiceTemplate->grandtotalshow == 1) { ?>
                <div class="row-data border-top">
                    ...
                    <h5 class="my-0 fontsizepx"><?php if ($currency->position == 1) {
                                                    echo $currency->curr_icon;
                                                } ?> <?php echo numbershow($billinfo->bill_amount, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                echo $currency->curr_icon;
                                                                                                                                                                                            } ?></h5>
                </div>
            <?php } ?>
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title text-bold fontsizepx">Return Total</h5>
                    </div>
                    <h5 class="my-0 fontsizepx"><?php echo (!empty($returnitem->totalamount)?$returnitem->totalamount:"0.00");?></h5>
                </div>
        </div>
                ...
                <div class="middle-data">
                    <?php if ($posinvoiceTemplate->table_level_show == 1) { ?>
                        <div class="item-info gap_right fontsizepx">
                            ...
                            <?php } else { ?>
                                <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->table_level) ? $posinvoiceTemplate->table_level : display('table')); ?>: <?php echo $tableinfo->tablename; ?></h5>
                            <?php } ?>
                        </div>
                    <?php }
                    if ($gloinvsetting->invorder == 1) { ?>
                        <div class="item-info fontsizepx">
                            <h5 class="item-title fontsizepx"><?php echo (!empty($posinvoiceTemplate->order_no) ? $posinvoiceTemplate->order_no : display('orderno')); ?>: <?php echo getPrefixSetting()->sales . '-' . $orderinfo->order_id; ?></h5>
                        </div>
                    <?php } ?>
                </div>
            <?php }
            ...
            ?>
                <div class="middle-data">
                    <div class="text-center">
                        <h5 class="item-title fontsizepx" style="font-size:18px; font-weight:bold;">Status:  Invoice Return</h5>
                    </div>
                </div>
            <?php } ?>
        ...
        <?php if ($customerinfo->customer_id > 1) { ?>
            <div class="invoice_address linehight">
                ...
                <?php if ($posinvoiceTemplate->customer_address == 1) { ?>
                    <div class="middle-data linehight">
                        <p class="my-0 linehight fontsizepx"><?php echo (!empty($orderinfo->delivaryaddress) ? $orderinfo->delivaryaddress : $customerinfo->customer_address) ?></p>
                    </div>
                <?php }
                if ($posinvoiceTemplate->customer_mobile == 1) { ?>
                    <div class="middle-data linehight">
