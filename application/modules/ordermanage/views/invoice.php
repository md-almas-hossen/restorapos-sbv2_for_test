	                            ...
	                            <div class="col-sm-2 text-left mb-display">
	                                ...
	                                <span class="label label-success-outline m-r-15"><?php echo display('billing_to') ?></span>
	                                 <address class="mt-10">  
		                                ...
		                                <c class="wmp"><?php echo (!empty($orderinfo->delivaryaddress)?$orderinfo->delivaryaddress:$customerinfo->customer_address)?></c><br>
									...
									if(!empty($item->tpid)){
										...
										if($toppingprice[$tp]>0){?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $toppingprice[$tp];?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </td>
                                                        <td class="text-right"><?php echo $addonsqty[$y];?></td>
                                                        <td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $toppingprice[$tp];?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
                                                     </tr>
									<?php $tp++;}
												}
										 }	
