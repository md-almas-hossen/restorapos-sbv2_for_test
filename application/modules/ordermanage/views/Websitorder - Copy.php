          ...
          <div class="left_portion">
            ...
            >
              ...
              >
                ...
                <a href="<?php echo base_url() ?>dashboard/home"><span class="fs-16 fw-medium ms-3 text-white">Home</span></a>
              </div>
            ...
            <ul class="nav nav-pills nav-stacked">
              <li class="w-100">
                <a href="javascript:void(0)" onclick="allrestoraorder('all',0)" id="all_data_sidebar" data-customertype="2"  class="align-items-center d-flex justify-content-between my-2 px-5 py-4 bg_all dataget">
                  <span class="text-black" >All</span>

                  <span class="text-dark3">(<?php echo $allcount['all'];?>)</span>
                </a>
              </li>
              <li class="w-100">
                <a href="javascript:void(0)"  onclick="allrestoraorder('pending')" id="pending_customertype" data-customertype="2" class="align-items-center d-flex justify-content-between my-2 px-5 py-4 bg_pending">
                  <span class="text-black">Pending</span>
                  <span class="text-dark3">(<?php echo $allcount['pending'];?>)</span>
                </a>
              </li>
              <li class="w-100">
                <a
                  href="javascript:void(0)" onclick="allrestoraorder('processing')" id="processing_customertype" data-customertype="2"
                  class="align-items-center d-flex justify-content-between my-2 px-5 py-4 bg_process"
                >
                  <span class="text-black">Processing</span>
                  <span class="text-dark3">(<?php echo $allcount['processing'];?>)</span>
                </a>
              </li>
              <li class="w-100">
                <a
                  href="javascript:void(0)" onclick="allrestoraorder('ready')" id="ready_customertype" data-customertype="2"
                  class="align-items-center d-flex justify-content-between my-2 px-5 py-4 bg_ready"
                >
                  <span class="text-black">Ready</span>
                  <span class="text-dark3">(<?php echo $allcount['ready'];?>)</span>
                </a>
              </li>
              <li class="w-100">
                <a
                  href="javascript:void(0)" onclick="pickupinfo('shipped')" id="shipped_customertype" data-customertype="2"
                  class="align-items-center d-flex justify-content-between my-2 px-5 py-4 bg_shipped">
                  <span class="text-black">Shipped</span>
                  <span class="text-dark3">(<?php echo $allcount['shippted'];?>)</span>
                </a>
              </li>
              <li class="w-100">
                <a
                  href="javascript:void(0)" onclick="pickupinfo('deliverred')" id="deliverred_customertype" data-customertype="2"
                  class="align-items-center d-flex justify-content-between my-2 px-5 py-4 bg_deliverred"
                >
                  <span class="text-black">Deliverred</span>
                  <span class="text-dark3">(<?php echo $allcount['delivery'];?>)</span>
                </a>
              </li>
            </ul>
          </div>
            ...
            <div class="restora_tabs">
              ...
              >
                ...
                >
                  <li role="presentation" class="nav-item active">
                    ...
                    <a  href="#restora_0" onclick="allrestoraorder('restoraall',2,0)"  id="main_manu" data-customertype="2" aria-controls="restora" class="align-content-center d-flex flex-wrap justify-content-center rounded-0" role="tab"
                      data-toggle="tab">
                      <img
                     ...
                     <?php  
                      ...
                      <div class="fs-13 text-black text-center w-100">(<?php echo $restorapos_count;?>)</div>
                    </a>
                  </li>
                  <?php 
                  ...
                  <li role="presentation" class="nav-item"  onclick="allrestoraorder('thridpartyall',3,<?php echo $list->companyId;?>)" id="customer_type_<?php echo $list->companyId;?>" data-customertype="3">
                    <a
                      href="#restora_<?php echo $list->companyId;?>"
                      aria-controls="home"
                    ...
                    >
                     <?php echo $list->company_name;?>
                      ...
                      <img
                        ...
                        alt=""
                      /> -->
                      <div class="fs-13 text-black text-center w-100">(<?php echo $count_query;?>)</div>
                    </a>
                  </li>
                  <?php } ?>
              ...
              <div class="body-wrapper">
                ...
                <div class="tab-content">
                 ...
                 <div role="tabpanel" class="tab-pane fade active in" id="restora">
                    <div id="loadpage"></div>
                  </div>
  ...
  <!-- /.modal-dialog --> 
    ...
    <script>
      ...
      $(document).ready(function () {
        allrestoraorder(data_status='all',0);
