    ...
    <div class="page-wrapper">
        <div class="invoice-card">
            <?php if ($posinvoiceTemplate->invoice_logo_show == 1 || $posinvoiceTemplate->company_name_show == 1 || $posinvoiceTemplate->company_address == 1) { ?>
                <div class="invoice-head linehight">
                    ...
                    if ($posinvoiceTemplate->company_name_show == 1) { ?>
                        <h4 style="font-size:22px;" align="center" class="linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->store_name) ? $posinvoiceTemplate->store_name : $storeinfo->title) ?></h4>
                    <?php }
                ...
                <div class="row-data linehight ">
                    ...
                    <div class="item-info linehight fontsizepx">
                        <?php if ($posinvoiceTemplate->date_show == 1) { ?>
                            <h5 class="item-title linehight fontsizepx" style="font-size:<?php echo $posinvoiceTemplate->fontsize; ?>px; font-weight:bold;"><?php echo (!empty($posinvoiceTemplate->date_level) ? $posinvoiceTemplate->date_level : display('date')); ?>: <?php echo date("$posinvoiceTemplate->date_time_formate", strtotime($orderinfo->order_date)); ?></h5>
                        <?php }
                        if ($posinvoiceTemplate->time_show == 1) { ?>
                            <h5 class="item-title linehight fontsizepx" style="font-size:<?php echo $posinvoiceTemplate->fontsize; ?>px; font-weight:bold;"><?php echo display('seat_time'); ?>: <?php echo date("h:i A", strtotime($orderinfo->order_time)); ?></h5>
                        <?php } ?>
                    </div>
            ...
            <div class="invoice-footer mb-15 linehight">
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight fontsizepx">Customer Paid Amount</h5>
                    </div>
                    <h5 class="my-0 linehight fontsizepx">
                        <?php if ($currency->position == 1) {
                            echo $currency->curr_icon;
                        } ?>
                        <?php echo numbershow($paidamount->totalpaid, $settinginfo->showdecimal); ?>
                        <?php if ($currency->position == 2) {
                            echo $currency->curr_icon;
                        } ?>
                    </h5>
                        ...
                        <?php } else { ?>
                            <div class="row-data">
                                ...
                                <h5 class="my-0 fontsizepx"><?php if ($currency->position == 1) {
                                       echo $currency->curr_icon;
                                 } ?> <?php echo numbershow($pmethod->paidamount - $paidamount->totalpaid, $settinginfo->showdecimal); ?> 
                                 <?php if ($currency->position == 2) {
                                      echo $currency->curr_icon;
                                   } ?></h5>
                            </div>
                ...
                if ($posinvoiceTemplate->table_level_show == 1 || $posinvoiceTemplate->order_no_show == 1) { ?>
                    <div class="middle-data linehight ">
                        ...
                        if ($posinvoiceTemplate->order_no_show == 1) { ?>
                            <div class="item-info linehight ">
                                <h5 class="item-title linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->order_no) ? $posinvoiceTemplate->order_no : display('orderno')); ?>: <?php echo getPrefixSetting()->sales . '-' . $orderinfo->order_id; ?></h5>
                            </div>
                        <?php } ?>
                    </div>
                <?php }
