									...
									?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php echo getPrefixSetting()->sales. '-' .$item->order_id;?></td>
                                            <td class="text-center"><?php echo $item->customer_name;?></td>
                                            <td class="text-center"><?php echo $item->customer_type;?></td>
                                            <td class="text-center"><?php echo $item->first_name.' '.$item->last_name;?>
                                            </td>
                                            ...
                                            <td class="text-right">
                                                ...
                                                echo numbershow($item->totalamount, $setting->showdecimal);
                                                ?>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url("ordermanage/order/orderdetails/$item->order_id") ?>"
                                                    ...
                                                    data-placement="left" title="Details"><i class="fa fa-eye"
                                                        aria-hidden="true"></i></a>
                                                <?php endif; ?>
                                                <a href="<?php echo base_url("ordermanage/order/posorderinvoice/$item->order_id") ?>"
                                                    class="btn btn-success btn-sm" data-toggle="tooltip"
                                                    data-placement="left" title="" data-original-title="Invoice"><i
