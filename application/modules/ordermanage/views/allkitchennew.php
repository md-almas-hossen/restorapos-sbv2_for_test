    ...
    <div class="row kitchen-tab ">
                <div class="col-sm-12 ">
                    <div class="d-flex mb-13">
                        ...
                        <button onclick="checkkitchentoken('allkitchenpending','view')" type="button" class="btn btn-lg act_btn btn-paste rounded-0 border-0 lh-30"> <?php echo display('pending_token') . '(' . $pending . ')'; ?></button>
                        <button onclick="checkkitchentoken('allkitchenongoing','view')" type="button" class="btn btn-lg act_btn btn-split rounded-0 border-0 lh-30"> <?php echo display('ongoing_token') . '(' .  $ongoing . ')';?></button>
                        <button onclick="checkkitchentoken('allkitchenprepared','view')" type="button" class="btn btn-lg act_btn btn-green rounded-0 border-0 lh-30"><?php echo display('prepared_token') . '(' .   $processing . ')';?></button>
                    </div>
                    <!-- Nav tabs -->
                    <ul class="nav nav-pills">
                        ...
                        ?>
                            <li class="<?php if ($x == 1) {
                                            echo "active";
                                        } ?>"><a href="#tab<?php echo $x; ?>" data-toggle="tab" id="actab<?php echo $x; ?>"><?php echo $kitchen->kitchen_name; ?></a></li>
                        <?php } ?>
                    ...
                    <div class="tab-content">
                        ...
                        ?>
                                <div class="tab-pane fade <?php if ($k == 1) {
                                    ...
                                    <div class="panel-body">
                                        <div class="grid">
                                            <div class="grid-sizer col-vxs-12 col-xs-6 col-md-4 col-lg-3 col-xlg-4 notokenid"></div>
                                            ...
                                            ?>
                                                        <div class="grid-col col-vxs-12 col-xs-6 col-md-4 col-lg-3 col-xlg-4" id="singlegrid<?php echo $orderinfo->order_id . $orderinfo->kitchenid; ?>">
                                                            <div class="grid-item-content" id="gridcontent<?php echo $orderinfo->order_id . $orderinfo->kitchenid; ?>">
                                                                ...
                                                                ?>
                                                                <div class="food_item <?php if ($status == 0) {
                                                                                            echo "pending";
                                                                    ...
                                                                    <div class="food_item_top">
                                                                        ...
                                                                        <div class="item_inner">
                                                                            ...
                                                                            <h4 class="kf_info"><?php echo display('type') ?>: <?php
...
<script src="<?php echo base_url('application/modules/ordermanage/assets/js/kitchennew.js'); ?>" type="text/javascript"></script>
