                                            ...
                                            <tbody>
												...
												$multiplletax = array();
													...
													$isoffer=$this->order_model->read('*', 'order_menu', array('row_id' => $item->row_id));	
														...
														<tr>
															<td scope="row"><?php echo $item->ProductName.','.$addonsnamestring.','.$toppingnamestring; ?></td>
															...
															<td><?php  if($item->OffersRate >0){ 
																$discountt = ($item->price*$item->OffersRate)/100;  
																	echo $presenttab[$item->row_id]*$item->price-($presenttab[$item->row_id]*$discountt)+$adonsprice+$alltpprice;
																...
																$totalprice= $totalprice+$adonsprice+$alltpprice+$presenttab[$item->row_id]*$item->price;
											...
											<?php 
												...
												$partial_vat = $this->db->select('*')->from('tax_collection')->where('relation_id', $orderid)->get()->row()->{'tax' . $i};
																...
																->where('sub_order.sub_id', $suborderid)
																->get()
																->row();
											...
											<?php if($isvatinclusive):?>
												...
												<tfoot>
													<tr>
														...
														<td colspan="2" class="text-right font-14" align="right">&nbsp; <b><?php echo display('total') ?> </b></td>
													...
													<tr>
														...
														<?php echo $fp_vat = number_format(($partial_vat/($billinfo->bill_amount-$billinfo->service_charge))*$totalprice, $settinginfo->showdecimal);?>
													...
													<tr>
														...
														echo number_format($totalprice+$fp_vat+$sc,3);?></b></td>
														<input type="hidden" id="total-sub-<?php echo $suborderid;?>" value="<?php echo $totalprice;?>">
														<input type="hidden" id="vat-<?php echo $suborderid;?>" value="<?php echo $fp_vat;?>">
														<input type="hidden" id="service-<?php echo $suborderid;?>" value="<?php echo $sc;?>">
														<input type="hidden" id="orderid-<?php echo $suborderid;?>" value="<?php echo $orderid;?>">
													</tr>
												</tfoot>
                                            <?php else:?>
