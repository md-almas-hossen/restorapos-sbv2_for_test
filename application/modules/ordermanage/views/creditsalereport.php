<script src="<?php echo base_url('application/modules/ordermanage/assets/js/creditsalereport.js'); ?>"
        ...
        <div class="panel panel-bd">
            <div class="panel-heading d-flex justify-content-between align-items-center">
                ...
                <div class="">
                    ...
                    <a class="btn btn-success" onclick="creditsalereport()"><?php echo display('search') ?></a>
