...
<body>
  <div id="printableArea" class="bill__container bill-pos-mini__container" style="width: 278px; font-size:11px;">
        ...
        <table class="w-100">
          ...
          <tbody>
            ...
            ?>
              <tr>
                <td class="p-0">
                  <p class="mb-0 fontsizepx"><?php echo $item->ProductName; ?>-<?php echo $item->variantName; ?></p><small class="mb-0 text-italic fontsizepx"><?php echo numbershow($singleprice, $settinginfo->showdecimal); ?> x <?php echo quantityshow($item->menuqty, $item->is_customqty); ?></small>
                </td>
                <td valign="top" class="p-0 text-right fontsizepx">
                  <p class="mb-0 fontsizepx"><?php if ($currency->position == 1) {
                                                echo $currency->curr_icon;
                                              } ?> <?php echo numbershow($itemprice - $ptdiscount, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                          echo $currency->curr_icon;
                                                                                                                                                                                        } ?></p>
                </td>
                <td valign="top" class="p-0 text-right fontsizepx">
                ...
                foreach ($addons as $addonsid) {
                  ...
                  <tr>
                    <td valign="top" class="p-0 fontsizepx">
                      <p class="mb-0 ml-2 fontsizepx">-<?php echo $adonsinfo->add_on_name; ?></p><small class="mb-0 ml-2 text-italic fontsizepx"><?php echo numbershow($adonsinfo->price, $settinginfo->showdecimal); ?> x <?php echo $addonsqty[$y]; ?></small>
                    </td>
              ...
              if (!empty($item->tpid)) {
                ...
                ?>
                  <tr>
                    <td valign="top" class="p-0 fontsizepx">
                      <p class="mb-0 ml-2 fontsizepx">-<?php echo $adonsinfo->add_on_name; ?></p><small class="mb-0 ml-2 text-italic fontsizepx"></small>
                    </td>
                    <td valign="top" class="text-right fontsizepx"><?php if ($currency->position == 1) {
                                                                      echo $currency->curr_icon;
            ...
            if (empty($dueinformation)) {
              ...
              $discount = $dueinformation->duetotal;
            }
            $discountpr = 0;
            if ($storeinfo->discount_type == 1) {
              $dispr = $discount * 100 / $billinfo->total_amount;
        ...
        <?php if ($posinvoiceTemplate->subtotal_level_show == 1) { ?>
          <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                                    echo $currency->curr_icon;
                                                                                  } ?> <?php echo numbershow($billinfo->total_amount, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                echo $currency->curr_icon;
                                                                                                                                                                                                                              } ?></p>
          </div>
          ...
          <?php if ($recalculate_vat == 1){?>
            ...
            <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                                    echo $currency->curr_icon;
                                                                                  } ?> <?php echo numbershow($billinfo->total_amount - $billinfo->VAT, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                echo $currency->curr_icon;
                                                                                                                                                                                                                              } ?></p>
          </div>
          ...
          <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <p class="mb-0 text-note text-primary linehight fontsizepx">-<?php if ($currency->position == 1) {
                                                                            echo $currency->curr_icon;
                                                                                                                                          ...
                                                                                                                                          echo $discount = numbershow($discount, $settinginfo->showdecimal);
        ...
        <?php if ($posinvoiceTemplate->vatshow == 1) {
          if (empty($taxinfos)) { ?>
            <div class="d-flex justify-content-between align-items-center mb-2">
              ...
              <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                            echo $currency->curr_icon;
                                                                          } ?> <?php $taxcalv = number_format(floor($calvat));
                                                                                                                                          echo numbershow($taxcalv, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                                  echo $currency->curr_icon;
                                                                                                                                                                                                                                                } ?></p>
            </div>
            <?php } else {
            ...
            ?>
                <div class="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                                echo $currency->curr_icon;
                                                                              } ?> <?php $taxcalv = number_format(floor($taxinfo->$fieldname));
                                                                                                                                              echo numbershow($taxcalv, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                                                  echo $currency->curr_icon;
                                                                                                                                                                                                                                                                } ?></p>
                </div>
      ...
      <div class="border-bottom--dashed">
        <?php if ($posinvoiceTemplate->grandtotalshow == 1) { ?>
          <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                                    echo $currency->curr_icon;
                                                                                  } ?> <?php echo numbershow($billinfo->bill_amount - $discount, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                        echo $currency->curr_icon;
                                                                                                                                                                                                                                      } ?></p>
          </div>
        <?php }
        if ($orderinfo->customerpaid > 0) {
          $customepaid = $orderinfo->customerpaid - $discount;
          $changes = $customepaid - $orderinfo->totalamount - $discount;
        } else {
          $customepaid = $orderinfo->totalamount - $discount;
          $changes = 0;
        }
        if ($billinfo->bill_status == 1) { ?>
          <?php if ($posinvoiceTemplate->customer_paid_show == 1) { ?>
            <div class="d-flex justify-content-between align-items-center mb-2">
              ...
              <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                            echo $currency->curr_icon;
                                                                          } ?> <?php echo numbershow($customepaid, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                              echo $currency->curr_icon;
                                                                                                                                                                                                            } ?></p>
            </div>
          <?php } ?>
        ...
        <?php if ($posinvoiceTemplate->change_due_show == 1) { ?>
          <div class="d-flex justify-content-between align-items-center">
            ...
            <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                          echo $currency->curr_icon;
                                                                        } ?> <?php echo numbershow($changes, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                        echo $currency->curr_icon;
                                                                                                                                                                                                      } ?></p>
          </div>
        <?php } ?>
    ...
    <div class="">
      <div class="mx-auto mb-1 fontsizepx" style="width: 25%; border: 1px solid rgb(0, 0, 0);"></div>
      <?php if ($posinvoiceTemplate->billing_to == 1) { ?><p class="text-note text-center text-bold mb-2 fontsizepx"><?php echo $customerinfo->customer_name; ?></p><?php }
      ...
      <?php }
        ...
        <div class="justify-content-between align-items-center flex-column">
          <p class="text-note text-center linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->footer_text) ? $posinvoiceTemplate->footer_text : display('thanks_you')); ?></p>
        </div>
      <?php } ?>
    </div>
