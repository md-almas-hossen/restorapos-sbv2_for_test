...
<div id="printableArea" class="bill__container bill-pos-mini__container" style="width: 278px; font-size:11px;">
    ...
    <div class="px-4">
        ...
        <div>
            ...
            <p class="mb-0 linehight fontsizepx"><b class="text-bold fontsizepx"><?php echo (!empty($posinvoiceTemplate->order_no)?$posinvoiceTemplate->order_no:display('orderno'));?>: </b> #<?php echo $margeid;?></p>
            ...
            <table class="w-100">
                ...
                <?php $this->load->model('ordermanage/order_model',	'ordermodel');
				  ...
				  $totalamount=0;
					...
					?>
                    <tr>
                        <td class="p-0"><p class="mb-0 fontsizepx"><?php echo $item->ProductName;?>-<?php echo $item->variantName;?></p><small class="mb-0 text-italic fontsizepx"><?php echo numbershow(floor($singleprice),$settinginfo->showdecimal);?> x <?php echo quantityshow($item->menuqty,$item->is_customqty);?></small></td>
             ...
             <?php $y++;
					...
					if(!empty($openiteminfo)){
									foreach($openiteminfo as $openfood){
                                     ...
                                     <tr>
                        				<td class="p-0"><p class="mb-0 fontsizepx"><?php echo $openfood->foodname;?>-<?php echo "Regular";?></p><small class="mb-0 text-italic fontsizepx"><?php echo number_format(floor($openprice));?> x <?php echo $openqty;?></small></td>
        ...
        <div class="border-bottom--dashed">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow(floor($allsubtotal),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
             <?php } ?>
            <?php if($posinvoiceTemplate->discountshow==1){?>
            <div class="d-flex justify-content-between align-items-center mb-2">
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?><?php $discountpercent=($discount*100)/($allsubtotal+$servicecharge+$calvat)?>(<?php //echo number_format($discountpercent,3)?>%)<?php //echo $discountpr;?></p>
                <p class="mb-0 text-note text-primary linehight fontsizepx">-<?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow(floor($discount),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?><?php  echo numbershow(floor($servicecharge),$settinginfo->showdecimal);?><?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
             <?php }?>
        ...
        <?php if($posinvoiceTemplate->vatshow==1){ if(empty($taxinfos)){?>
            ...
            ?>
                ...
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow(floor($multiplletax['tax'.$i]),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
           <?php $i++;} }} }?>
        <div class="border-bottom--dashed">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo numbershow(floor($grandtotal),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            <?php }
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo numbershow(floor($grandtotal),$settinginfo->showdecimal);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php if($totalpaid>$grandtotal) {echo numbershow(floor($totalpaid-$grandtotal),$settinginfo->showdecimal);}else{echo "0.00";} ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
            </div>
            <?php } ?>
        </div>
