  ...
  <div class="px-4">
    ...
    <div>
      <?php if ($posinvoiceTemplate->order_no_show == 1) { ?>
        <p class="mb-0 linehight fontsizepx">
          <b class="text-bold fontsizepx"><?php echo (!empty($posinvoiceTemplate->order_no) ? $posinvoiceTemplate->order_no : display('orderno')); ?>: </b> #<?php echo $orderinfo->saleinvoice; ?>
        </p>
      <?php }
      if ($posinvoiceTemplate->table_level_show == 1) { ?>
        ...
        <?php } ?>
        <?php }
      if ($posinvoiceTemplate->bin_pos_show == 1) {
        if ($storeinfo->isvatnumshow == 1) { ?><p class="mb-0 fontsizepx"><b class="text-bold fontsizepx"><?php echo (!empty($posinvoiceTemplate->bin_level) ? $posinvoiceTemplate->bin_level : display('tinvat')); ?>: </b><?php echo $storeinfo->vattinno; ?></p><?php }
                                                                                                                                                                                                                                                                                                    } ?>
      <?php if ($posinvoiceTemplate->date_show == 1) { ?><p class="mb-0 fontsizepx"><b class="text-bold fontsizepx"><?php echo (!empty($posinvoiceTemplate->date_level) ? $posinvoiceTemplate->date_level : display('date')); ?>: </b><?php echo date("$posinvoiceTemplate->date_time_formate", strtotime($orderinfo->order_date));
                                                                                                                                                                                                                              echo " " . date("h:i A", strtotime($orderinfo->order_time)) ?></p><?php } ?>
    </div>
    <div class="pb-3 border-bottom--dashed">
      <table class="w-100">
        <thead>
          <th style="width: 50%;text-align: left" class="fontsizepx"><strong class="fontsizepx"><?php echo display('item') ?></strong></th>
          <th style="width: 50%; text-align: right;" class="fontsizepx"><strong class="fontsizepx"><?php echo display('total') ?></strong></th>
        </thead>
        <tbody>
          ...
          ?>
            <tr>
              <td class="p-0">
                <p class="mb-0 fontsizepx"><?php echo $item->ProductName; ?>-<?php echo $item->variantName; ?></p><small class="mb-0 text-italic fontsizepx"><?php echo numbershow(floor($singleprice), $settinginfo->showdecimal); ?> x <?php echo quantityshow($item->menuqty, $item->is_customqty); ?></small>
              </td>
              <td valign="top" class="p-0 text-right fontsizepx">
                <p class="mb-0 fontsizepx"><?php if ($currency->position == 1) {
                                              echo $currency->curr_icon;
                                            } ?> <?php echo numbershow(floor($itemprice - $ptdiscount), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                              echo $currency->curr_icon;
                                                                                                                                                                                            } ?></p>
              </td>
            </tr>
            ...
            if (!empty($item->add_on_id)) {
              ...
              foreach ($addons as $addonsid) {
                ...
                <tr>
                  <td valign="top" class="p-0 fontsizepx">
                    <p class="mb-0 ml-2 fontsizepx">-<?php echo $adonsinfo->add_on_name; ?></p><small class="mb-0 ml-2 text-italic fontsizepx"><?php echo numbershow(floor($adonsinfo->price), $settinginfo->showdecimal); ?> x <?php echo $addonsqty[$y]; ?></small>
                  </td>
                  <td valign="top" class="text-right fontsizepx"><?php if ($currency->position == 1) {
                                                                    echo $currency->curr_icon;
                                                                  } ?> <?php echo numbershow(floor($adonsinfo->price * $addonsqty[$y]), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                              echo $currency->curr_icon;
                                                                                                                                                                                                                            } ?></td>
                </tr>
          ...
          if (!empty($openiteminfo)) {
            foreach ($openiteminfo as $openfood) {
              ...
              <tr>
                <td class="p-0 fontsizepx">
                  <p class="mb-0 fontsizepx"><?php echo $openfood->foodname; ?>-<?php echo "Regular"; ?></p><small class="mb-0 text-italic fontsizepx"><?php echo number_format(floor($openprice)); ?> x <?php echo $openqty; ?></small>
                </td>
                <td valign="top fontsizepx" class="p-0 text-right fontsizepx">
                  <p class="mb-0 fontsizepx"><?php if ($currency->position == 1) {
                                                echo $currency->curr_icon;
                                              } ?> <?php echo number_format(floor($openitemtotal)); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                  echo $currency->curr_icon;
                                                                                                                                                                } ?></p>
                </td>
              </tr>
    ...
    <div class="border-bottom--dashed">
      <?php if ($posinvoiceTemplate->subtotal_level_show == 1) { ?>
        <div class="d-flex justify-content-between align-items-center mb-2">
          ...
          <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                                  echo $currency->curr_icon;
                                                                                } ?> <?php echo numbershow(floor($billinfo->total_amount), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                    echo $currency->curr_icon;
                                                                                                                                                                                                                                  } ?></p>
        </div>
...
<p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php echo display('subtotal_without_vat'); ?>:</p>
<p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                        echo $currency->curr_icon;
                                                                      } ?> <?php echo numbershow(floor($billinfo->total_amount - $billinfo->VAT), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                          echo $currency->curr_icon;
                                                                                                                                                                                                                        } ?></p>
</div>
      <?php } } ?>
      <div class="d-flex justify-content-between align-items-center mb-2">
        <p class="mb-0 text-note text-primary linehight fontsizepx"><?php echo "Items Discount"; ?><?php //echo $discountpr;
                                                                                                  ?></p>
        <p class="mb-0 text-note text-primary linehight fontsizepx">-<?php if ($currency->position == 1) {
                                                                        echo $currency->curr_icon;
                                                                      } ?> <?php echo numbershow(floor($billinfo->allitemdiscount), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                              echo $currency->curr_icon;
                                                                                                                                                                                                                            } ?></p>
      </div>
      <?php if ($posinvoiceTemplate->discountshow == 1) { ?>
        <div class="d-flex justify-content-between align-items-center mb-2">
          <p class="mb-0 text-note text-primary linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->discount_level) ? $posinvoiceTemplate->discount_level : display('discount')); ?><?php $discountpercent = ($discount * 100) / ($billinfo->total_amount + $billinfo->service_charge + $billinfo->VAT) ?>(<?php //echo number_format($discountpercent,3)
                                                                                                                                                                                                                                                                                                      ?>%)<?php //echo $discountpr;
                                                                                                                                                                                                                                                                                                                                                        ?></p>
          <p class="mb-0 text-note text-primary linehight fontsizepx">-<?php if ($currency->position == 1) {
                                                                          echo $currency->curr_icon;
                                                                                                                                      ...
                                                                                                                                      if (empty($billinfo)) {
                                                                                                                                        echo numbershow(floor($discount), $settinginfo->showdecimal);
                                                                                                                                      } else {
                                                                                                                                        $discount = $billinfo->discount - $billinfo->allitemdiscount;
                                                                                                                                        echo numbershow(floor($discount), $settinginfo->showdecimal);
      ...
      <?php }
      if ($posinvoiceTemplate->servicechargeshow == 1) { ?>
        <div class="d-flex justify-content-between align-items-center mb-2">
          ...
          <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                        echo $currency->curr_icon;
                                                                                                                                    ...
                                                                                                                                    if (empty($billinfo)) {
                                                                                                                                      echo numbershow(floor($sdcharge), $settinginfo->showdecimal);
                                                                                                                                    } else {
                                                                                                                                      $sdcharge = $billinfo->service_charge;
                                                                                                                                      echo numbershow(floor($sdcharge), $settinginfo->showdecimal);
                                                                                                                                    } ?><?php if ($currency->position == 2) {
                                                                                                                                                                                                                                                                                                                                                        echo $currency->curr_icon;
                                                                                                                                                                                                                                                                                                                                                      } ?></p>
      ...
      <?php if ($posinvoiceTemplate->vatshow == 1) {
        if (empty($taxinfos)) { ?>
          <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                          echo $currency->curr_icon;
                                                                        } ?> <?php echo numbershow(floor($calvat), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                            echo $currency->curr_icon;
                                                                                                                                                                                                          } ?></p>
          </div>
          <?php } else {
          ...
          ?>
              <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                              echo $currency->curr_icon;
                                                                            } ?> <?php echo numbershow(floor($taxinfo->$fieldname), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                              echo $currency->curr_icon;
                                                                                                                                                                                                                            } ?></p>
              </div>
      <?php $i++;
    ...
    <div class="border-bottom--dashed">
      <?php if ($posinvoiceTemplate->grandtotalshow == 1) { ?>
        <div class="d-flex justify-content-between align-items-center mb-2">
          ...
          <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                                  echo $currency->curr_icon;
                                                                                } ?> <?php echo numbershow(floor($billinfo->bill_amount), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                    echo $currency->curr_icon;
                                                                                                                                                                                                                                  } ?></p>
        </div>
      <?php }
      ...
      if ($billinfo->bill_status == 1) { ?>
        <div class="d-flex justify-content-between align-items-center mb-2">
          ...
          <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                        echo $currency->curr_icon;
                                                                      } ?> <?php echo numbershow(floor($customepaid), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                echo $currency->curr_icon;
                                                                                                                                                                                                              } ?></p>
        </div>
        <?php } else {
        ...
        if ($pmethod->payment_type_id == 1) {
          ...
          <div class="border-bottom--dashed">
            <div class="d-flex justify-content-between align-items-center mb-2">
              ...
              <p class="mb-0 text-note text-primary text-bold linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                                      echo $currency->curr_icon;
                                                                                    } ?> <?php echo numbershow(floor($pmethod->paidamount), $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                      echo $currency->curr_icon;
                                                                                                                                                                                                                                    } ?></p>
            </div>
          </div>
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <p class="mb-0 text-note text-primary linehight fontsizepx"><?php if ($currency->position == 1) {
                                                                        echo $currency->curr_icon;
                                                                                                                                        ...
                                                                                                                                        echo numbershow(floor($totalpaid - $billinfo->bill_amount), $settinginfo->showdecimal);
                                                                                                                                      } else {
                                                                                                                                        echo "0.00";
                                                                                                                                      } ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                                                                                echo $currency->curr_icon;
    ...
    <!--<div class="">
            <div class="d-flex justify-content-between">
                <p class="text-note text-center mb-0">+ <?php //echo display('totalpayment')
                                                        ?></p>
                <?php //if($billinfo->bill_status==1){
                ?><p class="mb-0 text-note"><?php //if($currency->position==1){echo $currency->curr_icon;}
                                                                                  ?>  <?php //echo number_format(floor($customepaid)); 
  ...
  <div class="">
    ...
    <p class="text-note text-center text-bold mb-2 linehight fontsizepx"><?php echo $customerinfo->customer_name; ?></p>

    <div class="justify-content-between align-items-center flex-column">
      <p class="text-note text-center linehight fontsizepx"><?php echo display('itaewoncorner') ?></p>
    </div>
  </div>
  <?php //if($gloinvsetting->invpower==1){
  ?>
  <div class="border-top py-1">
    ...
    if ($posinvoiceTemplate->footertextshow == 1) { ?>
      <p class="text-note text-primary text-center mb-0 text-bold linehight fontsizepx"><?php echo (!empty($posinvoiceTemplate->footer_text) ? $posinvoiceTemplate->footer_text : display('thanks_you')); ?><< /p>
          <p class="text-note text-primary text-center mb-0 linehight fontsizepx"> Powered  By: RESTORAPOS, www.restorapos.com<?php //echo display('powerbybdtask')
                                                                                                                              ?></p>
        <?php } ?>
  </div>
  <?php //} 
