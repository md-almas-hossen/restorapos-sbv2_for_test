...
foreach($billinfo as $bill){
 $alltokenorder.=$bill->order_id.',';
 $allpostoken.=$bill->tokenno.',';	
 $allorder_table.=$bill->table_no.',';
}
 $alltokenorder=trim($alltokenorder,',');
  $allpostoken=trim($allpostoken,',');
...
<table border="0" class="font-18 wpr_100" style="width:100%; font-size:18px;">
	<h3 style="text-align: left;">Table No:<?php echo $allorder_table;?> Token No: <?php echo $alltokenorder;?></h3>
      <tr>
        <td>
          ...
          <table border="0" class="wpr_100" style="width:100%">
            ...
            <tr>
              <td align="center"><nobr><date><?php echo display('token_no')?>:<?php echo $allpostoken;?></nobr><br/><?php echo $customerinfo->customer_name;?></td>
            </tr>
          </table>
          <table width="100%">
            <tr>
      ...
      <tr>
      	<td align="center"><?php if(!empty($tableinfo)){ echo display('table').': '.$tableinfo->tablename;}?> | <?php echo display('ord_number');?>:<?php echo $alltokenorder;?></td>
      </tr>
    </table>
        </div>
    </div>
