...
//console.log(tax+'|'+discount+'|'+sc+'|'+stotal+'|'+tgtotal);
$('#udenc').val(encsting);
}
});
...
//console.log(qty+'Q'+iswithoutproduction+'ex'+isstockavail);
...
var allnumbv=tax2+'|'+discount2+'|'+sc2+'|'+stotal+'|'+getvalue;
var encsting= window.btoa( allnumbv );
$('#udenc').val(encsting);
}
});
