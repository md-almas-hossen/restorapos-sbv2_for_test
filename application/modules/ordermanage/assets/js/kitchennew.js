...
$( window ).load(function() {
 ...
 setInterval(function(){ 
  ...
  if(tstatus==0){
	setstate='allkitchenpending';
	seturl='allkitchen';
  }
  if(tstatus==1){
	setstate='allkitchenongoing';
	seturl='allkitchenongoing';
  }
  if(tstatus==2){
	setstate='allkitchenprepared';
	seturl='allkitchenprepared';
  }
...
function oredrisready(orderid){
 ...
 function checkkitchentoken(tokencheck,flag){
	...
	if(tokencheck=='allkitchenpending'){
		tokencheck='allkitchen';
	}
