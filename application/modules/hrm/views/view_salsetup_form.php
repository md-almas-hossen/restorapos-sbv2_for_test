...
echo 'Salary';
                                   ...
                                   <table id="add"> <?php foreach ($amo as $basic) {
                                       ...
                                       <tr>
                                           ...
                                           <td><input type="text" id="basic" name="basic" class="form-control"
                                                   disabled="" value="<?php echo $EmpRate->rate; ?>" readonly></td>
                                       </tr>
                                       <?php
                        $x = 0;
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <input type="text" name="amount[<?php echo $value->salary_type_id; ?>]"
                                                   ...
                                                   value="<?php echo $value->amount; ?>" title="<?php if($value->amount_type==1){echo 1;}else{ echo 0;}?>" id="add_<?php echo $x; ?>" readonly>
                                           </td>
                                       </tr>
                                       <?php $x++;
                        } ?>
                        ...
                        ?>
                                       <tr>
                                           ...
                                           <td><input type="text" name="amount[<?php echo $row->salary_type_id; ?>]"
                                                   ...
                                                   value="<?php echo $row->amount ?>" title="<?php if($row->amount_type==1){echo 1;}else{ echo 0;}?>" id="dd_<?php echo $y; ?>" readonly></td>
                                       </tr><?php
                              $y++;
                            }
                              ?>
                                       <tr>
                                           ...
                                           <td class="padding-10-px"><input type="checkbox" name="tax_manager"
                                                   ...
                                                   <?php if ($EmpRate->rate_type == 1) {
                                                                                                                                                    ...
                                                                                                                                                    } ?> readonly><?php echo display('tax_ma_nager') ?></td>
                                       </tr>
                   ...
                   <div class="form-group">
                     <a href="<?php echo base_url('hrm/Payroll/salary_setup_view');?>"><button type="button" class="btn btn-success w-md m-b-5"><?php echo display('back') ?></button>  </a>
                   </div>
                   <?php echo form_close() ?>
