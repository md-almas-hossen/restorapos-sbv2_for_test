            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="phone" min="0" class="form-control" type="number"
                                    oninput="validity.valid||(value='');" placeholder="<?php echo display('phone') ?>"
                                    id="phone" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="file" name="picture" class="form-control"
                                    placeholder="<?php echo display('photo') ?>" id="picture">
                            </div>
                        </div>
                        <div class="form-group text-right">
                            <a class="btn btn-success btnNext" onclick="validation1()"><?php echo display('next') ?></a>
                        </div>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="cgp[]" class="form-control"
                                    oninput="validity.valid||(value='');" placeholder="<?php echo display('cgp') ?>"
                                    id="cgp">
                            </div>
                        </div>
                        ...
                        <div class="form-group text-right">
                            <a class="btn btn-success btnPrevious"><?php echo display('sPrevious') ?></a>
                            <a class="btn btn-success btnNext" onclick="validation2()"><?php echo display('next') ?></a>
                        </div>
                    </div>
