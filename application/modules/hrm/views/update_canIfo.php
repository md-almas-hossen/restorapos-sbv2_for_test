                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="number" name="phone" class="form-control" id="phone" oninput="validity.valid||(value='');"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="alter_phone" class="form-control" type="number"
                                    value="<?php echo $basinfo->alter_phone; ?>" id="alter_phone" oninput="validity.valid||(value='');">
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="cgp[]" class="form-control"
                                    ...
                                    value="<?php echo $upedu['cgp'] ?>" oninput="validity.valid||(value='');">
                            </div>
                        </div>
