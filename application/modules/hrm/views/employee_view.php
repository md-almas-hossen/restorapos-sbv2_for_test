                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <?php if ($this->db->table_exists('real_ip_setting')){
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <?php if($this->db->table_exists('real_ip_setting')){
                                    ...
                                    if($real_ip==1){
                                ?>
                            <td><?php echo $row->device_name?$row->device_name." (".$row->device_ip.")":"<b class='text text-danger'>Not Set Yet</b>"; ?>
                            </td>
                            <?php } }?>
                            ...
                            <?php if (!$this->session->userdata('is_sub_branch')) {?>
                                ...
                                <a href="<?php echo base_url("hrm/Employees/update_employee_form/$row->employee_id") ?>"
                                ...
                                <?php } 
										...
										?>
                                <a href="<?php echo base_url("hrm/Employees/delete_employhistory/$row->employee_id") ?>"
                            ...
                            <?php }?>
                                ...
                                <a href="<?php echo base_url("hrm/Employees/cv/$row->employee_id");?>"
