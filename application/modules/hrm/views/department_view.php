                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <a href="<?php echo base_url("hrm/Department_controller/update_dept_form/$row->dept_id") ?>"
                                    class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                <?php endif; ?>

                                <?php if($this->permission->method('hrm','delete')->access()): ?>
                                <a href="<?php echo base_url("hrm/Department_controller/delete_dept/$row->dept_id") ?>"
