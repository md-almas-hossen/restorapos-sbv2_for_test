<link href="<?php echo base_url('application/modules/hrm/assets/css/update_employee_form_style.css') ?>" rel="stylesheet" type="text/css" />
<div class="row">
    <div class="customcon">
                    ...
                    <div class="col-sm-12 col-md-11">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Your Last Name" value="<?php echo $data->last_name; ?>">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email" placeholder="Your Email" value="<?php echo $data->email; ?>" onchange="checkexitemail(this.value,'email',<?php echo $data->emp_his_id; ?>)">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="zip_code" name="zip_code" placeholder="Your Zip Code" value="<?php echo $data->zip; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="username" name="username" placeholder="User Login Email" onchange="checkexitemail(this.value,'username',<?php echo $data->emp_his_id; ?>)">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <span class="password-show-hide">
                                                <svg class="show" id="hidepasstext" xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-eye-off"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10.585 10.587a2 2 0 0 0 2.829 2.828" /><path d="M16.681 16.673a8.717 8.717 0 0 1 -4.681 1.327c-3.6 0 -6.6 -2 -9 -6c1.272 -2.12 2.712 -3.678 4.32 -4.674m2.86 -1.146a9.055 9.055 0 0 1 1.82 -.18c3.6 0 6.6 2 9 6c-.666 1.11 -1.379 2.067 -2.138 2.87" /><path d="M3 3l18 18" /></svg>
                                                <svg class="hide" id="showpasstext" xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-eye"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" /><path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" /></svg>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <fieldset class="border p-2">
                                    <legend class="w-auto">Device IP Information</legend>
                                </fieldset>

                                <div class="col-sm-12">
                                    <div class="form-group">

                                        <label for="device_ip_id">Device IP</label>
                                        ...
                                        <div class="input__holder">
                                            ...
                                            <select name="device_ip_id" id="device_ip_id" class="form-control">
                                                ...
                                                <?php foreach ($device_ip_dropdown as $device) { ?>
                                                    <option <?php echo $device->id == $data->device_ip_id ? 'selected' : ''; ?> value="<?php echo $device->id ?>">
                                                        <?php echo $device->device_name . " (" . $device->device_ip . ")"; ?></option>
                                                <?php } ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" name="hiredate" id="hiredate" placeholder="Hire date" value="<?php echo $data->hire_date ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" name="ohiredate" id="ohiredate" placeholder="Original Hire date" value="<?php echo $data->original_hire_date ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" name="terminatedate" id="tdate" placeholder="Termination date" value="<?php echo $data->termination_date ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="termreason" id="treason" placeholder="Termination Reason"><?php echo $data->termination_reason ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" name="rehiredate" id="rhdate" placeholder="Rehire date" value="<?php echo $data->rehire_date ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="rate" id="rate" placeholder="<?php echo display('s_rate') ?>" value="<?php echo $data->rate; ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="pay_f_text" id="qfre_text" placeholder="Paym Frequency text" value="<?php echo $data->pay_frequency_txt; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="work_hour"><?php echo display('hourly_rate2') ?></label>
                                            <input type="number" class="form-control" name="h_rate2" id="rate2" placeholder="Hourly Rate" value="<?php echo $data->hourly_rate2; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="work_hour"><?php echo display('hourly_rate3') ?></label>
                                            <input type="number" class="form-control" name="h_rate3" id="rate3" placeholder="Hourly Rate" value="<?php echo $data->hourly_rate3; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="work_hour"><?php echo display('home_department') ?></label>
                                            <input type="text" class="form-control" name="h_department" id="rate3" placeholder="Hourly Rate" value="<?php echo $data->home_department; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="work_hour"><?php echo display('department_text') ?></label>
                                            <input type="text" class="form-control" name="h_dep_text" id="hdptext" placeholder="Hourly Rate" value="<?php echo $data->department_text; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <?php foreach ($benifit as $benifits) { ?>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="bnfid" name="benifit_c_code[]" value="<?php echo $benifits->bnf_cl_code; ?>" placeholder="Benifit Class Code">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="benifit_c_code_d" name="benifit_c_code_d[]" placeholder="Benifit Class Code Description" value="<?php echo $benifits->bnf_cl_code_des; ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="l_name"><?php echo display('benifit_acc_date') ?> </label>
                                                <input type="text" class="form-control datepicker" id="benifit_acc_date" name="benifit_acc_date[]" placeholder="Benefit Accrual Date" value="<?php echo $benifits->bnff_acural_date; ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                ...
                                <?php if (empty($benifit)) { ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="l_name"><?php echo display('benifit_desc') ?></label>
                                                <input type="text" class="form-control" id="benifit_c_code_d" name="benifit_c_code_d[]" placeholder="<?php echo display('benifit_desc') ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="benifit_acc_date" name="reports" placeholder="Reports" value="<?php echo $data->supervisor_report; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="dob" name="dob" placeholder="Date Of Birth" value="<?php echo $data->dob; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ethnic" name="ethnic" placeholder="Ethnic" value="<?php echo $data->ethnic_group; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="eeo_class"><?php echo display('eeo_class_gp') ?></label>
                                            <input type="text" class="form-control" id="eeo_class" name="eeo_class" placeholder="EEO Class Group" value="<?php echo $data->eeo_class_gp; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="ssn"><?php echo display('ssn') ?></label>
                                            <input type="text" class="form-control" id="ssn" name="ssn" placeholder="SSN" value="<?php echo $data->ssn; ?>">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <small id="fileHelp" class="text-muted"><img src="<?php echo base_url() . $data->picture ?>" id="output" class="img-thumbnail profile-height-width" />
                                        </small>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="h_email" name="h_email" placeholder="Home Email" value="<?php echo $data->home_email; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="b_email" name="b_email" placeholder="Business Email" value="<?php echo $data->business_email; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="h_phone"><?php echo display('home_phone') ?></label>
                                            <input type="number" class="form-control" id="h_phone" name="h_phone" placeholder="Home Phone" value="<?php echo $data->home_phone; ?>" oninput="validity.valid;">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="w_phone" name="w_phone" placeholder="Work Phone" value="<?php echo $data->business_phone; ?>" oninput="validity.valid;">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="c_phone" name="c_phone" placeholder="Cell Phone" value="<?php echo $data->cell_phone; ?>" oninput="validity.valid;">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="em_contact" name="em_contact" placeholder="Emergency Contact" value="<?php echo $data->emerg_contct; ?>" oninput="validity.valid||(value='');">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="e_h_phone" name="e_h_phone" placeholder="Emergency Home Phone" value="<?php echo $data->emrg_h_phone; ?>" oninput="validity.valid;">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="e_w_phone" name="e_w_phone" placeholder="Emergency Work Phone" value="<?php echo $data->emrg_w_phone; ?>" oninput="validity.valid;">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="e_c_relation" name="e_c_relation" placeholder="<?php echo display('emer_con_rela') ?>" value="<?php echo $data->emgr_contct_relation; ?>" oninput="validity.valid;">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="alt_em_cont"><?php echo display('alt_em_contct') ?></label>
                                            <input type="number" class="form-control" id="alt_em_cont" name="alt_em_cont" placeholder="Alter Emergency Contact" value="<?php echo $data->alt_em_contct; ?>" oninput="validity.valid;">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="a_e_h_phone"><?php echo display('alt_emg_h_phone') ?> </label>
                                            <input type="number" class="form-control" id="a_e_h_phone" name="a_e_h_phone" placeholder="<?php echo display('alt_em_contct') ?>" value="<?php echo $data->alt_emg_h_phone; ?>" oninput="validity.valid;">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="a_e_w_phone"><?php echo display('alt_emg_w_phone') ?> </label>
                                            <input type="number" class="form-control" id="a_e_w_phone" name="a_e_w_phone" placeholder="Alt Emergency Work Phone" value="<?php echo $data->alt_emg_w_phone; ?>" oninput="validity.valid;">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="c_f_name" name="c_f_name[]" value="<?php echo $custom->custom_field; ?>" placeholder="Custom Field Name">
                                                </div>
                                            </div>
