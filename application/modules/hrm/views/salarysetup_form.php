 <div class="form-group text-right">
    ...
    <?php }?>
     ...
     <a href="<?php echo base_url(); ?>hrm/Payroll/salary_setup_view"
         class="btn btn-success"><?php echo display('manage_salary_setup') ?></a>
     <?php endif; ?>
 </div>
                 ...
                 <div class="row">
                     <div class="col-sm-12 col-md-12">
                         <div class="panel">
                          ...
                          ?>
                                                 <tr>
                                                     <th class="padding-10-px">
                                                         <?php echo $ab->sal_name; ?>(<?php if($ab->amount_type==1){echo "%";}else{ echo $currency->curr_icon;}?>)
                                                     </th>
                                                     <td><input type="text"
                                                             name="amount[<?php echo $ab->salary_type_id; ?>]"
                                                             class="form-control addamount"
                                                             title="<?php if($ab->amount_type==1){echo 1;}else{ echo 0;}?>"
                                                             onkeyup="summary()" id="add_<?php echo $x; ?>"></td>
                                                 </tr>
                                                 <?php
                            $x++;
                          }
                          ...
                          ?>
                                                 <tr>
                                                     <th class="padding-10-px"><?php echo $row->sal_name; ?>
                                                         (<?php if($row->amount_type==1){echo "%";}else{ echo $currency->curr_icon;}?>)
                                                     </th>
                                                     <td><input type="text"
                                                             name="amount[<?php echo $row->salary_type_id; ?>]"
                                                             onkeyup="summary()" class="form-control deducamount"
                                                             title="<?php if($row->amount_type==1){echo 1;}else{ echo 0;}?>"
                                ...
                                ?>
                                                 <tr>
                                                     ...
                                                     <td class="padding-10-px"><input type="checkbox" name="tax_manager"
                                                             ...
                                                             value="1"><?php echo display('tax_ma_nager');?></td>
                                                 </tr>
