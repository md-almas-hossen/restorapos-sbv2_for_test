                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <a href="<?php echo base_url("hrm/Home/edit_atn_form/".$row['att_id']) ?>"
                                    class="btn btn-xs btn-success"><i
                                        class="fa fa-pencil"></i><?php echo display('update') ?></a>

                                <?php endif; ?>

                                <?php if($this->permission->method('hrm','delete')->access()): ?>
                                <a href="<?php echo base_url("hrm/Home/delete_atn/".$row['att_id']) ?>"
