 <div class="form-group text-right">
    ...
    <?php if (!$this->session->userdata('is_sub_branch')) {?>
     ...
     <a href="<?php echo base_url(); ?>hrm/Loan/loan_view"
         class="btn btn-success"><?php echo display('manage_granted_loan') ?></a>
     <?php endif; ?>
 </div>
                             ...
                             <div class="panel-body">
                                 ...
                                 <div class="form-group row">
                                     <label for="interest_rate"
                                         ...
                                         *</label>
                                     <div class="col-sm-9">
                                         <input type="number" min="0" name="interest_rate" class="form-control"
 ...
 <script src="<?php echo base_url('application/modules/hrm/assets/js/grandloan.js'); ?>" type="text/javascript">
 </script>