                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <?php if($this->permission->method('hrm','read')->access()): ?> 
                                    <a href="<?php echo base_url("hrm/Payroll/view_salstup_form/$que->employee_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                        <?php endif; ?>
                                
                                <?php if (!$this->session->userdata('is_sub_branch')) {?>

                                    <?php if($this->permission->method('hrm','update')->access()): ?>
                                    <a href="<?php echo base_url("hrm/Payroll/updates_salstup_form/$que->employee_id") ?>"
