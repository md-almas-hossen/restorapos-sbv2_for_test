                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <?php if (!$this->session->userdata('is_sub_branch')) {?>
                                ...
                                <td class="center">
                                    ...
                                    <a href="<?php echo base_url("hrm/Division_controller/division_form/$row->dept_id") ?>"
                                        class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                    <?php endif; ?>

                                    <?php if($this->permission->method('hrm','delete')->access()): ?>
                                    <a href="<?php echo base_url("hrm/Division_controller/delete_division/$row->dept_id") ?>"
