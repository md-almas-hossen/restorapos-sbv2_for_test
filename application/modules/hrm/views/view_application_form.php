         ...
         <div class="panel">
             ...
             <div class="panel-body">
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                         ...
                         <?php $value = $bb['employee_id'];
                                echo form_dropdown('employee_id', $dropdown, $value, 'class="form-control width-100" id="employee_id" disabled') ?>
                         <?php } else { ?>
                         ...
                         <input type="hidden" name="employee_id" class="form-control"
                             value="<?php echo $this->session->userdata('employee_id'); ?>" readonly>
                         <?php } ?>
                     ...
                     <input type="hidden" name="apply_date" class="form-control" id="f"
                         value="<?php echo $data->apply_date ?>" readonly>
                 </div>
                 <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                         <input type="text" name="apply_strt_date" class="datepickerjs form-control apply_start"
                             ...
                             value="<?php echo $data->apply_strt_date ?>" readonly>
                     </div>
                     ...
                     <div class="col-sm-4">
                         <input type="text" name="apply_end_date" class="datepickerjs form-control apply_end"
                             ...
                             placeholder="<?php echo display('apply_end_date') ?>" readonly>
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                         <input type="file" name="apply_hard_copy" class="form-control" readonly>
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                         <input type="text" name="leave_aprv_strt_date"
                             ...
                             placeholder="<?php echo display('leave_aprv_strt_date') ?>" readonly>
                     ...
                     <div class="col-sm-4">
                         <input type="text" name="leave_aprv_end_date"
                             ...
                             placeholder="<?php echo display('leave_aprv_end_date') ?>" readonly>
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                         <select name="approved_by" class="form-control width-100" disabled>
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-sm-10">
                         <textarea name="reason" class="form-control"
                             placeholder="<?php echo display('reason') ?>" readonly><?php echo $data->reason; ?></textarea>
                     </div>
                 </div>
                 <div class="form-group row">
                     <div class="col-sm-4">
                 ...
                 <div class="form-group">
                    <a href="<?php echo base_url('hrm/Leave/application_view');?>"><button type="button" class="btn btn-success w-md m-b-5"><?php echo display('back') ?></button>  </a>                                                                         
                 </div>
                 <?php echo form_close() ?>
