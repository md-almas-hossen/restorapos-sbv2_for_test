                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                <a href="<?php echo base_url("hrm/Candidate_select/update_shortlist_form//$que->can_short_id") ?>"
                                    class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                <a href="<?php echo base_url("hrm/Candidate_select/delete_shortlist/$que->can_short_id") ?>"
