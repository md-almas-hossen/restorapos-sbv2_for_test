...
<div class="form-group text-right">
    ...
    <a href="<?php echo base_url(); ?>hrm/Leave/application_view"
        class="btn btn-success"><?php echo display('manage_application'); ?></a>
    <?php endif; ?>
</div>
<!--  -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bgc-c-green-white">
                ...
                <strong><?php echo display('leave_application_form') ?></strong>
            </div>
...
<script src="<?php echo base_url('application/modules/hrm/assets/js/otherleave.js'); ?>" type="text/javascript">
</script>