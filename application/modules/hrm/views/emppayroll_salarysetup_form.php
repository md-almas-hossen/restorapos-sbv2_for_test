                     ...
                     <div class="col-sm-12 col-md-12">
                         <div class="panel">
                             ...
                             <div class="panel-body">
                                 ...
                                 <div class="form-group row">
                                     <label for="emp_sal_type" class="col-sm-3 col-form-label"><?php echo display('action') ?>*</label>
                                     <div class="col-sm-9">
                                 ...
                                 <div class="form-group row display-none" id="accselect">
                                     ...
                                     <div class="col-sm-9">
                                         <select name="headcode" class="form-control" placeholder="<?php echo display('transaction_head') ?>" id="headcode">						<?php foreach($alltranshead as $headcode){?>
                                             <option value="<?php echo $headcode->id;?>"><?php echo $headcode->Name;?></option>
                                             <?php } ?>
                                         </select>
                                     </div>
                                 </div>
                           ...
                           <option value="0">Amount(<?php echo $currency->curr_icon;?>)</option>
                                </select>
                            </div>
                        </div>
                                 <div class="form-group text-right">
