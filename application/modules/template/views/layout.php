...
// $files = glob('/var/www/html/application/cache/temp/*'); //get all file names
...
<html lang="en">
  ...
  80%, 100% {
    ...
    <body class="hold-transition sidebar-mini pace-done <?php
        if($setting->language == 'english') {
            echo 'english';
        } elseif($setting->language == 'arabic') {
            echo 'arabic';
        } elseif($setting->language == 'bangla') {
            echo 'bangla';
        }
        ?> <?php  echo $setting->posepagecolor;//if(($title=='posinvoiceloading') || ($title=='Counter Dashboard')|| ($title=='Add Purchase') || ($title=='Update Purchase')){ echo "sidebar-collapse pace-done"; echo $setting->posepagecolor;}?>">
        <!-- Site wrapper -->
        ...
        <header class="main-header"> 
            ...
            <div class="content-wrapper <?php if($title=='posinvoiceloading'){ echo "ml-0";}?>" style="<?php if($this->uri->segment(2)=="websitorder"){ echo "margin-left: 0;";}?>">
             ...
             <!--   <section class="content-header">
                    ...
                    <div class="header-title">
						...
						if($this->uri->segment(2)=="paymentmethod"){
									...
									$titlename=display('shift_module');
									}
								else if($this->uri->segment(2)=="Wastetracking"){
									$titlename=display('waste_tracking');
									}
									...
									$titlename=display('qr_module');
									}
								else if($this->uri->segment(2)=="facebookloginback"){
									$titlename=display('facebook_login');
									}
                ...
                <!-- Main content -->
                <div class="content bg_dashboard_main <?php if($title=='posinvoiceloading'){ echo "p-0";}?>" <?php if($title=='Counter Dashboard'){ echo "padding-left: 75px;";}?>">
                    <!-- load messages -->
