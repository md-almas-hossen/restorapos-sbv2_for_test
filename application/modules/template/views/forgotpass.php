...
<head>
    ...
    <title><?php echo (!empty($title)?$title:null) ?> :: <?php echo (!empty($title)?$title:null) ?></title>
        ...
        <div class="login-content login-content_bg">
        	<div class="">
                 ...
                 <div class="text-center mb-5">
                    <h1 class="mt-0"><?php echo display('forgot_password') ?></h1>
                    <div class="text-muted">
                        <?php echo (!empty($setting->title)?$setting->title:null) ?>
                    </div>
                </div>
                <?php echo form_open('resetpass','id="loginForm"'); ?>            
                <div class="form-group">
                    <label for="email"><?php echo display('email') ?></label>
                    <input type="text" placeholder="<?php echo display('email') ?>" name="email" id="email" class="form-control fs-15px" autocomplete="off" required="required"> 
                </div>
                <button type="submit" class="btn btn-success btn-lg btn-block fw-500 mb-3"><?php echo display('submit') ?></button>
