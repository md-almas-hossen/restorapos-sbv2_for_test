            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <fieldset class="border p-2">
                       <legend  class="w-auto"><?php echo display('set').' '.display('packaging_food'); ?></legend>
                    </fieldset>
                    <?php echo form_open_multipart('wastemangment/wastetracking/packagewasteentry',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                    ...
                    <div class="row">
                             <div class="col-sm-7">
                               <div class="form-group row">
                                    <label for="supplier_sss" class="col-sm-4 col-form-label"><?php echo display('order_id') ?> <i class="text-danger">*</i>
                                    </label>
                                    <div class="col-sm-6">
                                       <input type="" name="orderid" class="form-control" id="orderid" autocomplete="off">
                                    </div>
                                </div> 
                            </div>
                     ...
                     <table class="table table-bordered table-hover" id="purchaseTable">
                                <thead>
                                     <tr>
                                            ...
                                            <th class="text-center"><?php echo display('qnty')?> <i class="text-danger">*</i></th>
        ...
        <div class="row">
          <div class="row">
            ...
            <div class="panel panel-default">
              ...
              <a  class="btn btn-success" id="search_date"  onclick="getreport(this)" data-url="<?php echo base_url("wastemangment/wastetracking/tablewaste") ?>"><?php echo display('search') ?></a>
   ...
   function calprice(element)
    {
      ...
      var qty = $(element).val();
	  var price=parseFloat(toatalval)*parseFloat(qty);
        $('#price_'+id).val(price.toFixed(3));
