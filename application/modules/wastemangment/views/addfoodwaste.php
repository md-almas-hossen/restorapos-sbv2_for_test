<div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <fieldset class="border p-2">
                       <legend  class="w-auto"><?php echo display('set').' '.display('food_lost'); ?></legend>
                    </fieldset>
                    <?php echo form_open_multipart('wastemangment/wastetracking/insertfoodinformation',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                    <input name="url" type="hidden" id="url" value="<?php echo base_url("wastemangment/wastetracking/fooditem") ?>" />
                    ...
                    <div class="row">
                     ...
                     <table class="table table-bordered table-hover" id="purchaseTable">
                                <thead>
                                     <tr>
                                            <th class="text-center" width="20%"><?php echo display('food_name');?><i class="text-danger">*</i></th> 
                                           
                                              <th class="text-center"><?php echo display('waste').' '.display('qnty');?> </th>
                                ...
                                <tbody id="addPurchaseItem">
                                    <tr>
                                       ...
                                       <input type="text" name="product_name" required="" class="form-control product_name" onkeypress="product_list(1);" placeholder="<?php echo display('food_name');?>" id="product_name_1" tabindex="5" autocomplete="off">
            ...
            <div class="panel panel-default">
              ...
              <a  class="btn btn-success" id="search_date" onclick="getreport(this)" data-url="<?php echo base_url("wastemangment/wastetracking/tableFood") ?>"><?php echo display('search') ?></a>
...
function product_list(sl) {
    ...
    //alert(csrfname);
    if (foodid == 0 || foodid=='') {
        alert('<?php echo display('selct_user') ?>');
        return false;
    }
   ...
   function calprice(element)
    {
      ...
      var value = parseFloat(qty).toFixed(2);
