								...
								foreach($iteminfo as $item){
                                    ...
                                    <tr>
                                       ...
                                       <td class="wt">
                                        ...
                                        <td class="text-right">
                                            <input type="number" step="0.00001" name="storage_quantity[]" id="box_<?php echo $i;?>" onkeyup="calculate_singleqty(<?php echo $i;?>);" onchange="calculate_singleqty(<?php echo $i;?>);" class="form-control text-right storage_cal_1" placeholder="0.00" value="<?php echo $item->quantity/$item->conversionvalue;?>" min="0.01" tabindex="7" required="" oninput="this.value; /^[0-9]+(.[0-9]{1,10})?$/.test(this.value)||(value='0.00');">
                                            <input type="hidden" name="conversion_value[]" id="conversion_value_<?php echo $i;?>" value="<?php echo $item->conversionvalue;?>">
                                        </td>
