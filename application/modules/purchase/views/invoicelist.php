<div class="form-group text-right">
    ...
    <a href="<?php echo base_url("purchase/purchase/return_form")?>" class="btn btn-primary btn-md"><i
                ...
                <table width="100%" class="datatable2 table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            <td><?php echo $sl; ?></td>
                            <td><?php echo getPrefixSetting()->purchase_return. '-' . $items->po_no; ?></td>
