...
<div class="form-group text-right">
    ...
    <!-- create -->
    <?php if ($this->permission->check_label('so_request_list')->create()->access()) : ?>
    <a href="<?php echo base_url('purchase/purchase/soRequestAdd'); ?>" class="btn btn-success btn-md"><i
            class="fa fa-plus-circle" aria-hidden="true"></i>
        <?php echo display('new_so_request');?></a>
    <?php endif;?>
    <!-- cretae -->
            ...
            <div class="panel-body">
                ...
                <table class="datatable2 table table-striped table-bordered table-hover">
                    <thead>
                        ...
                        <th><?php echo display('request_date');?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                        if($li->status == 0){
                                            echo "<span style='margin-top:5px; color:white!important' class='badge'>". display('pending')."</span>";
                                        }else{
                                            echo "<span style='margin-top:5px; color:white!important' class='badge'>". display('approved')."</span>";
                                        }
                                    ?>
                            </td>
                            <td>
                                ...
                                <?php if ($li->status == 0) :  ?>
                                <a href="<?php echo base_url('purchase/purchase/soRequestAssign/' . $li->id); ?>"
                                    class="btn btn-sm btn-success"><?php echo display('assign_so_items');?> <i
                                        class="fa fa-check"></i></a>
                                <?php else: ?>
                                <a href="<?php echo base_url('purchase/purchase/soRequestAssign/' . $li->id); ?>"
                                    class="btn btn-sm btn-primary"><?php echo display('edit_assigned_so_items');?> <i
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?php
                                                        $details = $this->purchase_model->watchSORequest($li->id);
                                                        ?>
                                                <div class="table-responsive" id="printArea">
                                                    ...
                                                    <table
                                                        ...
                                                        <thead>
                                                            ...
                                                            <th><?php echo display('requested_qty');?></th>
                                                            <th><?php echo display('request_date');?></th>
                                                            <th><?php echo display('given_qty');?></th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $data->given_qty . ' ' . $data->uom_short_code; ?>
                                                                </td>
                                ...
                                <!-- edit -->
                                <?php if ($this->permission->check_label('so_request_list')->update()->access()) : ?>
                                <?php if ($li->status == 0) :  ?>
                                <a href="<?php echo base_url('purchase/purchase/soRequestEdit/' . $li->id); ?>"
                                ...
                                <!-- delete -->
                                <?php if ($this->permission->check_label('so_request_list')->delete()->access()) : ?>
                                <a href="<?php echo base_url('purchase/purchase/soRequestDelete/' . $li->id); ?>"
