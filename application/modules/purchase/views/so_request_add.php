    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd">
            <div class="panel-heading d-flex align-items-center justify-content-between">
                ...
                <a href="<?php echo base_url("purchase/purchase/soRequestList")?>"
                    class="btn btn-success btn-md pull-right"><i class="fa fa-list" aria-hidden="true"></i>
                    <?php echo display('so_request_list')?></a>
                <?php endif; ?>
            </div>


            <div class="panel-body">
                <?php echo form_open_multipart('purchase/purchase/soRequestStore', array('class' => 'form-vertical', 'id' => 'insert_purchase', 'name' => 'insert_purchase')) ?>
                ...
                ?>
                    ...
                    ?>
                    <input type="hidden" name="kitchenid" class="form-control" id="kitchenid"
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for=""><?php echo "Assign Date"; ?><i class="text-danger">*</i></label>
                ...
                <table class="table table-bordered table-hover" id="purchaseTable">
                    <thead>
                        <tr>
                            <th class="text-center" width="25%"><?php echo "Product Type:" ?><i
                                    class="text-danger">*</i></th>
                            <th class="text-center" width="25%"><?php echo display('item_information') ?><i
                                    class="text-danger">*</i></th>
                            <th class="text-center" width="50%"><?php echo display('qty') ?> <i
                                    class="text-danger">*</i></th>
                        </tr>
                    </thead>
                    <tbody id="addPurchaseItem">
                        <tr id="row1">
                            ...
                            <td><select name="product_type[]" id="product_type_1" onchange="product_dropdown(1)"
...
$('#add_invoice_item').click(function() {
    ...
    $('#addPurchaseItem').append(`
                ...
                <input type="hidden" name="id_check[]" value="${i}"/>
                    ...
                    <td class="text-right">
                        <input type="number" step="0.00001" name="product_quantity[]" id="cartoon_${i}" class="form-control text-right"  placeholder="0.00" value="" min="0.01" tabindex="6" required="">
                    </td>
                    <td>
