                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="" id="datebetween">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="from_date"  value="<?php echo $today; ?>" class="datepicker5 form-control" id="from_date"/>
                                </div>
                            </div>      
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="to_date" value="<?php echo $today; ?>" class="datepicker5 form-control" id="to_date"/>
                                </div>
                            </div>
                        </div> 
                                    ...
                                    <tbody>
                                        ...
                                        if ($supplierledger) {
                                            ...
                                            foreach ($supplierledger as $ledger) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="text-center"><?php echo $ledger->purchasedate; ?></td>
                                                    <td><?php echo $ledger->details; ?></td>
                                                    <td><?php echo $ledger->invoiceid;?></td>
                                                    <td align="right">
                                                        <?php
                                                        /*if ($ledger->d_c == 'd') {
