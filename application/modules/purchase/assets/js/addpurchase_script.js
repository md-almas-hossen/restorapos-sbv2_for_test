function product_types(sl) {
  ...
  function calculate_store(sl) {
      ...
      /*if(item_ctn_qty=='' || item_ctn_qty==''){
          alert("You Can't Add Quantity!!. First Add to quantity!!");
          return false;
      }*/
