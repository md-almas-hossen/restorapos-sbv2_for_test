    ...
    <div id="printArea">
        ...
        <div class="table-responsive">
            <table width="100%" class="table table-striped table-bordered table-hover" id="profit-loss-report">
                <thead>
                    <tr>
                        <th width="50%"><strong>Particulers</strong></th>
                        <td class="text-right"><strong>Ledger <?php echo display('amount'); ?>(<?php echo $currency; ?>)</strong></td>
                        <td class="text-right"><strong>Sub Ledger <?php echo display('amount'); ?>(<?php echo $currency; ?>)</strong></td>
                        <td class="text-right"><strong>Group Ledger <?php echo display('amount'); ?>(<?php echo $currency; ?>)</strong></td>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <?php foreach ($getProfitLossNature_3_Balances as $key1 => $data): ?>
                            <?php if ($data->level == 1): ?>
                                <tr class="voucherList">
                                    <td style="background: #008d4b9e!important;"><strong><?php echo $data->name; ?></strong></td>
                                    <td style="background: #008d4b9e!important;"></td>
                                    <td style="background: #008d4b9e!important;"></td>
                                    <td style="background: #008d4b9e!important;" class="text-right">
                                        <strong><?php echo number_format($data->credit, 2); ?></strong>
                                    </td>
                                </tr>
                            <?php elseif ($data->level == 2): ?>
                                <tr class="voucherList">
                                    <td style="padding-left:40px;"><?php echo $data->name; ?></td>
                            ...
                            <?php elseif ($data->level == 3): ?>
                                <tr class="voucherList">
                                    <td style="padding-left:80px;"><?php echo $data->name; ?></td>
                                    <td class="text-right">0.00</td>
                                    <td class="text-right"><?php echo number_format($data->credit, 2); ?></td>
                                    <td class="text-right">0.00</td>
                                </tr>
                            ...
                            <?php elseif ($data->level == 0 && property_exists($data, 'class')): ?>
                                <tr class="voucherList <?php echo $data->class; ?>">
                                    ...
                                    <td colspan="3" class="text-right"><strong><?php echo number_format($data->credit, 2); ?></strong></td>
                                </tr>
                        ...
                        <?php foreach ($getProfitLossNature_4_Balances as $key1 => $data): ?>
                            <?php if ($data->level == 1): ?>
                                <tr class="voucherList">
                                    ...
                                    <td style="background: #008d4b9e!important;"></td>
                                    <td style="background: #008d4b9e!important;" class="text-right">
                                        <strong><?php echo number_format($data->debit, 2); ?></strong>
                                    </td>
                                </tr>
                            <?php elseif ($data->level == 2): ?>
                                <tr class="voucherList">
                            ...
                            <?php elseif ($data->level == 0 && property_exists($data, 'class')): ?>
                                <tr class="voucherList <?php echo $data->class; ?>">
                                    <td><strong><?php echo $data->name; ?></strong></td>
                                    <td colspan="3" class="text-right"><strong><?php echo number_format($data->debit, 2); ?></strong></td>
                                </tr>
                            <?php elseif ($data->level == 0): ?>
                                <tr class="voucherList">
                                    <td><strong><?php echo $data->name; ?></strong></td>
