                        ...
                        <tbody>
                            ...
                            // dd($trial_balance_data);
                             ...
                             foreach ($trial_balance_data as $arr_key => $t_b_data) {
                                  ...
                                  ?>
                                 <tr class="header-row">
                                    <th style="background: #55e3b7!important"><strong>
                                        <?php 
                                    ...
                                    <th style="background: #55e3b7!important"></th>
                                    <th style="background: #55e3b7!important"></th>
                                </tr>
                                        ...
                                        <tr>
                                             <td>
                                                ...
                                                <?php echo form_open('accounts/AccReportController/general_ledger_report_search_from_trial', ['method' => 'POST', 'target' => '_blank']); ?>
                                                    ...
                                                    <!-- Hidden Inputs -->
                                                    <?php echo form_hidden('cmbCode', $t_b_detail_data['acc_id']); ?>
                                                    ...
                                                    <button type="submit" style="border: none;background: transparent; width: 100%; text-align:left">
                                                        <?php echo $t_b_detail_data['acc_name']; ?>
                                                    </button>
                                                <?php echo form_close(); ?>

        
                                            </td>
                                             <td style="text-align:right;"><?php echo $t_b_detail_data['debit'];?></td>
                                             <td style="text-align:right;"><?php echo $t_b_detail_data['credit'];?></td>
                                        </tr>
                              ...
                              ?>
                                    <tr>
                                        <td style="background: #55e3b7!important"><strong><?php echo $t_b_data[0]['acc_name'];?></strong></td>
                                        <td style="background: #55e3b7!important;text-align:right;"><?php echo $t_b_data[0]['debit'];?></td>
                                        <td style="background: #55e3b7!important;text-align:right;"><?php echo $t_b_data[0]['credit'];?></td>
                                   </tr>
                              <?php    
                                   }
                              }
