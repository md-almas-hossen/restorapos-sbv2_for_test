        ...
        <div class="panel panel-bd">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <?php echo display('sub_ledger_merged') ?>
                    </h4>
                </div>
            </div>
            <div class="panel-body">
               <div class="form-inline">
                ...
                <button class="btn btn-success" onclick="getSubLedgerMerged()"><?php echo display('search') ?></button>
                        </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo base_url('application/modules/accounts/assets/reports/sub_ledger_merged_report.js?v=2'); ?>" type="text/javascript"></script>
