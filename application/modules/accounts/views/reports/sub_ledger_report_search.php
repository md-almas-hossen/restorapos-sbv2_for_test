...
<div class="row" id="printArea">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd" style="border: 0; ">
            ...
            <input type="hidden" id="cmbCode" value="<?php echo $acc_coa_id; ?>">
            ...
            <div class="panel-body" id="printArea">
                ...
                <div class="text-center">
                    ...
                    <h3 class="mt-10"><?php echo display('sub_ledger') . ' ' . display('report') ?></h3>
...
<script src="<?php echo base_url('application/modules/accounts/assets/reports/sub_ledger_report.js'); ?>" type="text/javascript"></script>
