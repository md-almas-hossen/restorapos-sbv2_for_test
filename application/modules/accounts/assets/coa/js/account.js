...
function addCartOfAccount(coaID) {
    ...
    var url = baseurl + 'accounts/AccCoaController/getCoaDetail/' + coaID;
    accLoader();
    $.ajax({
        type: 'GET',
        url: url,
...
function addNewCoaFrom(ObjData) {
    ...
    lines += "<div class='row'>";
    lines += "<label for='currentHeadLabel' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'>Head Label<i class='text-danger'>*</i></label>";
    ...
    if (currentHeadLabel == 3 || currentHeadLabel == 4) {
        lines += "<div class='row'>";
        lines += "<label for='note_no' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'>Note No</label>";
        lines += "<div class='col-sm-8 col-md-12 col-xl-8'>";
    ...
    // account_name start
    lines += "<div class='row'>";
    lines += "<label for='account_name' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'>Ledger Name<i class='text-danger'>*</i></label>";
    lines += "<div class='col-sm-8 col-md-12 col-xl-8'>";
    ...
    lines += "<label for='bed_no' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold required'>Status</label>";
    ...
    lines += "<label class='form-check-label' for='is_active'>Inactive</label>";
...
function addLoadFromForAll(allfromLoad) {
    ...
    addFrom += "<label for='currentHeadLabel' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'>Head Label<i class='text-danger'>*</i></label>";
    ...
    if (currentHeadLabel == 3 || currentHeadLabel == 4) {
        addFrom += "<div class='row'>";
        addFrom += "<label for='note_no' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'>Note No</label>";
        addFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
    ...
    // row start
    addFrom += "<div class='row'>";
    addFrom += "<label for='account_name' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'> Ledger Name <i class='text-danger'>*</i></label>";
    addFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
    ...
    addFrom += "<label for='bed_no' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold required'>Status</label>";
    ...
    addFrom += "<label class='form-check-label' for='is_active'>Inactive</label>";
    ...
    if ((Number(allfromLoad.coaDetail.head_level) == 2) && (Number(allfromLoad.coaDetail.acc_type_id) == 1)) {
        ...
        addFrom += "<div class='row mt-2'>";
        addFrom += "<label for='asset_type' class=' col-sm-2 col-md-2 col-xl-2 fw-semibold required'>Asset Type</label>";
        addFrom += "<div class='col-sm-8 col-md-12 col-xl-8 mt-2'>";
    ...
    if ((Number(allfromLoad.coaDetail.head_level) == 3) && (Number(allfromLoad.coaDetail.acc_type_id) == 1)) {
        ...
        //Assect radio button start
        addFrom += "<div class='row mt-2'>";
        addFrom += "<label for='asset_type' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'>Asset Type</label>";
        addFrom += "<div class='col-sm-8 col-md-12 col-xl-8 mt-2'>";
        ...
        addFrom += "<div class='row'>";
        addFrom += "<label for='asset_code' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'> Fixed Asset Code </label>";
        addFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
        ...
        addFrom += "<div class='row'>";
        addFrom += "<label for='depreciation_rate' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'> Depraciation Rate % </label>";
        addFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
        ...
        addFrom += "<div class='row'>";
        addFrom += "<label for='Sub Type' class='col-sm-4 col-md-12 col-xl-4 fw-semibold'>Sub Type</label>";
        addFrom += "<div class='col-md-8'>";

        addFrom += "<select id='subtype_id' name='subtype_id' class='form-control'>";
    ...
    if ((Number(allfromLoad.coaDetail.head_level) == 3) && ((Number(allfromLoad.coaDetail.acc_type_id) == 4) || (Number(allfromLoad.coaDetail.acc_type_id) == 5))) {
        ...
        //Fixed Asset Code start
        addFrom += "<div class='row'>";
        addFrom += "<label for='dep_code' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'> Depraciation Code </label>";
        addFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
...
function loadDelfrom(data) {
    ...
    delform += "<label for='account_name' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'> Ledger Name <i class='text-danger'>*</i></label>";
...
function checkUpdeate(data) {
    ...
    var editurl = baseurl + 'accounts/AccCoaController/edit/' + editcoaId;
...
function loadUpdatefrom(UpdateCoaData) {
    ...
    var updateFrom = "<div class='row mt-3'>";
    updateFrom += "<div class='col-md-12'>";
    // row start
    updateFrom += "<div class='row'>";
    updateFrom += "<label for='currentHeadLabel' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'>Head Label<i class='text-danger'>*</i></label>";
    ...
    //note start
    if (currentHeadLabel == 3 || currentHeadLabel == 4) {
        updateFrom += "<div class='row  mt-3'>";
        updateFrom += "<label for='note_no' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'>Note No</label>";
        updateFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
        updateFrom += "<input type='text' class='form-group form-control' id='note_no' name='note_no' value = '" + note_no + "'>";
        updateFrom += "</div>";
        updateFrom += "</div>";
    }
    //note end
    ...
    // row start
    updateFrom += "<div class='row mt-3'>";
    updateFrom += "<label for='account_name' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'>Ledger Name<i class='text-danger'>*</i></label>";
    updateFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
    updateFrom += "<input type='text' class='form-group form-control' id='account_name' name='account_name' value = '" + UpdateCoaData.coaDetail.account_name + "' required>";
    updateFrom += "</div>";
    updateFrom += "</div>";
    // row end
    ...
    updateFrom += "<div class='row mt-3'>";
    updateFrom += "<label for='Parent Name' class='col-sm-4 col-md-12 col-xl-4 fw-semibold'>Parent Name</label>";
    updateFrom += "<div class='col-md-8'>";

    updateFrom += "<select id='parent_id' name='parent_id' class='form-control'>";
    ...
    updateFrom += "<div class='row mt-3'>";
    updateFrom += "<label for='bed_no' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold required'>Status</label>";
    updateFrom += "<div class='col-sm-8 col-md-12 col-xl-8 mt-2'>";
    updateFrom += "<label class='radio-inline'><input type='radio' name='is_active' value='1' id='is_active' checked > Active </label>";
    updateFrom += "<label class='radio-inline'><input type='radio' name='is_active' value='0' id='is_active' >Inactive</label>";
    updateFrom += "</div>";
    updateFrom += "</div>";
    //radio button End
    }else{
    ...
    if ((Number(UpdateCoaData.coaDetail.head_level) == 3) && (Number(UpdateCoaData.coaDetail.acc_type_id) == 1)) {
        ...
        updateFrom += "<label for='asset_type' class=' col-sm-2 col-md-2 col-xl-2 fw-semibold required'>Asset Type</label>";
        updateFrom += "<div class='col-sm-8 col-md-12 col-xl-8 mt-2'>";

        if (UpdateCoaData.coaDetail.is_stock == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_stock' checked required id='is_stock' >";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_stock' required id='is_stock'>";
        }


        updateFrom += "Is Stock</label>";

        if (UpdateCoaData.coaDetail.is_fixed_asset_schedule == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_fixed_asset' checked id='is_fixed_asset' >";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_fixed_asset' id='is_fixed_asset'>";
        }

        updateFrom += "Is Fixed Asset</label>";
    ...
    if ((Number(UpdateCoaData.coaDetail.head_level) == 3) && ((Number(UpdateCoaData.coaDetail.acc_type_id) == 4) || (Number(UpdateCoaData.coaDetail.acc_type_id) == 5))) {
        ...
        if (UpdateCoaData.coaDetail.is_fixed_asset_schedule == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='checkbox' name='asset_type' value='is_fixed_asset' checked  id='is_fixed_asset'>";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='checkbox' name='asset_type' value='is_fixed_asset' id='is_fixed_asset'>";
        }
    ...
    if ((Number(UpdateCoaData.coaDetail.head_level) == 4) && (Number(UpdateCoaData.coaDetail.acc_type_id) == 1)) {
        ...
        if (UpdateCoaData.coaDetail.is_stock == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input  m-1' type='radio' name='asset_type' value='is_stock' id = 'editasset_is_stock' checked required >";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input  m-1' type='radio' name='asset_type' value='is_stock' id = 'editasset_is_stock' required >";
        }
        updateFrom += "Is Stock</label>";

        if (UpdateCoaData.coaDetail.is_fixed_asset_schedule == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input  m-1' type='radio' name='asset_type' value='is_fixed_asset' id = 'editasset_is_fixed_asset' checked >";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input  m-1' type='radio' name='asset_type' value='is_fixed_asset' id = 'editasset_is_fixed_asset'  >";
        }
        updateFrom += "Is Fixed Asset</label>";


        if (UpdateCoaData.coaDetail.is_subtype == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_subtype'  id = 'editasset_is_subtype' checked >";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_subtype'  id = 'editasset_is_subtype' >";
        }
        updateFrom += "Is Sub Type</label>";

        if (UpdateCoaData.coaDetail.is_cash_nature == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input mr-3 m-1' type='radio' name='asset_type' value='is_cash' id = 'editasset_is_cash' checked >";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input mr-3 m-1' type='radio' name='asset_type' value='is_cash' id = 'editasset_is_cash' >";
        }
        updateFrom += "Is Cash Nature</label>";

        if (UpdateCoaData.coaDetail.is_bank_nature == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_bank'  id = 'editasset_is_bank' checked>";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_bank'  id = 'editasset_is_bank' >";
        }
        updateFrom += "Is Bank Nature</label>";
        ...
        if ((UpdateCoaData.coaDetail.asset_code != '') || (UpdateCoaData.coaDetail.depreciation_rate != 0)) {

            updateFrom += "<div class='col-md-12 mt-3'>";
            updateFrom += "<div class='row mt-2' id='editfixedAssetField'>";
            //Fixed Asset Code start
            updateFrom += "<div class='row'>";
            updateFrom += "<label for='asset_code' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'> Fixed Asset Code </label>";
            updateFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
            if (UpdateCoaData.coaDetail.asset_code != '') {
            ...
            updateFrom += "<div class='row'>";
            updateFrom += "<label for='depreciation_rate' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'> Depraciation Rate % </label>";
            updateFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
        ...
        if (UpdateCoaData.coaDetail.subtype_id != null) {
            ...
            updateFrom += "<div class='col-md-12 mt-3'>";
            updateFrom += "<div class='row'>";
            updateFrom += "<label for='Sub Type' class='col-sm-4 col-md-12 col-xl-4 fw-semibold'>Sub Type</label>";
            updateFrom += "<div class='col-md-8'>";

            updateFrom += "<select id='subtype_id' name='subtype_id' class='form-control'>";
    ...
    if ((Number(UpdateCoaData.coaDetail.head_level) == 4) && ((Number(UpdateCoaData.coaDetail.acc_type_id) == 2) || (Number(UpdateCoaData.coaDetail.acc_type_id) == 3))) {
        ...
        if (UpdateCoaData.coaDetail.is_subtype == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='checkbox' name='asset_type' value='is_subtype'  id = 'editexpin_is_subtype' checked >";
            $("#editSubtypeExpIncField").removeClass("d-none");
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='checkbox' name='asset_type' value='is_subtype'  id = 'editexpin_is_subtype' >";
    ...
    if ((Number(UpdateCoaData.coaDetail.head_level) == 4) && ((Number(UpdateCoaData.coaDetail.acc_type_id) == 4) || (Number(UpdateCoaData.coaDetail.acc_type_id) == 5))) {
        ...
        if (UpdateCoaData.coaDetail.is_fixed_asset_schedule == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input  m-1' type='radio' name='asset_type' value='is_fixed_asset' id = 'editlieq_is_fixed_asset' checked >";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input  m-1' type='radio' name='asset_type' value='is_fixed_asset' id = 'editlieq_is_fixed_asset'  >";
        }
        updateFrom += "Is Fixed Asset</label>";


        if (UpdateCoaData.coaDetail.is_subtype == 1) {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_subtype'  id = 'editlieq_is_subtype' checked >";
        } else {
            updateFrom += "<label class='radio-inline'><input class='form-check-input m-1' type='radio' name='asset_type' value='is_subtype'  id = 'editlieq_is_subtype' >";
        }
        updateFrom += "Is Sub Type</label>";
        ...
        if (UpdateCoaData.coaDetail.is_fixed_asset_schedule == 1) {
            ...
            //Fixed Asset Code start
            updateFrom += "<div class='row'>";
            updateFrom += "<label for='dep_code' class=' col-sm-4 col-md-12 col-xl-4 fw-semibold'> Depraciation Code </label>";
            updateFrom += "<div class='col-sm-8 col-md-12 col-xl-8'>";
    ...
    if (Number(UpdateCoaData.coaDetail.head_level) == 4 && currentHeadLabel != 1) {
        ...
        updateFrom +=
            "<div class='form-group mt-3'><button type='submit' class='btn btn-primary'>Update</button><a class='btn btn-success mx-2' onclick='addLoadFromForAll(" +
            stringifiedObj +
            ")'>Create</a>";
        if (currentHeadLabel != 1) {
...
$(document).on('click', '#asset_is_none', function () {
    var isChecked = $(this).is(':checked');
    if (isChecked == true) {
        $("#fixedAssetField").addClass("d-none");
        $("#SubtypeAssetField").addClass("d-none");
