...
class Fooditem_model extends CI_Model {
    ...
    public function read_fooditem($limit = null, $start = null)
	{
        ...
        $this->db->order_by('item_foods.ProductsID', 'desc');
        $this->db->where('item_foods.is_deleted',0);
	...
	public function findByingId($id = null)
	{ 
...
public function settinginfo()
	...
	public function allfooditem($catid)
		{ 
		$this->db->select('item_foods.*,variant.variantid,variant.variantName,variant.price');
        $this->db->from('item_foods');
		$this->db->join('variant','item_foods.ProductsID=variant.menuid','left');
	...
	public function createaccess($data = array()){
			return $this->db->insert_batch('tbl_itemwiseuser', $data);
		}
	...
	public function total_vat_tax_count(){
