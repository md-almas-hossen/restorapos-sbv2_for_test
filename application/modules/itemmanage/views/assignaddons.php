                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo  form_open('itemmanage/menu_addons/assignaddonscreate','method="post" id="myfrmreset"') ?>
                                <?php echo form_hidden('row_id', (!empty($addonsinfo->row_id)?$addonsinfo->row_id:null)) ?>
                                <div class="form-group row">
                                    <label for="addonsid"
                                        class="col-sm-4 col-form-label"><?php echo display('addons_name') ?>*</label>
						...
						echo form_dropdown('addonsid',$addonsdropdown,(!empty($addonsinfo->add_on_id)?$addonsinfo->add_on_id:null),'class="form-control"') ?>
                                ...
                                <div class="form-group row">
                                    <label for="menuid"
                                        class="col-sm-4 col-form-label"><?php echo display('item_name') ?>*</label>
                                    <div class="col-sm-8 customesl">
                                        <?php 
						if(empty($addonsmenulist)){$addonsmenulist = array('' => '--Select--');}
						echo form_dropdown('menuid',$menudropdown,(!empty($addonsinfo->menu_id)?$addonsinfo->menu_id:null),'class="form-control"') ?>
                                ...
                                <?php if(!empty($addonsinfo->row_id)){?>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <?php if (!$this->session->userdata('is_sub_branch')) {?>
                                ...
                                <td class="center">
                                    ...
                                    <a href="<?php echo base_url("itemmanage/menu_addons/assignaddonsdelete/$addonsmenu->row_id") ?>"
