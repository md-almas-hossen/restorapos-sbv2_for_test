                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo  form_open('itemmanage/item_food/availablecreate','method="post" id="myfrmreset"') ?>
						...
						echo form_dropdown('foodid',$itemdropdown,(!empty($intinfo->foodid)?$intinfo->foodid:null),'class="form-control"') ?>
                                ...
                                <div class="form-group row">
                                    <label for="availday"
                                        class="col-sm-3 col-form-label"><?php echo display('available_day') ?> *<a
                                            class="cattooltips" data-toggle="tooltip" data-placement="top"
                                            title="Use Day Name Like:Saturday,Sunday....."><i
                                ...
                                <div class="form-group row">
                                    <label for="fromtime"
                                        class="col-sm-3 col-form-label"><?php echo display('from_time') ?> *<a
                                            class="cattooltips" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <label for="totime" class="col-sm-2 col-form-label"><?php echo display('to_time') ?>
                                    </label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <?php if(!empty($intinfo->availableID)){?>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <?php if (!$this->session->userdata('is_sub_branch')) {?>
                                ...
                                <td class="center">
                                    ...
                                    <a href="<?php echo base_url("itemmanage/item_food/deleteavailable/$avail->availableID") ?>"
