        ...
        <div class="panel-heading">
                <div class="panel-title d-flex justify-content-between align-items-center">
                    ...
                    <?php if (!$this->session->userdata('is_sub_branch')) {?>
                     <div class="pull-right font-p-fw d-flex align-items-center"><a class="width-100 btn btn-success" href="<?php echo base_url("itemmanage/item_category/create") ?>"><?php echo display('add_category') ?></a></div>
                    <?php }?>
                </div>
            </div>
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo display('category_code') ?></th>
						...
						?>
                            ...
                            <?php foreach ($categories as $category) {
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><?php echo $category->CatCode; ?></td>
                                    <td><?php echo $category->ordered_pos; ?></td>
