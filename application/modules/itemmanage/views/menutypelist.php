                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <?php echo  form_open_multipart('itemmanage/item_food/menutypecreate','method="post" id="myfrmreset"') ?>
                                ...
                                <div class="form-group row">
                                    <label for="menu_type_name"
                                        ...
                                        *</label>
                                    <div class="col-sm-8">
                                        <input name="menu_type_name" class="form-control" type="text"
                                ...
                                <?php if(!empty($intinfo->menutypeid)){?>
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td><?php echo $tmenu->status?'Active':'Inactive'; ?></td>
                            ...
                            <?php if (!$this->session->userdata('is_sub_branch')) {?>
                                ...
                                <td class="center">
                                    ...
                                    <input name="url" type="hidden" id="url_<?php echo $tmenu->menutypeid; ?>"
                                        value="<?php echo base_url("itemmanage/item_food/updatemenufrm") ?>" />
                                    ...
                                    <a href="<?php echo base_url("itemmanage/item_food/deletemenutype/$tmenu->menutypeid") ?>"
...
<script src="<?php echo base_url('application/modules/itemmanage/assets/js/menutypelist_script.js'); ?>"
