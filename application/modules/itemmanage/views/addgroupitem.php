        ...
        <div class="panel panel-bd">
            <div class="panel-heading">
                <div class="panel-title box-header itemmanage_box_header" >
                    <h4><?php echo (!empty($title)?$title:null) ?><span class="pull-right"><input type="text" name="item_list" class="form-control" placeholder="Search" id="item_list"  />
                    
                    </span>
                </h4>
                  </div>  
            </div>
             <?php echo form_open_multipart("itemmanage/item_food/addgroupfood",'method="post" id="myfrmreset"') ?>
            <div class="panel-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="foodcode" class="form-control" type="text" placeholder="<?php echo display('foodcode') ?>" id="foodcode"  value="<?php echo (!empty($productinfo->foodcode)?$productinfo->foodcode:null) ?>">
                        </div>
                    </div>
					<div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="descrip" class="form-control tinymce2" rows="3" type="text" placeholder="<?php echo display('description') ?> " id="descrip"><?php echo (!empty($productinfo->descrip)?$productinfo->descrip:null) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                        	<select name="unit"  class="form-control">
                                ...
                                <option value="<?php echo $unit->id?>" <?php if(!empty($productinfo)){if($productinfo->unit==$unit->id){echo "Selected";}} else{echo "Selected";} ?>><?php echo $unit->uom_name?></option>
                                <?php } ?>
                              </select>
                        </div>
                    </div>
...
<input type="hidden" name="old_image" value="<?php echo (!empty($productinfo->ProductImage)?$productinfo->ProductImage:null) ?>">
                    ...
                    <input name="vat" class="form-control" type="hidden" placeholder="0%" id="vat"  value="<?php echo (!empty($productinfo->productvat)?$productinfo->productvat:'') ?>">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                                    <div class="checkbox checkbox-success">
                                    <input type="checkbox" name="notvisible" value="1" <?php if(!empty($productinfo))if($productinfo->isfoodshowonweb==1){echo "checked";}?> id="notvisible">
                                        <label for="notvisible"></label>
                                    </div>
                        </div>
                        <label for="isingredient" class="col-sm-3 col-form-label"><?php echo display('add_as_ingredient');?></label>
                        <div class="col-sm-2">
                                    <div class="checkbox checkbox-success">
                                    <input type="checkbox" name="isingredient" value="1" <?php if(!empty($productinfo))if($productinfo->isIngredient ==1){echo "checked";}?> id="isingredient">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                             <input class="form-control" type="number" name="ordering" value="<?php echo (!empty($productinfo->itemordering)?$productinfo->itemordering:0) ?>" id="ordering">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select name="status"  class="form-control">
                                ...
                                <option value="0" <?php if(!empty($productinfo)){if($productinfo->ProductsIsActive==0){echo "Selected";}} ?>>Inactive</option>
                              </select>
                        </div>
                    </div>
                            ...
                            <tbody id="mygroupitem">
								...
								if(!empty($groupsitem)){
									...
									?>
                                        ...
                                        <td  class="itemmanage_box_w_100"><button onclick="decrese(<?php echo $i;?>,<?php echo $inteminfo->price; ?>,<?php echo $inteminfo->variantid.$inteminfo->menuid ?>)" class="reduced items-count input-text qty" type="button"><i class="fa fa-minus"></i></button><input type="text" class="itemmanage_box_w_25" name="qty[]" id="sst<?php echo $i;?>" maxlength="12" value="<?php echo (!empty($items->item_qty)?$items->item_qty:null) ?>" readonly="readonly"><button onclick="increse(<?php echo $i;?>,<?php echo $inteminfo->price; ?>,<?php echo $inteminfo->variantid.$inteminfo->menuid ?>)" class="increase items-count" type="button"><i class="fa fa-plus"></i></button></td>
