                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo  form_open('itemmanage/item_food/varientcreate','method="post" id="myfrmreset"') ?>
                                <?php echo form_hidden('variantid', (!empty($intinfo->variantid)?$intinfo->variantid:null)) ?>
                                <div class="form-group row">
                                    <label for="itemname"
                                        class="col-sm-4 col-form-label"><?php echo display('item_name')?>
                                        *
                                    </label>
                                    <div class="col-sm-8 customesl">
                                        <?php 
                                            if(empty($itemdropdown)){$itemdropdown = array('' => '--Select--');}
                                            echo form_dropdown('foodid',$itemdropdown,(!empty($intinfo->menuid)?$intinfo->menuid:null),'class="form-control" required') ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="varientname" class="form-control" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="price" class="form-control" type="text"
                                            placeholder="<?php echo display('price') ?>" id="price" value="" required><a
                                            class="cattooltips" data-toggle="tooltip" data-placement="top"
                                            title=""><?php echo $currency->curr_icon;?></i></a>
                                    </div>
                                </div>

                                <?php if(!empty($intinfo->variantid)){?>
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo display('VariantCode') ?></th>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td><?php echo $varient->VariantCode; ?></td>
                            <td><?php echo $varient->ProductName; ?></td>
                            <td><?php echo $varient->price; ?></td>
                            ...
                            <?php if (!$this->session->userdata('is_sub_branch')) {?>
                                ...
                                <td class="center">
                                    ...
                                    <a href="<?php echo base_url("itemmanage/item_food/deletevarient/$varient->variantid") ?>"
