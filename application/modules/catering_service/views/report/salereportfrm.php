<script src="<?php echo base_url('application/modules/catering_service/assets/js/salereportfrm.js'); ?>" type="text/javascript"></script>
		        ...
		        <div class="panel panel-bd lobidrag">
		            <div class="panel-heading">
		                <div class="panel-title">
		                    <h4><?php echo display('catering_sell_report') ?></h4>
		                </div>
		            </div>
		            <div class="panel-body">
		            	<div id="purchase_div">
...
<script src="<?php echo base_url('application/modules/catering_service/report/assets/js/salereportfrm_script.js'); ?>" type="text/javascript"></script>
