    ...
    <div class="page-wrapper">
        <div class="invoice-card">
            ...
            <div class="invoice-head linehight">
                ...
                <h4 style="font-size:22px;" class="linehight">
                ...
                <p class="my-0 text-center linehight">
                ...
                <div class="row-data linehight">
                    ...
                    <div class="item-info linehight">
                        ...
                        <h5 class="item-title linehight" style="font-size:18px; font-weight:bold;">
                            ...
                            <?php echo date("$posinvoiceTemplate->date_time_formate", strtotime($orderinfo->order_date));?>
                        </h5>
                        <?php } if($posinvoiceTemplate->time_show==1){?>
                        <h5 class="item-title linehight" style="font-size:16px; font-weight:bold;">
                            <?php echo display('seat_time');?>:
                            <?php echo date("h:i A", strtotime($orderinfo->order_time));?></h5>
                        <?php } ?>
                    </div>
					...
					foreach ($iteminfo as $item){
						...
						if($item->price>0){
                          if($item->is_package == 1){
							...
							$singleprice=$item->price*$packqty;
                           }else{
					...
					?>
                        <div class="row-data linehight">
                            ...
                            <div class="text-right linehight">
                                <?php  if( $item->is_package ==1){?>
                                <p class="item-number linehight">
                                    <?php //echo numbershow($singleprice,$settinginfo->showdecimal);?>
                        ...
                        <div class="row-data linehight">
                            <div class="item-info linehight">
                                ...
                                <p class="item-number linehight">
                                    <?php //echo numbershow($info->price,$settinginfo->showdecimal);?> x
                                    <?php echo $info->menuqty;?></p>
                                <!-- <p class="item-number linehight">(<?php //echo $info->variantName;?>)</p> -->
                            </div>
                            <h5 class="linehight"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                                0.00<?php //echo numbershow($info->price*$info->qroupqty[$s],$settinginfo->showdecimal);?>
                                <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                        </div>
                        <?php } }?>
                        <?php 
			...
			if(!empty($item->tpid)){
					 ...
					 foreach($topping as $toppingid){
                        ...
                        <div class="row-data linehight">
                            <div class="item-info linehight">
                                <h5 class="item-title linehight">-<?php echo $tpinfo->add_on_name;?></h5>
                                <p class="item-number linehight"><?php //echo $toppingprice[$tp];?></p>
                            </div>
                            <h5 class="linehight"><?php if($currency->position==1){echo $currency->curr_icon;}?>
            ...
            foreach($openiteminfo as $openfood){
                ...
                ?>
                        <div class="row-data linehight">
                            <div class="item-info linehight">
                                <h5 class="item-title linehight"><?php echo $openfood->foodname;?></h5>
                                <p class="item-size linehight">Regular</p>

                            </div>
                            <div class="text-right linehight">
                                <p class="item-number linehight"><?php echo $openprice;?> x <?php echo $openqty;?></p>
                                <h5 class="my-0 linehight">
                                    <?php if($currency->position==1){echo $currency->curr_icon;}?>
            ...
            <div class="invoice-footer mb-15 linehight">
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight">
                            <?php echo (!empty($posinvoiceTemplate->subtotal_level)?$posinvoiceTemplate->subtotal_level:display('subtotal'));?>
                        </h5>
                    </div>
                    <h5 class="my-0 linehight">
                        <?php if($currency->position==1){echo $currency->curr_icon;}?>
                ...
                <div class="row-data linehight">
                    ...
                    <h5 class="my-0 linehight"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php echo numbershow($billinfo->allitemdiscount,$settinginfo->showdecimal);?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                ...
                <div class="row-data linehight">
                    ...
                    <h5 class="my-0 linehight">
                        <?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php $sdcharge=0; if(empty($billinfo)){ echo numbershow($sdcharge,$settinginfo->showdecimal);} else{echo $sdcharge=numbershow($billinfo->service_charge,$settinginfo->showdecimal);} ?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?>
                    </h5>
                </div>
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight">
                            <?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?>
              ...
              if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php if(empty($billinfo)){ echo numbershow($discount,$settinginfo->showdecimal);} else{echo numbershow($discount,$settinginfo->showdecimal);} ?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?>
                    </h5>
                </div>
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight">Adjustment
                            (#<?php echo getPrefixSetting()->sales. '-'.$billinfo->return_order_id;?>)</h5>
                    </div>
                    <h5 class="my-0 linehight">
                        <?php if($currency->position==1){echo $currency->curr_icon;}?>
            ...
            ?>
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight">
                            <?php echo (!empty($posinvoiceTemplate->vat_level)?$posinvoiceTemplate->vat_level:display('vat_tax'));?>(<?php echo $storeinfo->vat;?>%)
                        </h5>
                    </div>
                    <h5 class="my-0 linehight">
                        <?php if($currency->position==1){echo $currency->curr_icon;}?>
			...
			?>
                ...
                <div class="row-data border-top linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title text-bold linehight">
			...
			if($orderinfo->customerpaid>0){
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        ...
                        <h5 class="item-title linehight"><?php echo display('customer_due_amount'); ?></h5>
                        <?php }else{ ?>
                        <h5 class="item-title linehight">
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight">
                            <?php echo (!empty($posinvoiceTemplate->total_due)?$posinvoiceTemplate->total_due:display('total_due'));?>
                        </h5>
                    </div>
                    <h5 class="my-0 linehight">
                        <?php if($currency->position==1){echo $currency->curr_icon;}?>
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight"><?php echo $pmethod->payment_method;?> </h5>
                    </div>
                    <h5 class="my-0 linehight"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php echo numbershow($pmethod->paidamount,$settinginfo->showdecimal); ?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                ...
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title"><?php echo "Due";?> </h5>
                    </div>
                    <h5 class="my-0"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                        <?php echo numbershow($pmethod->paidamount,$settinginfo->showdecimal); ?>
                        <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <?php }
            ...
            <div class="invoice_address linehight">
                ...
                <div class="middle-data linehight">
                    ...
                    <div class="item-info gap_right linehight">
                        ...
                        <h5 class="item-title linehight">
                            ...
                            <?php echo $tableinfo->tablename;?></h5>
                        <?php } ?>
                    </div>
                    ...
                    <div class="item-info linehight">
                        <h5 class="item-title linehight">
                            ...
                            <?php echo getPrefixSetting()->sales. '-'.$orderinfo->order_id;?></h5>
                    </div>
                    <?php } ?>
                </div>
                <?php } 
                ...
                <div class="middle-data linehight">
                    <div class="text-center linehight">
                        <h5 class="item-title linehight" style="font-size:18px; font-weight:bold;">
                            <?php echo (!empty($posinvoiceTemplate->payment_status)?$posinvoiceTemplate->payment_status:display('payment_status'));?>:
                            <?php 
                    // dd($billinfo);
                   if($orderinfo->is_duepayment==1){
                         echo "Due";
