                                            ...
                                            <tr>
                                                ...
                                                <td class="fs-14 text-right fw-600">
                                                    ...
                                                    <!-- <?php //echo number_format($calvat, 3); 
                                                            ?> -->
                                                    <span id="vat"></span>
                                                    <input type="hidden" name="taxc" id="taxc">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="fs-14 fw-600 text-dark"><?php echo $mvat['tax_name']; ?> @
                                                            ...
                                                            <input type="hidden" id="vatax" value="<?php echo $mvat['default_value']; ?>">
                                                        </td>
                                                        ...
                                                        <td class="fs-14 text-right fw-600">
                                                            ...
                                                            <?php //echo number_format($totaltaxinfo->taxtotal, 3); 
                                                            ?>
                                                            <span id="vat"></span>
                                                            <input type="hidden" name="taxc" id="taxc">
        ...
        <div class="tab-wrapper">
            <div class="content-wrap">
                ...
                <div class="tab-content">
                    ...
                    <input type="hidden" name="granddiscount" id="granddiscount">
...
<span class="display-none" id="due-amount"><?php echo number_format($billinfo->bill_amount - $disamount, 3, '.', ''); ?></span>
...
<script src="<?php echo base_url('application/modules/catering_service/assets/js/catering-paymodal.js'); 
