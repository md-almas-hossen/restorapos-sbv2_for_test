    ...
    <div class="invoice-card">
        <?php if ($posinvoiceTemplate->invoice_logo_show == 1 || $posinvoiceTemplate->company_name_show == 1 || $posinvoiceTemplate->company_address == 1) { ?>
            <div class="invoice-head linehight">
                <?php if ($posinvoiceTemplate->invoice_logo_show == 1) { ?>
                    <img src="<?php echo base_url(); ?><?php echo (!empty($posinvoiceTemplate->logo) ? $posinvoiceTemplate->logo : $storeinfo->logo) ?>" style="margin-top: 10px;" alt="">
                <?php }
                if ($posinvoiceTemplate->company_name_show == 1) { ?>
                    <h4 style="font-size:22px;" class="linehight"><?php echo (!empty($posinvoiceTemplate->store_name) ? $posinvoiceTemplate->store_name : $storeinfo->title) ?></h4>
                <?php }
                if ($posinvoiceTemplate->company_address == 1) { ?>
                    <p class="my-0 linehight"><?php echo $storeinfo->address; ?></p>
                <?php }
                if ($posinvoiceTemplate->mobile_num == 1) { ?>
                    <p class="my-0 text-center linehight"><strong>Mobile: <?php echo $storeinfo->phone; ?></strong></p>
                <?php }
                if ($posinvoiceTemplate->website == 1) { ?>
                    <p class="my-0 text-center linehight"><strong><?php echo (!empty($posinvoiceTemplate->websitetext) ? $posinvoiceTemplate->websitetext : 'Website:' . base_url()) ?></strong></p>
                <?php }
                if ($posinvoiceTemplate->mushak == 1) { ?>
                    <p class="my-0 text-center linehight"><strong>Mushak-6.3</strong></p>
                <?php } ?>
            </div>
        <?php } ?>
            ...
            <div class="row-data linehight">
                ...
                <div class="item-info linehight">
                    <?php if ($posinvoiceTemplate->date_show == 1) { ?>
                        <h5 class="item-title linehight" style="font-size:18px; font-weight:bold;"><?php echo (!empty($posinvoiceTemplate->date_level) ? $posinvoiceTemplate->date_level : display('date')); ?>: <?php echo date("$posinvoiceTemplate->date_time_formate", strtotime($orderinfo->order_date)); ?></h5>
                    <?php }
                    if ($posinvoiceTemplate->time_show == 1) { ?>
                        <h5 class="item-title linehight" style="font-size:16px; font-weight:bold;"><?php echo display('seat_time'); ?>: <?php echo date("h:i A", strtotime($orderinfo->order_time)); ?></h5>
                    <?php } ?>
                </div>
                <?php if ($posinvoiceTemplate->bin_pos_show == 1) {
                    if ($storeinfo->isvatnumshow == 1) { ?>
                        <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->bin_level) ? $posinvoiceTemplate->bin_level : display('tinvat')); ?>: <?php echo $storeinfo->vattinno; ?></h5>
                <?php }
                } ?>
            </div>
        </div>
        ...
        <div class="invoice-details linehight">
            <div class="invoice-list linehight">
                <div class="invoice-title linehight">
                    <h4 class="heading linehight"><?php echo display('item') ?></h4>
                    <h4 class="heading heading-child linehight"><?php echo display('total') ?></h4>
                </div>

                <div class="invoice-data">
                    <?php $this->load->model('catering_service/catering_model',    'catering_model');
                    $i = 0;
                    $totalamount = 0;
                    $subtotal = 0;
                    ...
                    foreach ($iteminfo as $item) {
                        ...
                        $itemdetails = $this->catering_model->getiteminfo($item->menu_id);
                    ...
                    ?>
                        <div class="row-data linehight">
                            <div class="item-info linehight">
                                <?php if ($item->is_package == 1) { ?>
                                    <h5 class="item-title linehight"><?php echo $item->package_name; ?></h5>
                                <?php } else { ?>
                                    <h5 class="item-title linehight"><?php echo $item->ProductName; ?></h5>
                                    <p class="item-size linehight"><?php echo $item->variantName; ?></p>
                                <?php } ?>

                            </div>
                            <div class="text-right linehight">
                                <?php if ($item->is_package == 1) { ?>
                                    <p class="item-number linehight"><?php //echo numbershow($singleprice,$settinginfo->showdecimal);
                                                                        ?> <!--x--> <?php //echo quantityshow($item->menuqty,$item->is_customqty);
                                                                                                                                                    ?></p>
                                    <h5 class="my-0 linehight"><?php if ($currency->position == 1) {
                                                                    echo $currency->curr_icon;
                                                                } ?> <?php echo numbershow($itemprice, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                    echo $currency->curr_icon;
                                                                                                                                                                                                } ?></h5>
                                <?php } else { ?>
                                    <p class="item-number linehight"><?php echo numbershow($singleprice, $settinginfo->showdecimal); ?> x <?php echo quantityshow($item->menuqty, $item->is_customqty); ?></p>
                                    <h5 class="my-0 linehight"><?php if ($currency->position == 1) {
                                                                    echo $currency->curr_icon;
                                                                } ?> <?php echo numbershow($itemprice, $settinginfo->showdecimal); ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                    echo $currency->curr_icon;
                        ...
                        ?>
                                <div class="row-data linehight">
                                    <div class="item-info linehight">
                                        <h5 class="item-title linehight">-<?php echo $info->ProductName; ?></h5>
                                        <p class="item-number linehight"><?php //echo numbershow($info->price,$settinginfo->showdecimal);
                                                                            ?> x <?php echo $info->menuqty; ?></p>
                                        <!-- <p class="item-number linehight">(<?php echo $info->variantName; ?>)</p> -->
                                    </div>
                                    <h5 class="linehight"><?php if ($currency->position == 1) {
                                                                echo $currency->curr_icon;
                                                            } ?> 0.00<?php //echo numbershow($info->price*$info->qroupqty[$y],$settinginfo->showdecimal);
                        ...
                        if (!empty($item->add_on_id)) {
                            ...
                            foreach ($addons as $addonsid) {
                                ...
                                <div class="row-data linehight">
                                    <div class="item-info linehight">
                                        <h5 class="item-title linehight">-<?php echo $adonsinfo->add_on_name; ?></h5>
                                        <p class="item-number linehight"><?php echo numbershow($adonsinfo->price, $settinginfo->showdecimal); ?> x <?php echo $addonsqty[$y]; ?></p>
                                    </div>
                                    <h5 class="linehight"><?php if ($currency->position == 1) {
                                                                echo $currency->curr_icon;
                        ...
                        if (!empty($item->tpid)) {
                            ...
                            ?>
                                <div class="row-data">
                                    <div class="item-info">
                                        <h5 class="item-title">-<?php echo $tpinfo->add_on_name; ?></h5>
                                        <p class="item-number"><?php //echo $toppingprice[$tp];
                                                                ?></p>
                                    </div>
        ...
        <div class="invoice-footer mb-15 linehight">
            <?php if ($posinvoiceTemplate->subtotal_level_show == 1) { ?>
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->subtotal_level) ? $posinvoiceTemplate->subtotal_level : display('subtotal')); ?></h5>
                    </div>
            ...
            <div class="row-data linehight">
                <div class="item-info linehight">
                    <h5 class="item-title linehight"><?php echo "Items Discount"; ?></h5>
                </div>
                <h5 class="my-0 linehight"><?php if ($currency->position == 1) {
                                                echo $currency->curr_icon;
            ...
            <?php if ($posinvoiceTemplate->servicechargeshow == 1) { ?>
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->service_charge) ? $posinvoiceTemplate->service_charge : display('service_chrg')); ?></h5>
                    </div>
                    <h5 class="my-0 linehight">
                        <?php if ($currency->position == 1) {
                            echo $currency->curr_icon;
            ...
            if ($posinvoiceTemplate->discountshow == 1) { ?>
                ...
                <div class="row-data linehight">
                    <div class="item-info linehight">
                    <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->discount_level)?$posinvoiceTemplate->discount_level:display('discount'));?>
              
              <?php $discountpercent=($discount*100)/($billinfo->total_amount+$billinfo->service_charge+$billinfo->VAT)?>
              
              (<?php echo number_format($discountpercent,3)?>%)</h5>
            ...
            <?php if ($billinfo->return_order_id) { ?>
                <div class="row-data linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title linehight">Adjustment (#<?php echo getPrefixSetting()->sales . '-' . $billinfo->return_order_id; ?>)</h5>
                    </div>
                    <h5 class="my-0 linehight">
                        <?php if ($currency->position == 1) {
                            echo $currency->curr_icon;
            ...
            <?php if ($posinvoiceTemplate->vatshow == 1) {
                if (empty($taxinfos)) { ?>
                    <div class="row-data linehight">
                        <div class="item-info linehight">
                            <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->vat_level) ? $posinvoiceTemplate->vat_level : display('vat_tax')); ?>(<?php echo $storeinfo->vat; ?>%)</h5>
                        </div>
                        <h5 class="my-0 linehight">
                            <?php if ($currency->position == 1) {
                                echo $currency->curr_icon;
                    ...
                    ?>
                            <div class="row-data linehight">
                                <div class="item-info linehight">
                                    <h5 class="item-title linehight"><?php echo $mvat['tax_name']; ?></h5>
                                </div>
                                <h5 class="my-0 linehight">
                                    <?php if ($currency->position == 1) {
                                        echo $currency->curr_icon;
            ...
            <div class="row-data linehight">
                <div class="item-info linehight">
                        <h5 class="item-title linehight">Service Charge</h5>
                </div>
                <h5 class="my-0 linehight">
                    <?php if($currency->position==1){echo $currency->curr_icon;}?>
                    <?php echo $billinfo->service_charge;?>
            ...
            <?php if ($posinvoiceTemplate->grandtotalshow == 1) { ?>
                <div class="row-data border-top linehight">
                    <div class="item-info linehight">
                        <h5 class="item-title text-bold linehight"><?php echo (!empty($posinvoiceTemplate->grand_total) ? $posinvoiceTemplate->grand_total : display('grand_total')); ?></h5>
                    </div>
                    <h5 class="my-0 linehight">
                        <?php if ($currency->position == 1) {
                            echo $currency->curr_icon;
                        } ?>
                        <?php echo numbershow($billinfo->bill_amount - ($billinfo->discount), $settinginfo->showdecimal); ?>
                        <?php if ($currency->position == 2) {
                            echo $currency->curr_icon;
                        } ?>
                    </h5>
            ...
            <?php } elseif ($billinfo->bill_status == 2) { ?>
                ...
                <?php if ($posinvoiceTemplate->customer_paid_show == 1) { ?>
                    ...
                    <div class="row-data linehight">
                        <div class="item-info linehight">
                            <h5 class="item-title linehight"><?php echo display('total_due'); ?></h5>
                        </div>
                        ...
                        <h5 class="my-0 linehight">
                            ...
                            <?php echo numbershow($orderinfo->totalamount - $orderinfo->customerpaid, $settinginfo->showdecimal); ?>
                            <?php if ($currency->position == 2) {
                                echo $currency->curr_icon;
                            } ?>
                        </h5>
                ...
                ?>
                    <div class="row-data linehight">
                        <div class="item-info linehight">
                            <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->total_due) ? $posinvoiceTemplate->total_due : display('total_due')); ?></h5>
                        </div>
                        <h5 class="my-0 linehight">
                            <?php if ($currency->position == 1) {
                                echo $currency->curr_icon;
            ...
            <?php $paymentsmethod = $this->catering_model->allpayments($orderinfo->order_id);
            $alltype = "";
            $totalpaid = 0;
            ...
            foreach ($paymentsmethod as $pmethod) {
                ...
                if ($pmethod->payment_type_id == 1) {
                    $allcardp = $this->catering_model->allcardpayments($pmethod->bill_id, $pmethod->payment_type_id);
                    ...
                    <div class="row-data linehight">
                        <div class="item-info linehight">
                            <h5 class="item-title linehight"><?php
                                                                if ($orderinfo->is_duepayment == 1) {
                                                                    echo "Due";
                                                                } else {
                ...
                <?php } else if ($pmethod->payment_type_id == 14) {
                    $allmobilep = $this->catering_model->allmpayments($pmethod->bill_id, $pmethod->payment_type_id);
            ...
            ?>
                    <div class="row-data linehight">
                        <div class="item-info linehight">
                            <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->change_due_level) ? $posinvoiceTemplate->change_due_level : display('change_due')); ?></h5>
                        </div>
                        <h5 class="my-0 linehight"><?php if ($currency->position == 1) {
                                                        echo $currency->curr_icon;
                                                    } ?> <?php if ($totalpaid > $billinfo->bill_amount) {
                                                                                                                        echo numbershow($totalpaid - $billinfo->bill_amount, $settinginfo->showdecimal);
                                                                                                                    } else {
                                                                                                                        echo "0.00";
                                                                                                                    } ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                                                                                                        echo $currency->curr_icon;
            ...
            if ($billinfo->bill_status == 1) {
                ...
                ?>
                    <div class="row-data linehight">
                        <div class="item-info linehight">
                            <h5 class="item-title linehight"><?php echo display('totalpayment') ?></h5>
                        </div>
                        <h5 class="my-0 linehight"> <?php if ($billinfo->bill_status == 1) {
                                                        if ($currency->position == 1) {
                                                            echo $currency->curr_icon;
                                                        }
        ...
        <div class="invoice_address linehight">
            <?php if ($posinvoiceTemplate->billing_to_show == 1 || $posinvoiceTemplate->bill_by_show == 1) { ?>
                <div class="row-data linehight">
                    <?php if ($posinvoiceTemplate->billing_to_show == 1) { ?>
                        <div class="item-info linehight">
                            <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->billing_to) ? $posinvoiceTemplate->billing_to : display('billing_to')); ?>: <?php echo $customerinfo->customer_name; ?></h5>
                        </div>
                    <?php }
                    if ($posinvoiceTemplate->bill_by_show == 1) { ?>
                        <h5 class="my-0 linehight"><?php echo (!empty($posinvoiceTemplate->bill_by) ? $posinvoiceTemplate->bill_by : display('bill_by')); ?>: <?php echo $cashierinfo->firstname . ' ' . $cashierinfo->lastname; ?></h5><?php } ?>
                </div>
            <?php }
                ...
                <div class="middle-data linehight">
                    <?php if ($posinvoiceTemplate->table_level_show == 1) { ?>
                        <div class="item-info gap_right linehight">
                            ...
                            ?>
                                <h5 class="item-title linehight">Third Party(<?php echo $thirdpartyinfo->company_name; ?>)</h5>
                            <?php } else { ?>
                                <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->table_level) ? $posinvoiceTemplate->table_level : display('table')); ?>: <?php echo $tableinfo->tablename; ?></h5>
                            <?php } ?>
                        </div>
                    <?php }
                    if ($posinvoiceTemplate->order_no_show == 1) { ?>
                        <div class="item-info linehight">
                            <h5 class="item-title linehight"><?php echo (!empty($posinvoiceTemplate->order_no) ? $posinvoiceTemplate->order_no : display('orderno')); ?>: <?php echo getPrefixSetting()->sales . '-' . $orderinfo->order_id; ?></h5>
                        </div>
                    <?php } ?>
                </div>
            <?php }
            ...
            ?>
                <div class="middle-data linehight">
                    <div class="text-center linehight">
                        <h5 class="item-title linehight" style="font-size:18px; font-weight:bold;"><?php echo (!empty($posinvoiceTemplate->payment_status) ? $posinvoiceTemplate->payment_status : display('payment_status')); ?>:
                            <?php
                            if ($orderinfo->is_duepayment == 1) {
                                echo "Due";
                            } else {
            ...
            <?php if ($posinvoiceTemplate->waitershow == 1) { ?>
                <!--  <div class="middle-data linehight">
                  <div class="text-center linehight">
                    <h5 class="item-title linehight" style="font-size:18px; font-weight:bold;">
            ...
            if ($posinvoiceTemplate->footertextshow == '1') { ?>
                <div class="text-center linehight">
                    ...
                    ?>
                    <h3 class="my-0 linehight"><?php echo (!empty($posinvoiceTemplate->footer_text) ? $posinvoiceTemplate->footer_text : display('thanks_you')); ?></h3>
                <?php }
            if ($gloinvsetting->invpower == 1) { ?>
                    <p class="b_top linehight"><!--Powered  By: RESTORAPOS, www.restorapos.com--><?php echo display('powerbybdtask') ?></p>
                <?php } ?>
                </div>
                <?php //}
