        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    <?php echo form_open_multipart('loyalty/loyalty/createreview') ?>
                ...
                <input name="title" class="form-control" type="text" placeholder="<?php echo display('title') ?>" id="title" value="<?php echo (!empty($intinfo->title)?$intinfo->title:null) ?>" required>
                        ...
                        <div class="col-sm-8">
                            <input name="rating" min="0" class="form-control" type="number"  placeholder="<?php echo  display('rating'); ?>" id="offerstartdate"  value="<?php echo (!empty($intinfo->rating)?$intinfo->rating:null) ?>" required>
                        </div>
                    </div>
