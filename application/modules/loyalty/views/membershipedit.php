                    ...
                    <?php echo form_hidden('id', (!empty($intinfo->id)?$intinfo->id:null)) ?>
                        ...
                        <div class="form-group row">
  						...
  						<div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                 <input name="startpoint" class="form-control" type="text" placeholder="<?php echo display('startamount');?>" id="startpoint" value="<?php echo (!empty($intinfo->startpoint)?$intinfo->startpoint:null) ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="endpoint" class="col-sm-4 col-form-label"><?php echo display('endamount');?></label>
                            <div class="col-sm-8">
                                 <input name="endpoint" class="form-control" type="text" placeholder="<?php echo display('endamount');?>" id="endpoint" value="<?php echo (!empty($intinfo->endpoint)?$intinfo->endpoint:null) ?>">
                            </div>
                        </div>
