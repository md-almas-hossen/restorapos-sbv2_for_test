        ...
        <div class="panel panel-bd">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4><?php echo display('set_productioncost') ?></h4>
                </div>
            </div>
            <!--  -->
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered table-hover" id="purchaseTable">
                    ...
                    <tbody id="addPurchaseItem">
                        <tr>
                            ...
                            <td class="text-right">
                                <input type="text" name="product_quantity[]" id="cartoon_1" onkeyup='calprice(this)'
                                    class="form-control text-right store_cal_1" placeholder="0.00" value="" min="0"
                                    tabindex="6">
                            </td>
                            <td class="text-right">
                                <input type="text" id="price_1" class="form-control indprice text-right store_cal_1"
                                    placeholder="0.00" value="" min="0" tabindex="6" readonly>
                            </td>
                            <td>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <input name="receipePrice" type="hidden" value="" id="receipePrice" />
