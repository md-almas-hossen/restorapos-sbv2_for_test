<div class="form-group text-right">
    ...
    <a class="btn btn-success btn-md" href="<?php echo base_url("reservation/reservation/tablebooking") ?>"><i
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="customer_name"
                                        class="col-sm-4 col-form-label"><?php echo "Customer Name"; ?>*</label>
                                ...
                                <div class="form-group row">
                                    <label for="tableid"
                                        class="col-sm-4 col-form-label"><?php echo "Table No."; ?>*</label>
                                    <div class="col-sm-8 customesl">
                                ...
                                <div class="form-group row">
                                    <label for="tablicapacity"
                                        class="col-sm-4 col-form-label"><?php echo "No. of People"; ?>*</label>
                                    <div class="col-sm-8 customesl">
                                ...
                                <div class="form-group row">
                                    <label for="bookfromtime"
                                        class="col-sm-4 col-form-label"><?php echo display('s_time') ?> *</label>
                                    <div class="col-sm-8">
                                        <input name="bookfromtime" class="form-control timepicker" type="text"
                                            placeholder="<?php echo display('s_time') ?>" id="booktime" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="bookendtime"
                                        class="col-sm-4 col-form-label"><?php echo display('e_time') ?> *</label>
                                    <div class="col-sm-8">
                                        <input name="bookendtime" class="form-control timepicker" type="text"
                                            placeholder="<?php echo display('e_time') ?>" id="booktime" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="bookdate" class="col-sm-4 col-form-label"><?php echo display('date') ?>
                                        *</label>
                                    <div class="col-sm-8">
                                        <input name="bookdate" class="form-control datepicker" type="text"
                                            placeholder="<?php echo display('date') ?>" id="bookdate" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                ...
                <table width="100%" class="datatable2 table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo display('no_of_persone'); ?></th>
                            <th><?php echo display('s_time'); ?></th>
                            <th><?php echo display('e_time'); ?></th>
                            <th><?php echo display('date'); ?></th>
                            <th><?php echo display('foods_prereference');?></th>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td><?php echo $reserve->foods_prereference; ?></td>
                            <td><?php if($reserve->status==1){echo "Free";} if($reserve->status==2){echo "Booked";} ?>
                            </td>
                            <td class="center">
                                <?php if($this->permission->method('reservation','update')->access()): ?>
                                <input name="url" type="hidden" id="url_<?php echo $reserve->reserveid; ?>"
                                    value="<?php echo base_url("reservation/reservation/updateintfrm") ?>" />
                                <a onclick="editreserveinfo('<?php echo $reserve->reserveid; ?>')"
                                ...
                                <a href="<?php echo base_url("reservation/reservation/delete/$reserve->reserveid") ?>"
