                ...
                <div class="panel-body">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <input name="tablicapacity" class="form-control" type="hidden" id="tablicapacity" value="<?php echo $intinfo->person_capicity;?>" required="">
                        </div>
                    </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input name="bookdate" class="form-control" type="hidden" id="bookdate" value="<?php echo (!empty($intinfo->reserveday)?$intinfo->reserveday:null) ?>" required="">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                             <?php echo $intinfo->formtime;?>
                                <input name="bookfromtime" class="form-control" type="hidden" id="booktime" value="<?php echo (!empty($intinfo->formtime)?$intinfo->formtime:null) ?>" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="bookendtime" class="form-control timepicker" type="text" placeholder="<?php echo display('e_time') ?>" id="booktime" value="<?php echo (!empty($intinfo->totime)?$intinfo->totime:null) ?>" required="">
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <!-- <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                        <input name="notes" class="form-control" type="text" id="notes" value="<?php echo (!empty($intinfo->customer_notes)?$intinfo->customer_notes:null) ?>" placeholder="Customer Notes" required="">
                        </div>
                    </div> -->
						<div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="foods_prereference"><?php echo (!empty($intinfo->foods_prereference)?$intinfo->foods_prereference:null) ?></textarea>
                            </div>
                        </div>
