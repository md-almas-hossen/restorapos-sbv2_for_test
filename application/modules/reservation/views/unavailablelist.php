                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="unavaildate"
                                        class="col-sm-4 col-form-label"><?php echo display('unavaildate')?>*</label>
                                    <div class="col-sm-8">
                                        <input name="unavaildate" class="form-control datepicker5" type="text"
                                            placeholder="<?php echo display('unavaildate')?>" id="unavaildate"
                                            autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="fromtime"
                                        class="col-sm-4 col-form-label"><?php echo display('s_time') ?> *<a
                                            class="cattooltips" data-toggle="tooltip" data-placement="top"
                                            title="Use Time Like:2:00,10:00"><i class="fa fa-question-circle"
                                                aria-hidden="true"></i></a></label>
                                    <div class="col-sm-3 unavailableedit-form">
                                        <input name="fromtime" class="form-control timepicker" type="text"
                                            placeholder="<?php echo display('s_time') ?>" id="formtime"
                                            autocomplete="off">
                                    </div>
                                    <label for="totime" class="col-sm-2 col-form-label"><?php echo display('e_time') ?>
                                    </label>
                                    <div class="col-sm-3">
                                        <input name="totime" class="form-control timepicker" type="text"
                                            placeholder="<?php echo display('e_time') ?>" id="totime"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td class="center">
                                ...
                                <input name="url" type="hidden" id="url_<?php echo $unavail->offdayid; ?>"
                                    value="<?php echo base_url("reservation/reservation/updateunavailfrm") ?>" />
                                <a onclick="edituninfo('<?php echo $unavail->offdayid; ?>')" class="btn btn-info btn-sm"
                                ...
                                <a href="<?php echo base_url("reservation/reservation/deleteunavailable/$unavail->offdayid") ?>"
