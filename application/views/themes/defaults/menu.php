                ...
                <div id="loaditem">
                    ...
                    ?>
                            <div class="single_item row mb-3">
                                <div class="item_img col-sm-3 badgeoffer">
                                	<?php if ($menuitem->OffersRate > 0) { ?>
                                    <span class="top_side">-<?php echo $menuitem->OffersRate; ?>%</span>
                                <?php } ?>
                    ...
                    ?>
                        ...
                        if (empty($taxinfos)) {
                            if ($this->settinginfo->vat > 0) {
                                ...
                                $tvatcalc = Vatclaculation($itemtotal,$this->settinginfo->vat);
                            } else {
                                $calvat = $pvat;
                            }
                        } else {
                            ...
                            <table class="table total-cost">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if ($this->storecurrency->position == 1) {
                                                echo $this->storecurrency->curr_icon;
                                            } ?><?php echo numbershow($calvat, $settinginfo->showdecimal); ?><?php if ($this->storecurrency->position == 2) { echo $this->storecurrency->curr_icon; } ?></td>
                                    </tr>
                                    <tr>
