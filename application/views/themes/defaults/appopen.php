...
<body>
  ...
  <div class="content-wrap" style="height: 100vh;">
    ...
    <div class="p-3 gap-3" style="display: flex;justify-content: center;align-content: center;height: 100%;flex-wrap: wrap">
    	<div style="display: block;width: 100%;text-align: center;"><a href="<?php echo base_url()?>qr-menu" style="min-width:130px;" class="btn btn-success align-items-center justify-content-center" >Go To Menu</a></div>
        <div style="display: block;width: 100%;text-align: center;"><a style="min-width:130px;" href="<?php echo base_url()?>google-review" class="align-items-center btn btn-outline-success justify-content-center" >Google Review</a></div>
