                  ...
                  <?php echo form_open('#','method="post" class="main-reservaton-form"')?>
                     <div class="row">
                         <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                             ...
                             <input type="number" name="reservation_person" id="reservation_person" onKeyup="maxperson()" placeholder="<?php echo display('reservation_person')?>">
                         </div>
                         <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                         ...
                         <div class="col-lg-3 col-md-6">
                             ...
                             <button type="button" class="simple_btn" onclick="editreserveinfo()"><?php echo display('check_availablity') ?></button>
                         </div>
                     </div>
                 </form>
             </div>
