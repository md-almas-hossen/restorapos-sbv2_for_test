            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="bg-light border cart-totals p-4">
                        ...
                        <div class="cart-totals-border my-4">
                            <div class="totals-item">
                                ...
                                <div class="totals-value" id="cart-subtotal"><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><span id="subtotal"><?php echo $itemtotal+$discount;?></span><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></div>
                            </div>
                            <div class="totals-item">
                                <label>Vat </label>
                                <div class="totals-value" id="cart-tax"><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><span id="vat"><?php echo numbershow($calvat, $settinginfo->showdecimal);?></span><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></div>
                            </div>
					...
					if(!empty($isvatinclusive)){
						echo $itemtotal-$coupon;
					}else{
						echo ($calvat+$itemtotal)-$coupon;
					}
