...
<div class="modal fade" id="checkotp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content otpinfo">
             <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabel"><?php echo "Verify Number"; ?></h5>
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                 </button>
             </div>
             <div class="modal-body">
					<div class="item-add-ons row">
                    	 <div class="col-sm-8">
                                <div class="form-group">
                                	<input name="cususer" type="hidden" id="cususer" value="" />
                    				<input name="screctkey" type="hidden" id="screctkey" value="" />
                                    <label class="control-label" for="user_emails">Please Enter Your OTP</label>
                         ...
                         <div class="col-sm-4">
                         	 <div class="form-group">
                         		...
                         		<button type="button" class="btn btn-success btn-sm" onclick="verifyotp()"><?php echo display('submit')?></button>
                                </div>
                         </div>
           ...
           <div class="row">
                ...
                <?php if ($this->session->flashdata('message')) { ?>
                    ...
                    <?php } ?>
                                    ...
                                    <div class="rrtt">
                                      <?php echo form_open_multipart('','class="row"') ?>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="countryCode" class="form-label"><?php echo "Country Code"; ?></label>
                                                    <select name="countryCode" class="form-control select2" id="countrycode" required>
                                    ...
                                    <option <?php if($webinfo->country=="ZW"){ echo "selected";}?> data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                        ...
                                        <div class="col-sm-12">
                                            <input type="button" onclick="signupcustomer()" class="btn btn-success btn-sm search" value="Reginter Now">&nbsp; OR &nbsp;<a href="<?php echo base_url().'mylogin'?>" class="btn btn-success btn-sm search">Login</a>
                                        </div>
                                        <?php echo form_close() ?>
