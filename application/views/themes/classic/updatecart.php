...
<body class="<?php echo $qrtheme->theme;?>1">
  ...
  <div class="content-wrap">
    ...
    <div class="p-3" id="mycartlist">
    	...
    	<h6 class="fw-semibold mb-3"><?php echo display('upsumlist') ?></h6>
      <!-- Start Item -->
...
<button class="cart-total d-flex align-items-center justify-content-between bg-primary text-white position-fixed rounded-3 border-0 updatecart_border_none"  type="submit">
    <div class="">
