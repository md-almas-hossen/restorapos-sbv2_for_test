                            ...
                            <div class="clearfix">
                                <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                    <li data-thumb="<?php echo base_url(!empty($iteminfo->bigthumb) ? $iteminfo->bigthumb : 'dummyimage/555x370.jpg'); ?>">
                                        <?php if ($iteminfo->OffersRate > 0) { ?>
                                         		<div class="classic-offer">
                        							<div class="classic-offer-number"><?php echo $iteminfo->OffersRate; ?>% Off</div>
                    						 	</div>
                                                <?php } ?>
                ...
                <div class="col-md-6">
                    <div class="product-summary-content">
                        ...
                        <div class="mt-3 action_btn">
                            ...
                            $this->db->where('menuid', $iteminfo->ProductsID);
                            $tpquery = $this->db->get();
            ...
            <div class="row offer_inner">
                <div class="offer_slider owl-carousel">
                    ...
                    foreach ($related as $relateditem) {
						...
						$this->db->from('tbl_menutoping');
                        $this->db->where('menuid', $relateditem->ProductsID);
                        $tpquery = $this->db->get();
