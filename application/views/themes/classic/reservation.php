                    ...
                    <?php echo form_open('#','method="post" class="main-reservaton-form"')?>
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <input type="text" name="reservation_person" id="reservation_person" onKeyup="maxperson()" placeholder="<?php echo display('reservation_person')?>" autocomplete="off">
                            </div>
                            <div class="col-lg-12 mb-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <button type="button" class="simple_btn" onclick="editreserveinfo()"><?php echo display('book_table')?></button>
                            </div>
                        </div>
                    </form>
                </div>
