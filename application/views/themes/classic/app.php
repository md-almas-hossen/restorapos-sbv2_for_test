  ...
  <div class="content-wrap">
    ...
    <div class="header-item">
      <div class="py-3 ps-3">
        ...
        <div class="d-flex flex-nowrap slide-content" role="tablist">
          ...
          ?>
            <div class="slide-item text-center me-2 <?php if ($c == 1) {
                                                      echo "active";
                                                    } ?>" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home<?php echo $phcategoryname . $c; ?>" type="button" role="tab" aria-controls="nav-home" aria-selected="true">
              <img src="<?php echo base_url(!empty($category->CategoryImage) ? $category->CategoryImage : 'assets/img/no-image.png'); ?>" alt="" class="rounded-4">
    ...
    <div class="p-3">
      ...
      <div class="tab-content" id="searchqritem">
        ...
        ?>
          <div class="tab-pane fade show <?php if ($op == 1) {
                                            echo "active";
                                          } ?>" id="nav-home<?php echo $hcategoryname . $op; ?>" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
            <!-- Start Items Title -->
                      ...
                      <?php if ($restaurantisopen == 1) {
                        if ($getadons == 1 || $item->totalvarient > 1) { ?>
                          ...
                          if (count($this->cart->contents()) > 0) {
                            ...
                            $myvalue2 = trim($str2, ',');
                            if ($myid2 != $myvalue2) { ?>
                              <button class="simple_btn withaddons btn btn-primary btn-add p-0 d-flex align-items-center justify-content-center" id="backadd<?php echo $item->CategoryID . $k; ?>" onClick="addonsitemqr('<?php echo $item->ProductsID; ?>','<?php echo $item->variantid; ?>',<?php echo $item->CategoryID . $k; ?>)">
                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M17 7.93956H9.06044V0H7.93956V7.93956H0V9.06044H7.93956V17H9.06044V9.06044H17V7.93956Z" fill="white" />
                                </svg>
                              </button>
