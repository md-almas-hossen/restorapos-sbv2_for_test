            ...
            <div class="col-5 align-self-end">
              ...
              <div class="input-group input-group-sm ">
                <div class="input-group-prepend">
                  <button onclick="var result = document.getElementById('sst61_<?php echo $type;?>'); var sst = result.value; if( !isNaN( sst ) &amp;&amp; sst > 1 ) result.value--;return false;" style="min-width: 2.5rem" class="btn btn-decrement btn-sm btn-primary rounded-3 btn-minus reduced" type="button"><strong>−</strong></button>
                </div>
                ...
                <div class="input-group-append">
                  <button onclick="var result = document.getElementById('sst61_<?php echo $type;?>'); var sst = result.value; if( !isNaN( sst )) result.value++;return false;" style="min-width: 2.5rem" class="btn btn-increment btn-sm btn-primary rounded-3 btn-plus increase" type="button"><strong>+</strong></button>
                </div>
              </div>
...
<div class="form-check mb-1">
 ...
 <?php } }?>
        ...
        <?php if($type=="menu"){$flag="menu";}else{ $flag="other";} ?>
          <button type="button" onclick="addonsfoodtocartmulti(<?php echo $item->ProductsID;?>,1,'<?php echo $flag;?>')" class="btn btn-primary"><?php echo "Cart & More";?></button>
           <button type="button" class="btn btn-secondary" onclick="addonsfoodtocart(<?php echo $item->ProductsID;?>,1,'<?php echo $flag;?>')"><?php echo display('add_to_cart') ?></button>
        </div>
