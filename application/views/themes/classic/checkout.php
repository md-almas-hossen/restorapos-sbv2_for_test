                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
									...
									<div class="form-group">
                                        ...
                                        <input type="number" pattern="\d{11}"  id="phone" class="form-control" value="<?php echo (!empty($billinginfo->phone) ? $billinginfo->phone : null) ?>" placeholder="Add Phone" name="phone" required>
                                    </div>
