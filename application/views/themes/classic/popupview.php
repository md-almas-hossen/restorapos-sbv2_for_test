  <div class="modal-header bg-primary">
        ...
        <div class="modal-body p-4">
          ...
          <div class="d-flex justify-content-between mb-1">
            ...
            <span><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $calvat=numbershow($billinfo->VAT, $settinginfo->showdecimal); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></span>
          </div>
          <div class="d-flex justify-content-between mb-1">
