...
$acthemename = $activethemeinfo->themename;?>
                ...
                <div class="form-group row bookinfo">
                    ...
                    <div class="col-sm-8">
                        <select name="tableid" class="select2 form-control" onchange="checkbook()" id="selecttable"
                ...
                <div class="form-group row bookinfo">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input name="bookfromtime" class="form-control" type="hidden" id="booktime"
                            value="<?php echo $gettime;?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="bookendtime" class="col-sm-4 col-form-label"><?php echo display('e_time') ?> *</label>
                    <div class="col-sm-8">
                        <input name="bookendtime" id="reservation_time" class="form-control" type="text"
                            placeholder="<?php echo display('e_time') ?>" value="<?php echo $endtime;?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="name" class="col-sm-4 col-form-label"><?php echo display('name') ?></label>
                    <div class="col-sm-8"><input type="text" name="customer_name" class="form-control" id="name"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8"><input type="text" name="mobile" class="form-control" id="phone"
                            placeholder="+8801712121212"
                            value="<?php echo (!empty($customerinfo->customer_phone)?$customerinfo->customer_phone:$contactno) ?>"
                            required></div>
                </div>
                <div class="form-group row">
                    <label for="mail" class="col-sm-4 col-form-label"><?php echo display('email') ?></label>
                    <div class="col-sm-8"><input type="email" name="email" class="form-control" id="mail"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8"><textarea class="form-control" name="message" id="message" rows="3"
                ...
                <?php echo form_close();?>
                <script
                    src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/js/reservation.js">
                </script>