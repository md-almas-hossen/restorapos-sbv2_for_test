      ...
      <div class="row g-3">
        ...
        ?>
          <div class="col-6">
            ...
            <img src="<?php echo base_url(!empty($category->CategoryImage) ? $category->CategoryImage : 'assets/img/default/default_food.png'); ?>" class="img-fluid rounded-4 mx-auto" alt="" onerror="this.onerror=null; this.src='<?php echo base_url('assets/img/default/default_food.png'); ?>';">
