...
<div class="tab-pane fade show active" id="nav-home-search" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
  <!-- Start Items Title -->
  <div class="d-flex justify-content-between mb-3">
    <h5 class="mb-0 fw-semibold">Search Result</h5>
  </div>
  <!-- /.End Items Title -->
  <!-- Start Item -->
  <?php
...
if ($catid == 0) { ?>
  ...
  ?>
    <div class="tab-pane fade show" id="nav-home<?php echo $hcategoryname . $op; ?>" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
      <!-- Start Items Title -->
      <div class="d-flex justify-content-between mb-3">
