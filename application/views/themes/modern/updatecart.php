...
<body class="<?php echo $qrtheme->theme;?>1">
  ...
  <?php echo form_open('hungry/updateqrorder','method="post" class="order_form"')?>
            ...
            <?php } ?>
            <div class="p-3">
             <div class="tab-content updatecart_padding_botom" style="padding-bottom: 50px;">
              <?php if($billinfo->payment_method_id!=4){?>
          ...
          <div class="payment-radio form-check rounded bg-white border mb-2 active">
            <input type="radio" name="card_type" id="payment_method_cre<?php echo $p;?>" data-parent="#payment" data-target="#description_cre<?php echo $p;?>" value="<?php echo $payment->payment_method_id;?>" <?php if($payment->payment_method_id==4){ echo "checked";}?> class="form-check-input">
            <label class="form-check-label d-flex align-items-center" for="payment_method_cre<?php echo $p; ?>"> 
...
<button class="cart-total d-flex align-items-center justify-content-between position-fixed border-0"  type="submit" style="bottom: 0; left: 0; right: 0; min-width: 2.5rem; background:<?php echo !empty($qrtheme->qrbuttoncolor) ? $qrtheme->qrbuttoncolor : '#940753'; ?>; color:<?php echo !empty($qrtheme->qrbuttontextcolor) ? $qrtheme->qrbuttontextcolor : '#ffffff'; ?>;">
    <div class="">
      ...
      <span class="ms-1 fw-medium"><?php echo display('update_ord') ?></span>
    </div>
