                ...
                <?php if ($this->session->flashdata('message')) { ?>
                    ...
                    <?php } ?>
                                    ...
                                    <option <?php if($webinfo->country=="ZW"){ echo "selected";}?> data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                        ...
                                        <div class="col-sm-12">
                                            <input type="submit" class="btn bg-green text-white px-5 py-2 btn-switch" <?php echo $bg_color_css;?> value="Register Now">&nbsp; OR &nbsp;<a href="<?php echo base_url().'mylogin'?>" class="btn bg-green text-white px-5 py-2 btn-switch" <?php echo $bg_color_css;?>>Login</a>
                                        </div>
                                        <?php echo form_close() ?>
