...
if(isset($color_setting->web_text_color)){
 ...
 ?>
 <link href="<?php echo base_url('application/views/themes/'.$acthemename.'/assets_web/css/myorderlist.css') ?>"
     rel="stylesheet" type="text/css" />
 <span class="rightSidebar_inner"></span>

 <div class="container-xxl p-md-5 p-mt-5">
     <div class="row">
         ...
         <div class="col-xl-9 col-md-8">
             <div class="col-sm-12 col-md-12 myinfotable">
                 <span class="text-center orderlistfont">My Order List</span>
                     ...
                     <tbody>
                         ...
                         <tr>
                             ...
                             <td class="text-center">
                                 <?php if($item->orderacceptreject == "" || $item->orderacceptreject ==0){
                                            echo "Pending";
                                        }else{
                                                
                                                if($item->order_status==1){echo "Accepted";}
                             ...
                             <td class="text-right"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                                 <?php echo $item->totalamount;?>
                                 <?php if($currency->position==2){echo $currency->curr_icon;}?> </td>
                             <td class="text-center">
                                 <a href="<?php echo base_url();?>vieworder/<?php echo $item->order_id;?>"
                                     class="btn btn-success btn-sm" <?php echo $bg_color_css;?> data-toggle="tooltip"
                                     data-placement="left" title="" data-original-title="Invoice"><i class="ti-eye"
