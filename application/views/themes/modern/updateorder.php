...
<div class="modal fade" id="closenotice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="app-bottom-menu bottom-0 g-0 justify-content-center position-fixed row start-0 w-100">
    ...
    <a href="<?php echo base_url(); ?>update-summery/<?php echo $orderinfo->order_id;?>" class="align-items-center col d-flex flex-column justify-content-center menu-item text-center btnposition" style="background:<?php echo !empty($qrtheme->qrbuttoncolor) ? $qrtheme->qrbuttoncolor : '#940753'; ?>; color:<?php echo !empty($qrtheme->qrbuttontextcolor) ? $qrtheme->qrbuttontextcolor : '#ffffff'; ?>;">
    ...
    <div class="p-3">
        ...
        <div class="tab-pane fade show">
          ...
          <?php $allcat = "";
				...
				?>
          <!-- <a href="#" class="card border-0 mb-2 p-3 rounded-4 shadow text-inherit"> -->
          <div class="card border-0 rounded-4 shadow text-inherit">
            <div class="row g-3">
              <div class="col-auto">
     ...
     <?php $myid2 = $item->CategoryID . $item->ProductsID . $item->variantid. $item->ProductsID . $item->variantid;
            ...
            <div class="cart_counter active" id="removeqtyb<?php echo $item->CategoryID . $k; ?>">
              ...
              <div class="input-group input-group-sm ">
                <div class="input-group-prepend">
                  <button id="<?php echo $item->CategoryID . $k; ?>" onclick="itemreduce('<?php echo $item->ProductsID; ?>','<?php echo $item->variantid; ?>',<?php echo $item->CategoryID . $k; ?>)" class="btn btn-decrement btn-sm btn-primary rounded-3 btn-minus reduced" type="button" style="min-width: 2.5rem; background:<?php echo !empty($qrtheme->qrbuttoncolor) ? $qrtheme->qrbuttoncolor : '#940753'; ?>; color:<?php echo !empty($qrtheme->qrbuttontextcolor) ? $qrtheme->qrbuttontextcolor : '#ffffff'; ?>;"><strong>−</strong></button>
                </div>
