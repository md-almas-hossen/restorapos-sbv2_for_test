										...
										<div class="d-flex pb-1 border-dash justify-content-between align-items-center">
											...
											<div class="text-center">
												<div class="border cart_counter d-flex justify-content-end p-1 radius-30">
													...
													<input type="text" name="qty" id="sst20" maxlength="12" value="<?php echo $item['qty'];?>" title="Quantity:" class="border-0 input-text qty text-center width_40" readonly="readonly">
