...
<body class="<?php echo $qrtheme->theme; ?>1">
    ...
    <!-- Start Cart Total -->
    <button type="button" class="cart-total d-flex align-items-center justify-content-between bg-primary text-white position-fixed rounded-3 border-0" onClick="addonsitemdetailsqr('qr-app-cart')">
        <div class="">
    ...
    <div class="content-wrap">
        ...
        <div class="p-3">
            <div class="row g-3 justify-content-between mb-2">
                <h5 class="col fw-semibold"><?php echo $iteminfo->ProductName; ?></h5>
            ...
            if (!empty($topinglist)) {
                ...
                <div class="mb-3 topping-section">
                    ...
                    ?>
                        ...
                        <?php if ($topping['maxoption'] > 1) { ?>
                            <p>Select up to <?php echo $topping['maxoption']; ?></p>
                        <?php } else { ?>
                            <p>Select up one</p>
                        <?php } ?>
                                    ...
                                    <div class="form-check mb-1">
                                        ...
                                        <?php if ($topping['isposition'] > 0) { ?>
                                            ...
                                            <duv class="expandable mt-1 radio-toggle-buttons">
                                                ...
                                                <label class="btn btn-sm btn-outline-primary rounded-pill d-inline-flex align-items-center fs-13" for="option2<?php echo $topping['tpassignid'] . $sql->add_on_id; ?>"><svg class="me-1" width="16" height="16" viewBox="0 0 21 20" fill="none" aria-hidden="true">
                                                        <title>Right Half Topping</title>
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 18C10.5 19.1046 11.4045 20.0209 12.4872 19.8025C17.0581 18.8809 20.5 14.8424 20.5 9.99999C20.5 5.15756 17.0581 1.11904 12.4872 0.197442C11.4045 -0.0208738 10.5 0.895421 10.5 1.99999L10.5 10C11.0523 10 11.5 10.4477 11.5 11C11.5 11.5523 11.0523 12 10.5 12L10.5 18ZM15.5 6.00001C15.5 7.10458 14.6046 8.00001 13.5 8.00001C12.3954 8.00001 11.5 7.10458 11.5 6.00001C11.5 4.89544 12.3954 4.00001 13.5 4.00001C14.6046 4.00001 15.5 4.89544 15.5 6.00001ZM17.5 11C17.5 11.5523 17.0523 12 16.5 12C15.9477 12 15.5 11.5523 15.5 11C15.5 10.4477 15.9477 10 16.5 10C17.0523 10 17.5 10.4477 17.5 11ZM15.5 15.5C15.5 16.3284 14.8284 17 14 17C13.1716 17 12.5 16.3284 12.5 15.5C12.5 14.6716 13.1716 14 14 14C14.8284 14 15.5 14.6716 15.5 15.5Z" fill="currentColor"></path>
                                                        <path d="M0.5 9.99998C0.5 5.16206 3.93552 1.12655 8.5 0.200012L8.5 2.25201C5.04954 3.1401 2.5 6.2723 2.5 9.99998C2.5 13.7277 5.04955 16.8599 8.5 17.7479V19.7999C3.93552 18.8734 0.5 14.8379 0.5 9.99998Z" fill="currentColor"></path>
                                                    </svg>Right Half</label>
