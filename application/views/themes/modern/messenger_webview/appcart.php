...
<body class="<?php echo $qrtheme->theme; ?>1">
    <div class="content-wrap">
        ...
        <div class="p-3 bg-light" id="mycartlist">
            ...
            ?>
                    <div class="card border-0 mb-2 p-3 rounded-4 shadow">
                        <div class="row g-3">
                            ...
                            <div class="col">
                                <h6 class="fw-semibold item-title mb-0 overflow-hidden">
                                    <?php echo $item['name'];
                                    ...
                                    ?> </h6>
                                <div class="fs-6 fw-semibold item-price text-primary">
    ...
    <a href="<?php echo base_url('qr-app-checkout'); ?>" class="cart-total d-flex align-items-center justify-content-between bg-primary text-white position-fixed rounded-3">
        <div class="">
