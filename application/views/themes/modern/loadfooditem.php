...
if (!empty($searchresult)) {
                                ...
                                foreach ($searchresult as $menuitem) {
                                    ...
                                    $this->db->where('menuid',$menuitem->ProductsID);
                                    $tquery2= $this->db->get();
						...
						<div class="col-md-4 col-lg-6 col-xxl-4 col-6 d-flex">
							<div class="card border-0 p-3 w-100">
								...
								<div class="card-body d-flex flex-column pt-2 pt-md-4 px-0 pb-0">
									<h6 class="card-text mb-2 fs-sm-15 pcoursor" onclick="quickorder(<?php echo $menuitem->ProductsID; ?>,<?php echo $menuitem->CategoryID; ?>)"><?php echo $menuitem->ProductName ?> </h6>
									<div class="d-block d-sm-flex d-xxl-block d-dxl-flex justify-content-between align-items-center mt-auto">
										<span class="fw-600">
