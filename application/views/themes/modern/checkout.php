							...
							<div class="tab-content" id="pills-tabContent">
								<div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
									<div class="bg-white d-block p-4 mb-4">
										<h4 class="fw-600 mb-4"><?php echo display('logininfo') ?></h4>
												...
												<div class="col-md-12">
													<div class="align-items-end row">
														<div class="col-auto mb-2">
															<label for="username" class="form-label"><?php echo display('username_or_email') ?></label>
                                   <input type="email" id="user_email" class="form-control" name="user_email">
														...
														<div class="col-auto mb-2">
															<a href="javascript:void(0)" onclick="logincustomer();" class="btn bg-green text-white px-5 py-2 btn-switch" <?php echo $bg_color_css;?>><?php echo display('login') ?></a>
														</div>
														<div class="col-auto mb-3">
															<?php echo display('newuser') ?>? <a href="#register" class="text-green gotoReg" <?php echo $text_color_css;?>><?php echo display('register') ?></a>
														</div>
													</div>
												</div>
						...
						<fieldset class="custInfo">
							<div class="bg-white d-block p-4">
								...
								<div class="">
									<div class="row g-3 align-items-end">
										<div class="col-xl-4">
											<label for="customerName3" class="form-label"><?php echo display('name') ?></label>
