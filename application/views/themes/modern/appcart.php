...
<body class="<?php echo $qrtheme->theme; ?>1">
  <div class="content-wrap">
    <div class="top-header py-4 px-3 d-flex align-items-center" style="background:<?php if (!empty($qrtheme->backgroundcolorqr)) {
                                                                                    echo $qrtheme->backgroundcolorqr;
                                                                                  } ?>;">
      <div class="">
          ...
          foreach ($shippinginfo as $payment) {
            ...
            if (!array_filter($dinepayment)) { ?>
              <div class="payment-radio form-check rounded bg-white border mb-2 active">
                <input type="radio" name="card_type" id="dinepayment_method_cre<?php echo $p; ?>" data-parent="#payment" data-target="#description_cre<?php echo $p; ?>" value="<?php echo $payment->payment_method_id; ?>" <?php if ($payment->payment_method_id == 4) {
                                                                                                                                                                                                                              echo "checked";
                                                                                                                                                                                                                            } ?> class="form-check-input dineinpay">
              ...
              ?>
                  <div class="payment-radio form-check pl-0 rounded bg-white border mb-2">
                    <input type="radio" name="card_type" id="dinepayment_method_cre<?php echo $p; ?>" data-parent="#payment" data-target="#description_cre<?php echo $p; ?>" value="<?php echo $payment->payment_method_id; ?>" <?php if ($payment->payment_method_id == $pvalue) {
                                                                                                                                                                                                                                  echo "checked";
                                                                                                                                                                                                                                } ?> class="form-check-input dineinpay">
                    <label class="form-check-label d-flex align-items-center" for="dinepayment_method_cre<?php echo $p; ?>">
                      <span class="checkbox-img me-2">
        ...
        <?php if (!empty($shippinginfo)) {
          ...
          foreach ($shippinginfo as $payment) {
            ...
            if (!array_filter($pickuppayment)) { ?>
              <div class="payment-radio form-check rounded bg-white border mb-2 active">
                <input type="radio" name="card_type1" id="pickpayment_method_cre<?php echo $p; ?>" data-parent="#payment" data-target="#description_cre<?php echo $p; ?>" value="<?php echo $payment->payment_method_id; ?>" <?php if ($payment->payment_method_id == 4) {
                                                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                                                              } ?> class="form-check-input pickuppay">
              ...
              ?>
                  <div class="payment-radio form-check pl-0 rounded bg-white border mb-2">
                    <input type="radio" name="card_type1" id="pickpayment_method_cre<?php echo $p; ?>" data-parent="#payment" data-target="#description_cre<?php echo $p; ?>" value="<?php echo $payment->payment_method_id; ?>" <?php if ($payment->payment_method_id == $pvalue) {
                                                                                                                                                                                                                                    echo "checked";
                                                                                                                                                                                                                                  } ?> class="form-check-input pickuppay">
                    <label class="form-check-label d-flex align-items-center" for="pickpayment_method_cre<?php echo $p; ?>">
                      <span class="checkbox-img me-2">
  ...
  <button class="cart-total d-flex align-items-center justify-content-between position-fixed border-0" type="submit" style="bottom: 0; left: 0; right: 0; min-width: 2.5rem; background:<?php echo !empty($qrtheme->qrbuttoncolor) ? $qrtheme->qrbuttoncolor : '#940753'; ?>; color:<?php echo !empty($qrtheme->qrbuttontextcolor) ? $qrtheme->qrbuttontextcolor : '#ffffff'; ?>;">
    <div>
