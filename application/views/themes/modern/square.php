  ...
  <div class="container-xxl">
    <div class="row">
      <div class="col-sm-12">
		...
		var newcsrf=basicinfo.csrftokeng;
          // JavaScript Document
        ...
        */
        ...
        /* HANDLE AS DESIRED */
        console.log("The form loaded wds!");
		$("#idcsrft").val(newcsrf);
        }
        }
        });
        ...
        */
        ...
        <div id="form-container">
          <div id="sq-ccbox">
            <?php echo form_open('payment-process','method="post" id="nonce-form"')?>
            <input type="hidden" name="csrf_test_name" value="" id="idcsrft">
              <fieldset>
