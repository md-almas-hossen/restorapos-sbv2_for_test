	...
	<div class="bg-dark2 bottom-0 d-block d-lg-none end-0 position-fixed px-2 py-3 start-0 z-index-99">
		<div class="container-xxl">
			<div class="d-flex align-items-center justify-content-center">
				<a href="javascript:void(0)" onclick="gotocheckoutmobile()" class="align-items-center d-flex text-white">
					<span class="border-end border-right me-3 pe-3"><?php echo display('proceedtocart') ?></span>
					...
					<div class="d-block position-relative">
						...
						<span class="bg-green cart-badge fs-13 fw-600 position-absolute rounded-circle text-center text-white" <?php echo $bg_color_css;?> id="mitemtotal"><?php echo count($this->cart->contents());?></span>
					</div>
					...
					<div class="text-white" id="mobilecarttotal">0</div>
                    <?php } ?>
				</a>
			</div>
		</div>
	...
	<div class="d-none d-xl-block position-relative overflow-hidden py-4">
		...
		<div class="container-xxl">
			<div class="row g-3 position-relative">
				<div class="col-xl-2">
					<div class="input-group">
						...
						<select class="form-select rounded-0 border-0 ps-5 py-3" id="desktopship" onChange="getcheckbox('desktopship')">
							...
							<option data-title="<?php echo $shipment->shipping_method;?>" data-price="<?php echo $shipment->shippingrate;?>" value="<?php echo $shipment->shiptype;?>" <?php if(empty($defaultship)){if($shipment->shiptype==1){ echo "selected";}}else if($shipment->ship_id==$defaultship){echo "selected";}?>><?php echo $shipment->shipping_method;?></option>
                            <?php }?>
						</select>
					</div>
				</div>
				<div class="col-xl-6">
					<div class="input-group">
						<input class="form-select rounded-0 border-0 ps-4 pe-5 py-3 addressauto" value="<?php echo $shipaddress;?>" type="text" id="location" placeholder="Search here for your location" autocomplete="off">
						<input name="delivaryaddress" type="hidden" id="delivaryaddress"/> 
                        <div class="bg-green border-0 end-0 input-group-text input-icon-absolute me-2 position-absolute px-3 py-2 rounded-0 text-white top-50" <?php echo $bg_color_css;?>>
							<i class="ti-location-pin me-2"></i>Location
						</div>
					</div>
				</div>
				<div class="col-xl-2">
					<div class="input-group">
						...
						<input type="text" class="border-0 datepicker form-control ps-5 py-3 rounded-0" placeholder="Delivery Date" id="orderdate" autocomplete="off">
					</div>
				</div>
				<div class="col-xl-2">
					<div class="input-group">
						...
						<select class="form-select ps-5 py-3 rounded-0" aria-label="Default select example" id="reservation_time" >
							...
							foreach($delivarytime as $dtime){
								...
								?>
							<option value="<?php echo $sptime['0'];?>"><?php echo $dtime->deltime;?></option>
                            <?php }} ?>
						</select>
					</div>
				</div>
			...
			<div class="row g-2 position-relative">
				<div class="col-sm-4">
					<div class="input-group">
						...
						<select class="form-select rounded-0 border-0 ps-5 py-3 bg-whitish" id="mobileship" onChange="getcheckbox('mobileship')">
							<?php foreach($shippinginfo as $shipment){?>
							<option data-title="<?php echo $shipment->shipping_method;?>" data-price="<?php echo $shipment->shippingrate;?>" value="<?php echo $shipment->shiptype;?>" <?php if($shipment->shiptype==1){ echo "selected";}?>><?php echo $shipment->shipping_method;?></option>
                            <?php }?>
						</select>
					</div>
				</div>
				<div class="col-sm-4 col-6 col-12-d400">
					<div class="input-group">
						...
						<input type="text" class="border-0 datepicker form-control ps-5 py-3 rounded-0 bg-whitish" placeholder="Delivery Date" id="orderdatemobile" autocomplete="off">
					</div>
				</div>
				<div class="col-sm-4 col-6 col-12-d400">
					<div class="input-group">
				...
				<div class="col-xl-12">
					<div class="input-group">
						<input class="form-select rounded-0 border-0 ps-4 pe-5 py-3 bg-whitish addressauto" value="<?php echo $shipaddress;?>" type="text" id="mlocation" placeholder="Search location" aria-label="Search" autocomplete="off">
						<div class="bg-green border-0 end-0 input-group-text input-icon-absolute me-2 position-absolute px-3 py-2 rounded-0 text-white top-50" <?php echo $bg_color_css;?>>
							<i class="ti-location-pin me-2"></i>Location
						</div>
					</div>
				...
				<div id="nav__outer-wrap" class="nav__outer-wrap">
					<ul id="nav__inner-wrap" class="nav__inner-wrap">
						...
						<li class="nav__item nav__menu-item <?php echo $clidclass;?>">
                            ...
                            <?php }else{ ?>
                            <a class="nav__link nav__link--toplevel" onclick="searchmenu('<?php echo $category->CategoryID; ?>')"><?php echo $category->Name; ?></a>
                            <?php } ?>
						</li>
                        <?php } ?>
                        ...
                        <?php $op = 0;
							...
							<div class="accordion-item">
								...
								<h2 class="accordion-header" id="<?php echo $hcategoryname; ?>">
									<button onclick="searchmenu('<?php echo $category->CategoryID; ?>')" class="<?php echo $issub;?> py-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-<?php echo $hcategoryname; ?>" aria-expanded="false" aria-controls="flush-<?php echo $hcategoryname; ?>">
										<?php echo $category->Name; ?>
									</button>
								</h2>
									...
									<div class="accordion-body py-1">
										<ul class="list-unstyled ms-3">
                                        	<?php foreach ($category->sub as $subcat) {
                                                ...
                                                $ProdcutQTYsub = $pnumResultsub->totalcat;
                                            ?>
											<li class="my-1"><a onclick="searchmenu('<?php echo $subcat->CategoryID; ?>')" class="fs-13 text-decoration-none text-muted"><i class="ti-minus me-2"></i><?php echo $subcat->Name; ?><span class="float-end">(<?php echo $ProdcutQTYsub; ?>)</span></a></li>
                                             <?php } ?>
										</ul>
									</div>
								</div>
				...
				<div class="col rightSidebar none-from-md auto-fit">
						...
						if ($cart = $this->cart->contents()){?>
                                                            ...
                                                            <div class="d-flex pb-1 border-dash justify-content-between align-items-center">
                                                                <div class="text-start me-2">
                                                                    ...
                                                                    <div class="fs-13 lh-sm">
                                                                        ...
                                                                        <?php if(!empty($item['addonsid'])){?><div><span class="fw-600"><?php echo display('addons_name')?>:</span> <span class="text-muted"><?php echo $item['addonname'];?>(<?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><?php echo $item['addontpr'];?><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?>)</span></div><?php } ?>
                                                                    </div>
                                                                ...
                                                                <div class="text-center">
                                                                    <div class="border cart_counter d-flex justify-content-end p-1 radius-30">
                                                                        ...
                                                                        <input type="text" name="qty" id="sst3" maxlength="12" value="<?php echo $item['qty'];?>" title="Quantity:" class="border-0 input-text qty text-center width_40">
                                                                ...
                                                                <table class="table table-borderless m-0">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td class="fs-14 p-0 text-end fw-600"><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><span id="subtotal"><?php echo $itemtotal;?></span><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></td>
                                                                        </tr>
                                                                        <?php if (empty($taxinfos)) { ?>
                                                                        <tr>
                                                                            <td class="fs-14 p-0"><?php echo display('vat') ?></td>
                                                                            <td class="fs-14 p-0 text-end fw-600"><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><?php echo numbershow($calvat,$settinginfo->showdecimal);?><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></td>
                                                                        </tr>
                                                                        <?php } else {
                                                                                $i = 0;
                                                                         ...
                                                                         <tr>
                                                                            ...
                                                                            <td class="fs-14 p-0 text-end fw-600"><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><?php echo  numbershow($multiplletax['tax' . $i],$settinginfo->showdecimal); ?><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></td>
                                                                        </tr>
                                                                        <?php $i++;
                                                                                    }
                                                                                }
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="fs-14 p-0 text-end fw-600"><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><span id="discount"><?php echo $discount;?></span><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></td>
                                                                        </tr>
                                                                        <?php 
                                                                                if(!empty($this->session->userdata('couponcode'))){?>
                                                                        <tr>
                                                                            <td class="fs-14 p-0"><?php echo display('coupon_discount'); ?></td>
                                                                            <td class="fs-14 p-0 text-end fw-600"><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><span id="coupdiscount"><?php echo $coupon=$this->session->userdata('couponprice');?></span><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></td>
                                                                        </tr>
                                                                        <?php }
																			else{
																				 ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="fs-14 p-0 text-end fw-600"><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><span id="scharge"><?php if($this->session->userdata('shippingrate')>0){ echo $shipping=$this->session->userdata('shippingrate');}else{echo "0";}?></span><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?> <input name="servicecharge" type="hidden" value="0" id="getscharge" /><input name="servicename" type="hidden" value="" id="servicename" /></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                ...
                                <div class="p-0 mt-auto border-top">
                                                ...
                                                <div class="align-items-center border-top d-flex fw-600 justify-content-between px-3 py-2">
                                                    ...
                                                    <div><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><span id="grtotal"><?php echo $calvat+$itemtotal+$shipping-($discount+$coupon);?></span><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></div>
                                                </div>
					...
					<span id="vat" class="d-none"><?php echo $calvat;?></span>
                            ...
                            <div class="p-0 mt-auto border-top">
                                        ...
                                        <div class="align-items-center border-top d-flex fw-600 justify-content-between px-3 py-2">
                                            <div><?php echo display('total') ?></div>
                                            <div><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><?php echo $calvat+$itemtotal+$shipping-($discount+$coupon);?><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></div>
                                        </div>
